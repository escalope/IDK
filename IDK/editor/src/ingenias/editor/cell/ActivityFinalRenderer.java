...
public class ActivityFinalRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/ActivityFinalUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ActivityFinal",
	index,"/ingenias/editor/rendererxml/ActivityFinalINGENIASPanel.xml");
  ...
  public static void setEntity(ActivityFinal ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ActivityFinal",ent.getPrefs().getView());
