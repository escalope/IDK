...
public class UMLSendsMessageView extends NAryView {

static UMLSendsMessageRenderer renderer1 = new UMLSendsMessageRenderer();
 public static UMLSendsMessageRenderer renderer = new UMLSendsMessageRenderer();
  // Constructor.
  public UMLSendsMessageView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.UMLSendsMessage ent=(ingenias.editor.entities.UMLSendsMessage)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.UMLSendsMessage ent) {
