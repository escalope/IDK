...
public class OHasGroupRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("OHasGroup",
	index,"/rendererxml/OHasGroupNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("OHasGroup",
	index,"/rendererxml/OHasGroupINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("OHasGroup",
	index,"/rendererxml/OHasGroupLABELPanel.xml");
     ...
     */
     public OHasGroupRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("OHasGroup",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.OHasGroup ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("OHasGroup",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("OHasGroup",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("OHasGroup",c);
	}
