...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFUsesMethodNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFUsesMethod",
	index,"/ingenias/editor/rendererxml/WFUsesMethodINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFUsesMethod",
	index,"/ingenias/editor/rendererxml/WFUsesMethodLABELPanel.xml");
 ...
 public static void setEntity(WFUsesMethod ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFUsesMethod",ent.getPrefs().getView());
