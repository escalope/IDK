...
public class ODecomposesGroupRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("ODecomposesGroup",
	index,"/rendererxml/ODecomposesGroupNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ODecomposesGroup",
	index,"/rendererxml/ODecomposesGroupINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ODecomposesGroup",
	index,"/rendererxml/ODecomposesGroupLABELPanel.xml");
     ...
     */
     public ODecomposesGroupRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("ODecomposesGroup",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.ODecomposesGroup ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ODecomposesGroup",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("ODecomposesGroup",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("ODecomposesGroup",c);
	}
