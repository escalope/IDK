...
public class InspectQualityOfSourceInTesting extends ingenias.editor.entities.RuntimeFact{
  ...
  public InspectQualityOfSourceInTesting (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="InspectQualityOfSourceInTesting";
  }
  

  public InspectQualityOfSourceInTesting (){
  ...
  public String getType(){
   return "InspectQualityOfSourceInTesting";
  }
