...
public class InteractionView extends VertexView {

  public static InteractionRenderer renderer = new InteractionRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public InteractionView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Interaction ent=(ingenias.editor.entities.Interaction)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Interaction ent) {
