...
public class GTDecomposesView extends NAryView {

static GTDecomposesRenderer renderer1 = new GTDecomposesRenderer();
 public static GTDecomposesRenderer renderer = new GTDecomposesRenderer();
  // Constructor.
  public GTDecomposesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GTDecomposes ent=(ingenias.editor.entities.GTDecomposes)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GTDecomposes ent) {
