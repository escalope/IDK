...
public class GeneratingForSingleReceiverTask extends Task{
 ...
 public void execute() throws TaskException{
        ...
        Collection<MultipleAnswer>  eiMultipleAnswer=new Vector(this.getAllInputsOfType("MultipleAnswer"));             
        ...
        if (eaTimeOut_generator.mustFail("GeneratingForSingleReceiver",getAgentID())){
