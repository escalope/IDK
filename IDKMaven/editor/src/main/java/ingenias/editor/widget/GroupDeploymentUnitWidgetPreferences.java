...
public class GroupDeploymentUnitWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public GroupDeploymentUnitWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","InstGroup","InstanceName",""};
