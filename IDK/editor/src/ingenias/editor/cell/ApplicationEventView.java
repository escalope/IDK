...
public class ApplicationEventView extends VertexView {

  public static ApplicationEventRenderer renderer = new ApplicationEventRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ApplicationEventView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.ApplicationEvent ent=(ingenias.editor.entities.ApplicationEvent)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ApplicationEvent ent) {
