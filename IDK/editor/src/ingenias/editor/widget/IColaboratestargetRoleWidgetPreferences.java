...
public class IColaboratestargetRoleWidgetPreferences extends EntityWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public IColaboratestargetRoleWidgetPreferences() {
  super();
  String[] preferredOrder={"Cardinality",""};
  this.setPreferredOrder(preferredOrder);
  Vector result=null;
  
   preferredWidget.put("Cardinality",ingenias.editor.widget.CustomJComboBox.class);
   result=new Vector();
