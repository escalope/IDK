...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/IPursuesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IPursues",
	index,"/ingenias/editor/rendererxml/IPursuesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("IPursues",
	index,"/ingenias/editor/rendererxml/IPursuesLABELPanel.xml");
 ...
 public static void setEntity(IPursues ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IPursues",ent.getPrefs().getView());
