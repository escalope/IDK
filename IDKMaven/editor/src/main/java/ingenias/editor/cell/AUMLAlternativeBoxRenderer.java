...
public class AUMLAlternativeBoxRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("AUMLAlternativeBox",
	index,"/rendererxml/AUMLAlternativeBoxUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLAlternativeBox",
	index,"/rendererxml/AUMLAlternativeBoxINGENIASPanel.xml");
     ...
     */
    public AUMLAlternativeBoxRenderer() {
    }
    
      public JComponent getConcreteSubComponent(String fieldname, Entity ent, Map map) {
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLAlternativeBox",ent.getPrefs(map).getView());
	  return currentMap.get(fieldname);
  		}

    public Dimension getSize() {
    return RenderComponentManager.getSize("AUMLAlternativeBox",current);
    }
  ...
  public static void setEntity(AUMLAlternativeBox ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLAlternativeBox",ent.getPrefs(attributes).getView());
  current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AUMLAlternativeBox",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AUMLAlternativeBox",current);
	}
