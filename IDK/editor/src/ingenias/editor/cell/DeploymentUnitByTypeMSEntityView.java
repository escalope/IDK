...
public class DeploymentUnitByTypeMSEntityView extends VertexView {

  public static DeploymentUnitByTypeMSEntityRenderer renderer = new DeploymentUnitByTypeMSEntityRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public DeploymentUnitByTypeMSEntityView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.DeploymentUnitByTypeMSEntity ent=(ingenias.editor.entities.DeploymentUnitByTypeMSEntity)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(DeploymentUnitByTypeMSEntity ent) {
