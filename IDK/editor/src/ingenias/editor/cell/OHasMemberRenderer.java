...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/OHasMemberNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("OHasMember",
	index,"/ingenias/editor/rendererxml/OHasMemberINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("OHasMember",
	index,"/ingenias/editor/rendererxml/OHasMemberLABELPanel.xml");
 ...
 public static void setEntity(OHasMember ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("OHasMember",ent.getPrefs().getView());
