...
public class TestingTimoutSendingInitiatorForTimedOutcommunicationInitiatorSending extends TimedOutcommunicationInitiatorSending{
...

{
	...
	{ SenderFailure ment=new SenderFailure();
	   ...
	   agcATimeOut_0.putO2AObject(ment, false);
        ...
        new Thread(){
	      ...
	      MainInteractionManager.getInstance().setTitle("node DeploymentForInitiatorSendingTimeout");
