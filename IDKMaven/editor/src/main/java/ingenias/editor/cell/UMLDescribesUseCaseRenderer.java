...
public class UMLDescribesUseCaseRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("UMLDescribesUseCase",
	index,"/rendererxml/UMLDescribesUseCaseNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UMLDescribesUseCase",
	index,"/rendererxml/UMLDescribesUseCaseINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UMLDescribesUseCase",
	index,"/rendererxml/UMLDescribesUseCaseLABELPanel.xml");
     ...
     */
     public UMLDescribesUseCaseRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("UMLDescribesUseCase",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.UMLDescribesUseCase ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UMLDescribesUseCase",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("UMLDescribesUseCase",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("UMLDescribesUseCase",c);
	}
