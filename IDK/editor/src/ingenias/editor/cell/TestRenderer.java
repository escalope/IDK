...
public class TestRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/TestUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Test",
	index,"/ingenias/editor/rendererxml/TestINGENIASPanel.xml");
  ...
  public static void setEntity(Test ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Test",ent.getPrefs().getView());
