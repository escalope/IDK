...
public class AUMLPortView extends VertexView {

  public static AUMLPortRenderer renderer = new AUMLPortRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public AUMLPortView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.AUMLPort ent=(ingenias.editor.entities.AUMLPort)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(AUMLPort ent) {
