...
public class ApplicationEventSlotsView extends VertexView {

  public static ApplicationEventSlotsRenderer renderer = new ApplicationEventSlotsRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ApplicationEventSlotsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.ApplicationEventSlots ent=(ingenias.editor.entities.ApplicationEventSlots)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ApplicationEventSlots ent) {
