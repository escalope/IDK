...
public class TriggersFailureView extends NAryView {

static TriggersFailureRenderer renderer1 = new TriggersFailureRenderer();
 public static TriggersFailureRenderer renderer = new TriggersFailureRenderer();
  // Constructor.
  public TriggersFailureView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.TriggersFailure ent=(ingenias.editor.entities.TriggersFailure)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.TriggersFailure ent) {
