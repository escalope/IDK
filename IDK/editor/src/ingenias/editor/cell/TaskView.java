...
public class TaskView extends VertexView {

  public static TaskRenderer renderer = new TaskRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public TaskView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Task ent=(ingenias.editor.entities.Task)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Task ent) {
