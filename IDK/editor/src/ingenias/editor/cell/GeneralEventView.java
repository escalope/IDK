...
public class GeneralEventView extends VertexView {

  public static GeneralEventRenderer renderer = new GeneralEventRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public GeneralEventView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.GeneralEvent ent=(ingenias.editor.entities.GeneralEvent)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(GeneralEvent ent) {
