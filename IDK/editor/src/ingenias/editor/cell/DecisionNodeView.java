...
public class DecisionNodeView extends VertexView {
  ...
  public static DecisionNodeRenderer renderer = new DecisionNodeRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public DecisionNodeView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.DecisionNode ent=(ingenias.editor.entities.DecisionNode)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(DecisionNode ent) {
