...
public class WFTestStateView extends VertexView {

  public static WFTestStateRenderer renderer = new WFTestStateRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public WFTestStateView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.WFTestState ent=(ingenias.editor.entities.WFTestState)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(WFTestState ent) {
