...
public class GTDecomposesORRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("GTDecomposesOR",
	index,"/rendererxml/GTDecomposesORNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTDecomposesOR",
	index,"/rendererxml/GTDecomposesORINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTDecomposesOR",
	index,"/rendererxml/GTDecomposesORLABELPanel.xml");
     ...
     */
     public GTDecomposesORRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("GTDecomposesOR",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.GTDecomposesOR ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTDecomposesOR",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("GTDecomposesOR",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("GTDecomposesOR",c);
	}
