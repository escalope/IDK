...
public class IUIterateView extends VertexView {

  public static IUIterateRenderer renderer = new IUIterateRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public IUIterateView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.IUIterate ent=(ingenias.editor.entities.IUIterate)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(IUIterate ent) {
