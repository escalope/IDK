...
public class ContributeNegativelyRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("ContributeNegatively",
	index,"/rendererxml/ContributeNegativelyNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ContributeNegatively",
	index,"/rendererxml/ContributeNegativelyINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ContributeNegatively",
	index,"/rendererxml/ContributeNegativelyLABELPanel.xml");
     ...
     */
     public ContributeNegativelyRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("ContributeNegatively",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.ContributeNegatively ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ContributeNegatively",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("ContributeNegatively",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("ContributeNegatively",c);
	}
