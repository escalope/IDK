...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/ApplicationBelongsToNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ApplicationBelongsTo",
	index,"/ingenias/editor/rendererxml/ApplicationBelongsToINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ApplicationBelongsTo",
	index,"/ingenias/editor/rendererxml/ApplicationBelongsToLABELPanel.xml");
 ...
 public static void setEntity(ApplicationBelongsTo ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ApplicationBelongsTo",ent.getPrefs().getView());
