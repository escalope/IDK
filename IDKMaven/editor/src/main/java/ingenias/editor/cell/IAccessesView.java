...
public class IAccessesView extends NAryView {

static IAccessesRenderer renderer1 = new IAccessesRenderer();
 public static IAccessesRenderer renderer = new IAccessesRenderer();
  // Constructor.
  public IAccessesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.IAccesses ent=(ingenias.editor.entities.IAccesses)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.IAccesses ent) {
