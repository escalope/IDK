...
public class SourceToTesting extends ingenias.editor.entities.RuntimeFact{
  ...
  public SourceToTesting (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="SourceToTesting";
  }
  

  public SourceToTesting (){
