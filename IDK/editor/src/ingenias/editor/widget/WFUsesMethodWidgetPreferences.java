...
public class WFUsesMethodWidgetPreferences extends EntityWidgetPreferences {
  ...
  public WFUsesMethodWidgetPreferences() {
  super();
  String[] preferredOrder={"Label","ApplicationMethod",""};
