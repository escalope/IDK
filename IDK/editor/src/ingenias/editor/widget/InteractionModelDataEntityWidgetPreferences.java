...
public class InteractionModelDataEntityWidgetPreferences extends EntityWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public InteractionModelDataEntityWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","InteractionConsidered",""};
