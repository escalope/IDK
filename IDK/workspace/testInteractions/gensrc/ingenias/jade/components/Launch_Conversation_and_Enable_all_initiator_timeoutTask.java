...
public class Launch_Conversation_and_Enable_all_initiator_timeoutTask extends Task{

 public Launch_Conversation_and_Enable_all_initiator_timeoutTask(String id){
  super(id,"Launch_Conversation_and_Enable_all_initiator_timeout");
 }
 ...
 public void execute() throws TaskException{
        ...
        SenderFailure  eiSenderFailure=(SenderFailure)this.getFirstInputOfType("SenderFailure");             
		...
		eaTimeOut_generator.requestTaskFailure("GeneratingForSingleReceiver","ATimeOut_0");
