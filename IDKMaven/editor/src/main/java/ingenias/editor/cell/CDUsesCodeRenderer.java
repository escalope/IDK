...
public class CDUsesCodeRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("CDUsesCode",
	index,"/rendererxml/CDUsesCodeNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("CDUsesCode",
	index,"/rendererxml/CDUsesCodeINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("CDUsesCode",
	index,"/rendererxml/CDUsesCodeLABELPanel.xml");
     ...
     */
     public CDUsesCodeRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("CDUsesCode",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.CDUsesCode ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("CDUsesCode",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("CDUsesCode",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("CDUsesCode",c);
	}
