...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GTAffectsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTAffects",
	index,"/ingenias/editor/rendererxml/GTAffectsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTAffects",
	index,"/ingenias/editor/rendererxml/GTAffectsLABELPanel.xml");
 ...
 public static void setEntity(GTAffects ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTAffects",ent.getPrefs().getView());
