...
public class WorkflowBoxView extends VertexView {

  public static WorkflowBoxRenderer renderer = new WorkflowBoxRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public WorkflowBoxView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.WorkflowBox ent=(ingenias.editor.entities.WorkflowBox)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(WorkflowBox ent) {
