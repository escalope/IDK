...
public class MentalStateProcessorRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/MentalStateProcessorUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("MentalStateProcessor",
	index,"/ingenias/editor/rendererxml/MentalStateProcessorINGENIASPanel.xml");
  ...
  public static void setEntity(MentalStateProcessor ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("MentalStateProcessor",ent.getPrefs().getView());
