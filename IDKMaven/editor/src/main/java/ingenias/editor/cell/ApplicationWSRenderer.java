...
public class ApplicationWSRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/rendererxml/ApplicationWSUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ApplicationWS",
	index,"/rendererxml/ApplicationWSINGENIASPanel.xml");
    ...
    public ApplicationWSRenderer() {
	  ...
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("ApplicationWS",ent.getPrefs(map).getView());
  ...
  public static void setEntity(ApplicationWS ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ApplicationWS",ent.getPrefs(attributes).getView());
