...
public class TaskOutputDefinitionWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public TaskOutputDefinitionWidgetPreferences() {
  super();
  String[] preferredOrder={"Description","Operation","AffectedElement",""};
