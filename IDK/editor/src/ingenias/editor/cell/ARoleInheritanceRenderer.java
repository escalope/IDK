...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/ARoleInheritanceNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ARoleInheritance",
	index,"/ingenias/editor/rendererxml/ARoleInheritanceINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ARoleInheritance",
	index,"/ingenias/editor/rendererxml/ARoleInheritanceLABELPanel.xml");
 ...
 public static void setEntity(ARoleInheritance ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ARoleInheritance",ent.getPrefs().getView());
