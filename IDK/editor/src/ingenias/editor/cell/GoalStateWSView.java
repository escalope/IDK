...
public class GoalStateWSView extends VertexView {

  public static GoalStateWSRenderer renderer = new GoalStateWSRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public GoalStateWSView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.GoalStateWS ent=(ingenias.editor.entities.GoalStateWS)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(GoalStateWS ent) {
