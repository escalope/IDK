...
public class AGOCondSubordinationRelationshipGroupEdge extends NAryEdge {

  // Constructor with data content
  public AGOCondSubordinationRelationshipGroupEdge(ingenias.editor.entities.AGOCondSubordinationRelationshipGroup userObject) {
    super(userObject);
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof AGOCondSubordinationRelationshipGroupEdge)))
      return false;

    // n-edge to be considered.
    AGOCondSubordinationRelationshipGroupEdge edge = new AGOCondSubordinationRelationshipGroupEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof AGOCondSubordinationRelationshipGroupEdge)
      edge = (AGOCondSubordinationRelationshipGroupEdge) selectedEdge;
