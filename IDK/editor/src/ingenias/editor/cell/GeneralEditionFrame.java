...
public class GeneralEditionFrame extends javax.swing.JDialog implements java.io.Serializable {
  ...
  public GeneralEditionFrame(ingenias.editor.Editor editor,ingenias.editor.ObjectManager om,final Frame f,String title,Entity ent) {
    super(f,title,true);
    ...
    GeneralEditionPanel gep=new GeneralEditionPanel(editor,f, om,ent);
    ...
    main.add(jb,BorderLayout.SOUTH);
