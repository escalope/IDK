...
public class AGOClientServerRelationshipOrgView extends NAryView {

static AGOClientServerRelationshipOrgRenderer renderer1 = new AGOClientServerRelationshipOrgRenderer();
 public static AGOClientServerRelationshipOrgRenderer renderer = new AGOClientServerRelationshipOrgRenderer();
  // Constructor.
  public AGOClientServerRelationshipOrgView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGOClientServerRelationshipOrg ent=(ingenias.editor.entities.AGOClientServerRelationshipOrg)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGOClientServerRelationshipOrg ent) {
