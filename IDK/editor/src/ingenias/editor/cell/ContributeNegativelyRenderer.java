...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/ContributeNegativelyNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ContributeNegatively",
	index,"/ingenias/editor/rendererxml/ContributeNegativelyINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ContributeNegatively",
	index,"/ingenias/editor/rendererxml/ContributeNegativelyLABELPanel.xml");
 ...
 public static void setEntity(ContributeNegatively ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ContributeNegatively",ent.getPrefs().getView());
