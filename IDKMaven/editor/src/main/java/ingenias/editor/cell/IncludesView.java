...
public class IncludesView extends NAryView {

static IncludesRenderer renderer1 = new IncludesRenderer();
 public static IncludesRenderer renderer = new IncludesRenderer();
  // Constructor.
  public IncludesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.Includes ent=(ingenias.editor.entities.Includes)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.Includes ent) {
