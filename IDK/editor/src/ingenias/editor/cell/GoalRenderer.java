...
public class GoalRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/GoalUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Goal",
	index,"/ingenias/editor/rendererxml/GoalINGENIASPanel.xml");
  ...
  public static void setEntity(Goal ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Goal",ent.getPrefs().getView());
