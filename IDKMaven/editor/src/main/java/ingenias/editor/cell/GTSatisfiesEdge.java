...
public class GTSatisfiesEdge extends NAryEdge {

  // Constructor with data content
  public GTSatisfiesEdge(ingenias.editor.entities.GTSatisfies userObject) {
    super(userObject);
    
     this.addRole("GTSatisfiessource");
     this.setArity("GTSatisfiessource",true,1);
     this.setArity("GTSatisfiessource",false,1);
     
this.addClass("GTSatisfiessource","ingenias.editor.entities.Task");
     
this.addClass("GTSatisfiessource","ingenias.editor.entities.Workflow");
     
this.addClass("GTSatisfiessource","ingenias.editor.entities.Plan");
     
    
     this.addRole("GTSatisfiestarget");
     this.setArity("GTSatisfiestarget",true,1);
     this.setArity("GTSatisfiestarget",false,2147483647);
     
this.addClass("GTSatisfiestarget","ingenias.editor.entities.Goal");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof GTSatisfiesEdge)))
      return false;

    // n-edge to be considered.
    GTSatisfiesEdge edge = new GTSatisfiesEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof GTSatisfiesEdge)
      edge = (GTSatisfiesEdge) selectedEdge;
