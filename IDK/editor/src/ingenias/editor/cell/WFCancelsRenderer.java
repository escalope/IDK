...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFCancelsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFCancels",
	index,"/ingenias/editor/rendererxml/WFCancelsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFCancels",
	index,"/ingenias/editor/rendererxml/WFCancelsLABELPanel.xml");
 ...
 public static void setEntity(WFCancels ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFCancels",ent.getPrefs().getView());
