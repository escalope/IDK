...
public class MentalStateManagerWidgetPreferences extends AgentComponentWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public MentalStateManagerWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","ManagerDescription",""};
