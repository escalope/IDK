...
public class WFDecomposesWFView extends NAryView {

static WFDecomposesWFRenderer renderer1 = new WFDecomposesWFRenderer();
 public static WFDecomposesWFRenderer renderer = new WFDecomposesWFRenderer();
  // Constructor.
  public WFDecomposesWFView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFDecomposesWF ent=(ingenias.editor.entities.WFDecomposesWF)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFDecomposesWF ent) {
