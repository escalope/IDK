...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("GTDestroys",
	index,"/rendererxml/GTDestroysNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTDestroys",
	index,"/rendererxml/GTDestroysINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTDestroys",
	index,"/rendererxml/GTDestroysLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.GTDestroys ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTDestroys",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("GTDestroys",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("GTDestroys",c);
	}
