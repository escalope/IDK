...
public class UMLAssociationRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("UMLAssociation",
	index,"/rendererxml/UMLAssociationNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UMLAssociation",
	index,"/rendererxml/UMLAssociationINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UMLAssociation",
	index,"/rendererxml/UMLAssociationLABELPanel.xml");
     ...
     */
     public UMLAssociationRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("UMLAssociation",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.UMLAssociation ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UMLAssociation",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("UMLAssociation",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("UMLAssociation",c);
	}
