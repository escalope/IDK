...
public class AGORelationshipMemberView extends NAryView {

static AGORelationshipMemberRenderer renderer1 = new AGORelationshipMemberRenderer();
 public static AGORelationshipMemberRenderer renderer = new AGORelationshipMemberRenderer();
  // Constructor.
  public AGORelationshipMemberView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGORelationshipMember ent=(ingenias.editor.entities.AGORelationshipMember)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGORelationshipMember ent) {
