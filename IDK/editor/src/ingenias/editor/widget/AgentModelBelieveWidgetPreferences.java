...
public class AgentModelBelieveWidgetPreferences extends BelieveWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public AgentModelBelieveWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Believed",""};
