...
public class ComponentDiagramModelJGraph extends ModelJGraph {
 ...
 entities.add("UMLComment");
    ...
    if (nAryEdgesNum <= 1 && edgesNum == 0) {
      ...
      if (relacion.equalsIgnoreCase("CDUsesCode")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new CDUsesCodeEdge(new CDUsesCode(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("UMLRealizes")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new UMLRealizesEdge(new UMLRealizes(Editor.getNewId()));
        }
      }
  ...
  public DefaultGraphCell createCell(String entity) throws InvalidEntity{
    ...
    INGENIASCodeComponent nentity=getOM().createINGENIASCodeComponent( Editor.getNewId("INGENIASCodeComponent"));
      DefaultGraphCell vertex = new
    ...
    Test nentity=getOM().createTest( Editor.getNewId("Test"));
      DefaultGraphCell vertex = new
          TestCell(nentity);
      // Default Size for the cell with the new entity
     return vertex;
...
JOptionPane.showMessageDialog(IDE.ide,
 ...
 public synchronized JGraph cloneJGraph(){
		 ...
		 ComponentDiagramModelJGraph jg=new  ComponentDiagramModelJGraph(
				(ComponentDiagramDataEntity) this.mde,this.name,IDEAbs.ide.ids.om,
