...
public class OrgDeploymentUnitView extends VertexView {

  public static OrgDeploymentUnitRenderer renderer = new OrgDeploymentUnitRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public OrgDeploymentUnitView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.OrgDeploymentUnit ent=(ingenias.editor.entities.OrgDeploymentUnit)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(OrgDeploymentUnit ent) {
