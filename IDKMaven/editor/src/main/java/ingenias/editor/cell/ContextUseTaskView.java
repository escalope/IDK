...
public class ContextUseTaskView extends VertexView {

  public static ContextUseTaskRenderer renderer = new ContextUseTaskRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ContextUseTaskView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.ContextUseTask ent=(ingenias.editor.entities.ContextUseTask)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ContextUseTask ent) {
