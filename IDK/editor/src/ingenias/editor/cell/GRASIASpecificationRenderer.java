...
public class GRASIASpecificationRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/GRASIASpecificationUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GRASIASpecification",
	index,"/ingenias/editor/rendererxml/GRASIASpecificationINGENIASPanel.xml");
  ...
  public static void setEntity(GRASIASpecification ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GRASIASpecification",ent.getPrefs().getView());
