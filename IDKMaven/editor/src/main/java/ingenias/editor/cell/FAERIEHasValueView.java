...
public class FAERIEHasValueView extends NAryView {

static FAERIEHasValueRenderer renderer1 = new FAERIEHasValueRenderer();
 public static FAERIEHasValueRenderer renderer = new FAERIEHasValueRenderer();
  // Constructor.
  public FAERIEHasValueView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.FAERIEHasValue ent=(ingenias.editor.entities.FAERIEHasValue)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.FAERIEHasValue ent) {
