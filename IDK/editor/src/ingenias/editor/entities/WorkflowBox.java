...
public class WorkflowBox extends INGENIASObject {


  public ingenias.editor.entities.Workflow Workflow;
  ...
  public WorkflowBox(String id) {
    super(id);
    this.setHelpDesc("<br>				A workflow is an abstraction to a process that has been automatised using activities and identifying responsibility relationships.<br>			");
    this.setHelpRecom("");
  }


      public ingenias.editor.entities.Workflow getWorkflow(){
        return Workflow;
      }
       public void setWorkflow(ingenias.editor.entities.Workflow
					Workflow){
