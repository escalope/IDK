...
public class ODecomposesWFRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("ODecomposesWF",
	index,"/rendererxml/ODecomposesWFNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ODecomposesWF",
	index,"/rendererxml/ODecomposesWFINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ODecomposesWF",
	index,"/rendererxml/ODecomposesWFLABELPanel.xml");
     ...
     */
     public ODecomposesWFRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("ODecomposesWF",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.ODecomposesWF ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ODecomposesWF",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("ODecomposesWF",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("ODecomposesWF",c);
	}
