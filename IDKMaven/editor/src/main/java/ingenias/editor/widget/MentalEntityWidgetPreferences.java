...
public class MentalEntityWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public MentalEntityWidgetPreferences() {
  super();
  String[] preferredOrder={""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("ExecutionContext",CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("ExecutionContext",result);
