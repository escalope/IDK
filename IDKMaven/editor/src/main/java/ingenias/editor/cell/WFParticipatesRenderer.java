...
public class WFParticipatesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFParticipates",
	index,"/rendererxml/WFParticipatesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFParticipates",
	index,"/rendererxml/WFParticipatesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFParticipates",
	index,"/rendererxml/WFParticipatesLABELPanel.xml");
     ...
     */
     public WFParticipatesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFParticipates",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.WFParticipates ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFParticipates",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFParticipates",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFParticipates",c);
	}
