...
public class GTAndDependsView extends NAryView {

static GTAndDependsRenderer renderer1 = new GTAndDependsRenderer();
 public static GTAndDependsRenderer renderer = new GTAndDependsRenderer();
  // Constructor.
  public GTAndDependsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GTAndDepends ent=(ingenias.editor.entities.GTAndDepends)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GTAndDepends ent) {
