...
public class TestingPackageWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public TestingPackageWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","TestingDeployment","Tests","Parameters",""};
