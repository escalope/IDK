...
public class HTMLAction extends INGENIASModuleAction {
	...
	throws FileNotFoundException {
		HTMLDocumentGenerator html;
		try {
			html = new HTMLDocumentGenerator(new BrowserImp(ids));
			Properties props = html.getProperties();

			ProjectProperty jadeProjectProperty = (ProjectProperty) props.get(html.getName()+":htmldoc");
			jadeProjectProperty.value= pathProject+"/html";
