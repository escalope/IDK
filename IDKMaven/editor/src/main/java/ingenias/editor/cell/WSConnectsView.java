...
public class WSConnectsView extends NAryView {

static WSConnectsRenderer renderer1 = new WSConnectsRenderer();
 public static WSConnectsRenderer renderer = new WSConnectsRenderer();
  // Constructor.
  public WSConnectsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WSConnects ent=(ingenias.editor.entities.WSConnects)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WSConnects ent) {
