...
public class MemberDplmntRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("MemberDplmnt",
	index,"/rendererxml/MemberDplmntNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("MemberDplmnt",
	index,"/rendererxml/MemberDplmntINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("MemberDplmnt",
	index,"/rendererxml/MemberDplmntLABELPanel.xml");
     ...
     */
     public MemberDplmntRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("MemberDplmnt",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.MemberDplmnt ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("MemberDplmnt",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("MemberDplmnt",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("MemberDplmnt",c);
	}
