...
public class GTDependsView extends NAryView {

static GTDependsRenderer renderer1 = new GTDependsRenderer();
 public static GTDependsRenderer renderer = new GTDependsRenderer();
  // Constructor.
  public GTDependsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GTDepends ent=(ingenias.editor.entities.GTDepends)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GTDepends ent) {
