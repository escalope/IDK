...
public class FrameFactRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/FrameFactUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("FrameFact",
	index,"/ingenias/editor/rendererxml/FrameFactINGENIASPanel.xml");
  ...
  public static void setEntity(FrameFact ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("FrameFact",ent.getPrefs().getView());
