...
public class AGOCondSubordinationRelationshipGroupWidgetPreferences extends EntityWidgetPreferences {
  ...
  public AGOCondSubordinationRelationshipGroupWidgetPreferences() {
  super();
