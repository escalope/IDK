...
public class MentalEntityInstanceCreationRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("MentalEntityInstanceCreation",
	index,"/rendererxml/MentalEntityInstanceCreationUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("MentalEntityInstanceCreation",
	index,"/rendererxml/MentalEntityInstanceCreationINGENIASPanel.xml");
     ...
     */
    public MentalEntityInstanceCreationRenderer() {
    }
    
      public JComponent getConcreteSubComponent(String fieldname, Entity ent, Map map) {
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("MentalEntityInstanceCreation",ent.getPrefs(map).getView());
	  return currentMap.get(fieldname);
  		}

    public Dimension getSize() {
    return RenderComponentManager.getSize("MentalEntityInstanceCreation",current);
    }
  ...
  public static void setEntity(MentalEntityInstanceCreation ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("MentalEntityInstanceCreation",ent.getPrefs(attributes).getView());
  current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("MentalEntityInstanceCreation",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("MentalEntityInstanceCreation",current);
	}
