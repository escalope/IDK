...
public class MentalStateProcessorView extends VertexView {

  public static MentalStateProcessorRenderer renderer = new MentalStateProcessorRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public MentalStateProcessorView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.MentalStateProcessor ent=(ingenias.editor.entities.MentalStateProcessor)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(MentalStateProcessor ent) {
