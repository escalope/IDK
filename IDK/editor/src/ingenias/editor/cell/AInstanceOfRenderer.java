...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AInstanceOfNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AInstanceOf",
	index,"/ingenias/editor/rendererxml/AInstanceOfINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AInstanceOf",
	index,"/ingenias/editor/rendererxml/AInstanceOfLABELPanel.xml");
 ...
 public static void setEntity(AInstanceOf ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AInstanceOf",ent.getPrefs().getView());
