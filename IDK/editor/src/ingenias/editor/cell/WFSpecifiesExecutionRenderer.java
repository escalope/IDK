...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFSpecifiesExecutionNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFSpecifiesExecution",
	index,"/ingenias/editor/rendererxml/WFSpecifiesExecutionINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFSpecifiesExecution",
	index,"/ingenias/editor/rendererxml/WFSpecifiesExecutionLABELPanel.xml");
 ...
 public static void setEntity(WFSpecifiesExecution ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFSpecifiesExecution",ent.getPrefs().getView());
