...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/UIInitiatesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UIInitiates",
	index,"/ingenias/editor/rendererxml/UIInitiatesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UIInitiates",
	index,"/ingenias/editor/rendererxml/UIInitiatesLABELPanel.xml");
 ...
 public static void setEntity(UIInitiates ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UIInitiates",ent.getPrefs().getView());
