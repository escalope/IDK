...
public class InteractionWidgetPreferences extends InteractionUnitWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public InteractionWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Nature",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("Nature",ingenias.editor.widget.CustomJComboBox.class);
   result=new Vector();
   ...
   result.add("centralizedPlanning");
   
   result.add("distributedPlanning");
   
   result.add("negotiation");
   
   result.add("competition");
   
   defaultValues.put("Nature",result);
