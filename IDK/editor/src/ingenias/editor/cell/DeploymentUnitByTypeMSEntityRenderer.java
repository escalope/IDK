...
public class DeploymentUnitByTypeMSEntityRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/DeploymentUnitByTypeMSEntityUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("DeploymentUnitByTypeMSEntity",
	index,"/ingenias/editor/rendererxml/DeploymentUnitByTypeMSEntityINGENIASPanel.xml");
  ...
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("DeploymentUnitByTypeMSEntity",ent.getPrefs().getView());
