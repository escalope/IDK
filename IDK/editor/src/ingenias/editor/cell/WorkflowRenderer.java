...
public class WorkflowRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/WorkflowUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Workflow",
	index,"/ingenias/editor/rendererxml/WorkflowINGENIASPanel.xml");
  ...
  public static void setEntity(Workflow ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Workflow",ent.getPrefs().getView());
