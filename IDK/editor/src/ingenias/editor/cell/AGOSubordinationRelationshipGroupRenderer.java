...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AGOSubordinationRelationshipGroupNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipGroup",
	index,"/ingenias/editor/rendererxml/AGOSubordinationRelationshipGroupINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipGroup",
	index,"/ingenias/editor/rendererxml/AGOSubordinationRelationshipGroupLABELPanel.xml");
