...
public class AgentRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("Agent",
	index,"/rendererxml/AgentUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Agent",
	index,"/rendererxml/AgentINGENIASPanel.xml");
    ...
    public AgentRenderer() {
	  ...
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("Agent",ent.getPrefs(map).getView());
  ...
  public static void setEntity(Agent ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Agent",ent.getPrefs(attributes).getView());
  current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("Agent",
