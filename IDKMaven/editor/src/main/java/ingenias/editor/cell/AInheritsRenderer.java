...
public class AInheritsRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AInherits",
	index,"/rendererxml/AInheritsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AInherits",
	index,"/rendererxml/AInheritsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AInherits",
	index,"/rendererxml/AInheritsLABELPanel.xml");
     ...
     */
     public AInheritsRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AInherits",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AInherits ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AInherits",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AInherits",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AInherits",c);
	}
