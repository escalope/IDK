...
public class IAccessesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("IAccesses",
	index,"/rendererxml/IAccessesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IAccesses",
	index,"/rendererxml/IAccessesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("IAccesses",
	index,"/rendererxml/IAccessesLABELPanel.xml");
     ...
     */
     public IAccessesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("IAccesses",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.IAccesses ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IAccesses",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("IAccesses",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("IAccesses",c);
	}
