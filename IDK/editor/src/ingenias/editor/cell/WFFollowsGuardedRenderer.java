...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFFollowsGuardedNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFFollowsGuarded",
	index,"/ingenias/editor/rendererxml/WFFollowsGuardedINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFFollowsGuarded",
	index,"/ingenias/editor/rendererxml/WFFollowsGuardedLABELPanel.xml");
 ...
 public static void setEntity(WFFollowsGuarded ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFFollowsGuarded",ent.getPrefs().getView());
