...
public class BasicDeployDiagramMarqueeHandler extends MarqueeHandler  implements java.io.Serializable {

	



        public BasicDeployDiagramMarqueeHandler(ModelJGraph graph){
	super(graph);
        }
