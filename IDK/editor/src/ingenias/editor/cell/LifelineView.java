...
public class LifelineView extends VertexView {

  public static LifelineRenderer renderer = new LifelineRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public LifelineView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Lifeline ent=(ingenias.editor.entities.Lifeline)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Lifeline ent) {
