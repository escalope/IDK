...
public class GTSatisfiesView extends NAryView {

static GTSatisfiesRenderer renderer1 = new GTSatisfiesRenderer();
 public static GTSatisfiesRenderer renderer = new GTSatisfiesRenderer();
  // Constructor.
  public GTSatisfiesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GTSatisfies ent=(ingenias.editor.entities.GTSatisfies)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GTSatisfies ent) {
