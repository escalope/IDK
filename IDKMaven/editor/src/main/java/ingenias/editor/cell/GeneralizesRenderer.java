...
public class GeneralizesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("Generalizes",
	index,"/rendererxml/GeneralizesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Generalizes",
	index,"/rendererxml/GeneralizesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("Generalizes",
	index,"/rendererxml/GeneralizesLABELPanel.xml");
     ...
     */
     public GeneralizesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("Generalizes",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.Generalizes ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Generalizes",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("Generalizes",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("Generalizes",c);
	}
