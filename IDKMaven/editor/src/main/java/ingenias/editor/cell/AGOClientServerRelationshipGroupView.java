...
public class AGOClientServerRelationshipGroupView extends NAryView {

static AGOClientServerRelationshipGroupRenderer renderer1 = new AGOClientServerRelationshipGroupRenderer();
 public static AGOClientServerRelationshipGroupRenderer renderer = new AGOClientServerRelationshipGroupRenderer();
  // Constructor.
  public AGOClientServerRelationshipGroupView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGOClientServerRelationshipGroup ent=(ingenias.editor.entities.AGOClientServerRelationshipGroup)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGOClientServerRelationshipGroup ent) {
