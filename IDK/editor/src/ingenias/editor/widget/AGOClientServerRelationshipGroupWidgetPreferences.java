...
public class AGOClientServerRelationshipGroupWidgetPreferences extends EntityWidgetPreferences {
  ...
  public AGOClientServerRelationshipGroupWidgetPreferences() {
  super();
