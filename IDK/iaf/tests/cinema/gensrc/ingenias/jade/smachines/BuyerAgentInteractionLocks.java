...
*/
			...
			public class BuyerAgentInteractionLocks implements CustomLocks {
			
			public BuyerAgentInteractionLocks(){};
			
			        public void addInteractionLocks(String interaction, LocksWriter lw, String role){
                                    
                   if (interaction.equals("Asking_for_a_ticket") && role.equals("Buyer") ){
                            BuyerAsking_for_a_ticketDefaultCommControl.addDefaultLocks(lw);
                   }
                                    
                   if (interaction.equals("BuyerAssignment") && role.equals("Buyer") ){
                            BuyerBuyerAssignmentDefaultCommControl.addDefaultLocks(lw);
                   }
                  
		           // Interactions in which this agent appears as initiator                  
                  
                  if (interaction.equals("Buy_ticket")&& role.equals("Buyer")){
                    BuyerBuy_ticketDefaultCommControl.addDefaultLocks(lw);
                  }
