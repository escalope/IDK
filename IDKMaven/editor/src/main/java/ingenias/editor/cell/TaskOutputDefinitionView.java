...
public class TaskOutputDefinitionView extends VertexView {

  public static TaskOutputDefinitionRenderer renderer = new TaskOutputDefinitionRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public TaskOutputDefinitionView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.TaskOutputDefinition ent=(ingenias.editor.entities.TaskOutputDefinition)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(TaskOutputDefinition ent) {
