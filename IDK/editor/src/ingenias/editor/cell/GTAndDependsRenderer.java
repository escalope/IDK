...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GTAndDependsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTAndDepends",
	index,"/ingenias/editor/rendererxml/GTAndDependsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTAndDepends",
	index,"/ingenias/editor/rendererxml/GTAndDependsLABELPanel.xml");
 ...
 public static void setEntity(GTAndDepends ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTAndDepends",ent.getPrefs().getView());
