...
public class AGOClientServerRelationshipOrgEdge extends NAryEdge {

  // Constructor with data content
  public AGOClientServerRelationshipOrgEdge(ingenias.editor.entities.AGOClientServerRelationshipOrg userObject) {
    super(userObject);
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof AGOClientServerRelationshipOrgEdge)))
      return false;

    // n-edge to be considered.
    AGOClientServerRelationshipOrgEdge edge = new AGOClientServerRelationshipOrgEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof AGOClientServerRelationshipOrgEdge)
      edge = (AGOClientServerRelationshipOrgEdge) selectedEdge;
