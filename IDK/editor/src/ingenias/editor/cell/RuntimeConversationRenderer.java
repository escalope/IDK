...
public class RuntimeConversationRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/RuntimeConversationUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("RuntimeConversation",
	index,"/ingenias/editor/rendererxml/RuntimeConversationINGENIASPanel.xml");
  ...
  public static void setEntity(RuntimeConversation ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("RuntimeConversation",ent.getPrefs().getView());
