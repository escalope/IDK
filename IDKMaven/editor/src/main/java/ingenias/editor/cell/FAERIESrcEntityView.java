...
public class FAERIESrcEntityView extends NAryView {

static FAERIESrcEntityRenderer renderer1 = new FAERIESrcEntityRenderer();
 public static FAERIESrcEntityRenderer renderer = new FAERIESrcEntityRenderer();
  // Constructor.
  public FAERIESrcEntityView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.FAERIESrcEntity ent=(ingenias.editor.entities.FAERIESrcEntity)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.FAERIESrcEntity ent) {
