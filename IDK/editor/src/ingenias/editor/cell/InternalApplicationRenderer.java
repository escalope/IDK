...
public class InternalApplicationRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/InternalApplicationUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("InternalApplication",
	index,"/ingenias/editor/rendererxml/InternalApplicationINGENIASPanel.xml");
  ...
  public static void setEntity(InternalApplication ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("InternalApplication",ent.getPrefs().getView());
