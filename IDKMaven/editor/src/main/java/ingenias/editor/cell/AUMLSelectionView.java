...
public class AUMLSelectionView extends NAryView {

static AUMLSelectionRenderer renderer1 = new AUMLSelectionRenderer();
 public static AUMLSelectionRenderer renderer = new AUMLSelectionRenderer();
  // Constructor.
  public AUMLSelectionView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AUMLSelection ent=(ingenias.editor.entities.AUMLSelection)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AUMLSelection ent) {
