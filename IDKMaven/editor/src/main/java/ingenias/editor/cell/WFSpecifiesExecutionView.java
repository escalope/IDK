...
public class WFSpecifiesExecutionView extends NAryView {

static WFSpecifiesExecutionRenderer renderer1 = new WFSpecifiesExecutionRenderer();
 public static WFSpecifiesExecutionRenderer renderer = new WFSpecifiesExecutionRenderer();
  // Constructor.
  public WFSpecifiesExecutionView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFSpecifiesExecution ent=(ingenias.editor.entities.WFSpecifiesExecution)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFSpecifiesExecution ent) {
