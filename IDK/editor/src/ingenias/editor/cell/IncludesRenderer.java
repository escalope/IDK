...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/IncludesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Includes",
	index,"/ingenias/editor/rendererxml/IncludesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("Includes",
	index,"/ingenias/editor/rendererxml/IncludesLABELPanel.xml");
 ...
 public static void setEntity(Includes ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Includes",ent.getPrefs().getView());
