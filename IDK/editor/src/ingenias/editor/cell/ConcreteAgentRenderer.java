...
public class ConcreteAgentRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/ConcreteAgentUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ConcreteAgent",
	index,"/ingenias/editor/rendererxml/ConcreteAgentINGENIASPanel.xml");
  ...
  public static void setEntity(ConcreteAgent ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ConcreteAgent",ent.getPrefs().getView());
