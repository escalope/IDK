...
public class FAERIECtxtEntityView extends VertexView {

  public static FAERIECtxtEntityRenderer renderer = new FAERIECtxtEntityRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public FAERIECtxtEntityView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.FAERIECtxtEntity ent=(ingenias.editor.entities.FAERIECtxtEntity)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(FAERIECtxtEntity ent) {
