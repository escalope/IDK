...
public Agent1Protocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("Interaction0") && conv.getPlayedRole().equals("Role2")){
		   	DefaultCommControl dcc=new Role2Interaction0DefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new Role2Interaction0StateBehavior(agentName,
				msr, msu,
				conv,                           		
				conv.getPlayedRole(),
			   	actors,
