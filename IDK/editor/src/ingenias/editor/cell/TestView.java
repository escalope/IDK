...
public class TestView extends VertexView {

  public static TestRenderer renderer = new TestRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public TestView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Test ent=(ingenias.editor.entities.Test)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Test ent) {
