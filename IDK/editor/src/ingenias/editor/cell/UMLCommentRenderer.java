...
public class UMLCommentRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/UMLCommentUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UMLComment",
	index,"/ingenias/editor/rendererxml/UMLCommentINGENIASPanel.xml");
  ...
  public static void setEntity(UMLComment ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UMLComment",ent.getPrefs().getView());
