...
public class WFEndsEdge extends NAryEdge {

  // Constructor with data content
  public WFEndsEdge(ingenias.editor.entities.WFEnds userObject) {
    super(userObject);
    
     this.addRole("WFEndssource");
     this.setArity("WFEndssource",true,1);
     this.setArity("WFEndssource",false,1);
     
this.addClass("WFEndssource","ingenias.editor.entities.ActionUML");
     
this.addClass("WFEndssource","ingenias.editor.entities.InitialNode");
     
this.addClass("WFEndssource","ingenias.editor.entities.JoinNode");
     
this.addClass("WFEndssource","ingenias.editor.entities.MergeNode");
     
this.addClass("WFEndssource","ingenias.editor.entities.ForkNode");
     
this.addClass("WFEndssource","ingenias.editor.entities.Task");
...
this.addClass("WFEndssource","ingenias.editor.entities.InitialNode");
     ...
     this.setArity("WFEndstarget",false,1);
     
this.addClass("WFEndstarget","ingenias.editor.entities.EndNode");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof WFEndsEdge)))
      return false;

    // n-edge to be considered.
    WFEndsEdge edge = new WFEndsEdge( null);
