...
public class FAERIECtxtModelView extends VertexView {

  public static FAERIECtxtModelRenderer renderer = new FAERIECtxtModelRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public FAERIECtxtModelView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.FAERIECtxtModel ent=(ingenias.editor.entities.FAERIECtxtModel)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(FAERIECtxtModel ent) {
