...
static FAERIEGeneratedByRenderer renderer1 = new FAERIEGeneratedByRenderer();
 public static FAERIEGeneratedByRenderer renderer = new FAERIEGeneratedByRenderer();
  // Constructor.
  public FAERIEGeneratedByView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.FAERIEGeneratedBy ent=(ingenias.editor.entities.FAERIEGeneratedBy)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.FAERIEGeneratedBy ent) {
