...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AGORelationshipOrgNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGORelationshipOrg",
	index,"/ingenias/editor/rendererxml/AGORelationshipOrgINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGORelationshipOrg",
	index,"/ingenias/editor/rendererxml/AGORelationshipOrgLABELPanel.xml");
 ...
 public static void setEntity(AGORelationshipOrg ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGORelationshipOrg",ent.getPrefs().getView());
