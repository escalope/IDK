...
public class SubProtocolWidgetPreferences extends AUMLContainerWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public SubProtocolWidgetPreferences() {
  super();
  String[] preferredOrder={"Protocol","Description",""};
