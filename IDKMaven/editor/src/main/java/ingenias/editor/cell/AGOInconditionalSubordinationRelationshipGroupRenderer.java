...
public class AGOInconditionalSubordinationRelationshipGroupRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGOInconditionalSubordinationRelationshipGroup",
	index,"/rendererxml/AGOInconditionalSubordinationRelationshipGroupNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOInconditionalSubordinationRelationshipGroup",
	index,"/rendererxml/AGOInconditionalSubordinationRelationshipGroupINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOInconditionalSubordinationRelationshipGroup",
	index,"/rendererxml/AGOInconditionalSubordinationRelationshipGroupLABELPanel.xml");
     ...
     */
     public AGOInconditionalSubordinationRelationshipGroupRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGOInconditionalSubordinationRelationshipGroup",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGOInconditionalSubordinationRelationshipGroup ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOInconditionalSubordinationRelationshipGroup",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGOInconditionalSubordinationRelationshipGroup",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGOInconditionalSubordinationRelationshipGroup",c);
	}
