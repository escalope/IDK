...
public class AHasMSRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AHasMS",
	index,"/rendererxml/AHasMSNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AHasMS",
	index,"/rendererxml/AHasMSINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AHasMS",
	index,"/rendererxml/AHasMSLABELPanel.xml");
     ...
     */
     public AHasMSRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AHasMS",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AHasMS ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AHasMS",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AHasMS",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AHasMS",c);
	}
