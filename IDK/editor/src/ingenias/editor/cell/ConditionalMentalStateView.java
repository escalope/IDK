...
public class ConditionalMentalStateView extends VertexView {

  public static ConditionalMentalStateRenderer renderer = new ConditionalMentalStateRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ConditionalMentalStateView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.ConditionalMentalState ent=(ingenias.editor.entities.ConditionalMentalState)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ConditionalMentalState ent) {
