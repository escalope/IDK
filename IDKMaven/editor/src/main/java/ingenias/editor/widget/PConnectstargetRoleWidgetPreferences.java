...
public class PConnectstargetRoleWidgetPreferences extends EntityWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public PConnectstargetRoleWidgetPreferences() {
  super();
  String[] preferredOrder={"TaskInput",""};
