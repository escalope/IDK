...
public class RuntimeConversationWidgetPreferences extends ConversationWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public RuntimeConversationWidgetPreferences() {
  super();
  ...
  this.setPreferredOrder(preferredOrder);
   ...
   preferredWidget.put("AbortCode",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("AbortCode",result);
