...
public class WorkflowView extends VertexView {

  public static WorkflowRenderer renderer = new WorkflowRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public WorkflowView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Workflow ent=(ingenias.editor.entities.Workflow)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Workflow ent) {
