...
public class WFTestFinalStateView extends VertexView {

  public static WFTestFinalStateRenderer renderer = new WFTestFinalStateRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public WFTestFinalStateView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.WFTestFinalState ent=(ingenias.editor.entities.WFTestFinalState)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(WFTestFinalState ent) {
