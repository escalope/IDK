...
public class WFPursueRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFPursue",
	index,"/rendererxml/WFPursueNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFPursue",
	index,"/rendererxml/WFPursueINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFPursue",
	index,"/rendererxml/WFPursueLABELPanel.xml");
     ...
     */
     public WFPursueRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFPursue",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.WFPursue ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFPursue",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFPursue",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFPursue",c);
	}
