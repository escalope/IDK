...
public class AGORelationshipOrgRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGORelationshipOrg",
	index,"/rendererxml/AGORelationshipOrgNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGORelationshipOrg",
	index,"/rendererxml/AGORelationshipOrgINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGORelationshipOrg",
	index,"/rendererxml/AGORelationshipOrgLABELPanel.xml");
     ...
     */
     public AGORelationshipOrgRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGORelationshipOrg",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGORelationshipOrg ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGORelationshipOrg",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGORelationshipOrg",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGORelationshipOrg",c);
	}
