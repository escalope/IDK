...
public class WFCancelsRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFCancels",
	index,"/rendererxml/WFCancelsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFCancels",
	index,"/rendererxml/WFCancelsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFCancels",
	index,"/rendererxml/WFCancelsLABELPanel.xml");
     ...
     */
     public WFCancelsRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFCancels",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.WFCancels ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFCancels",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFCancels",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFCancels",c);
	}
