...
public class ContributePositivelyView extends NAryView {

static ContributePositivelyRenderer renderer1 = new ContributePositivelyRenderer();
 public static ContributePositivelyRenderer renderer = new ContributePositivelyRenderer();
  // Constructor.
  public ContributePositivelyView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.ContributePositively ent=(ingenias.editor.entities.ContributePositively)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.ContributePositively ent) {
