...
public class AHasMSManagerRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AHasMSManager",
	index,"/rendererxml/AHasMSManagerNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AHasMSManager",
	index,"/rendererxml/AHasMSManagerINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AHasMSManager",
	index,"/rendererxml/AHasMSManagerLABELPanel.xml");
     ...
     */
     public AHasMSManagerRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AHasMSManager",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AHasMSManager ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AHasMSManager",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AHasMSManager",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AHasMSManager",c);
	}
