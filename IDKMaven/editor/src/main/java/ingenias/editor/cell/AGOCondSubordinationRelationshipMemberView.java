...
public class AGOCondSubordinationRelationshipMemberView extends NAryView {

static AGOCondSubordinationRelationshipMemberRenderer renderer1 = new AGOCondSubordinationRelationshipMemberRenderer();
 public static AGOCondSubordinationRelationshipMemberRenderer renderer = new AGOCondSubordinationRelationshipMemberRenderer();
  // Constructor.
  public AGOCondSubordinationRelationshipMemberView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGOCondSubordinationRelationshipMember ent=(ingenias.editor.entities.AGOCondSubordinationRelationshipMember)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGOCondSubordinationRelationshipMember ent) {
