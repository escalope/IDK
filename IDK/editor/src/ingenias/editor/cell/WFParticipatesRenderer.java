...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFParticipatesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFParticipates",
	index,"/ingenias/editor/rendererxml/WFParticipatesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFParticipates",
	index,"/ingenias/editor/rendererxml/WFParticipatesLABELPanel.xml");
 ...
 public static void setEntity(WFParticipates ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFParticipates",ent.getPrefs().getView());
