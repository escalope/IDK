...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GeneralizesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Generalizes",
	index,"/ingenias/editor/rendererxml/GeneralizesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("Generalizes",
	index,"/ingenias/editor/rendererxml/GeneralizesLABELPanel.xml");
 ...
 public static void setEntity(Generalizes ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Generalizes",ent.getPrefs().getView());
