...
public class WFPlaysView extends NAryView {

static WFPlaysRenderer renderer1 = new WFPlaysRenderer();
 public static WFPlaysRenderer renderer = new WFPlaysRenderer();
  // Constructor.
  public WFPlaysView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFPlays ent=(ingenias.editor.entities.WFPlays)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFPlays ent) {
