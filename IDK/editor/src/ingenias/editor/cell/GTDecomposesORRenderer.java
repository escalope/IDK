...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GTDecomposesORNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTDecomposesOR",
	index,"/ingenias/editor/rendererxml/GTDecomposesORINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTDecomposesOR",
	index,"/ingenias/editor/rendererxml/GTDecomposesORLABELPanel.xml");
 ...
 public static void setEntity(GTDecomposesOR ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTDecomposesOR",ent.getPrefs().getView());
