...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/rendererxml/ExtendsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Extends",
	index,"/rendererxml/ExtendsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("Extends",
	index,"/rendererxml/ExtendsLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.Extends ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Extends",ent.getPrefs(attributes).getView());
