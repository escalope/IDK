...
public class UIPrecedesView extends NAryView {

static UIPrecedesRenderer renderer1 = new UIPrecedesRenderer();
 public static UIPrecedesRenderer renderer = new UIPrecedesRenderer();
  // Constructor.
  public UIPrecedesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.UIPrecedes ent=(ingenias.editor.entities.UIPrecedes)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.UIPrecedes ent) {
