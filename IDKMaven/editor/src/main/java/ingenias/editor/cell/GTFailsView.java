...
public class GTFailsView extends NAryView {

static GTFailsRenderer renderer1 = new GTFailsRenderer();
 public static GTFailsRenderer renderer = new GTFailsRenderer();
  // Constructor.
  public GTFailsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GTFails ent=(ingenias.editor.entities.GTFails)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GTFails ent) {
