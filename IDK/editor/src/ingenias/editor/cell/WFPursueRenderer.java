...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFPursueNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFPursue",
	index,"/ingenias/editor/rendererxml/WFPursueINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFPursue",
	index,"/ingenias/editor/rendererxml/WFPursueLABELPanel.xml");
 ...
 public static void setEntity(WFPursue ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFPursue",ent.getPrefs().getView());
