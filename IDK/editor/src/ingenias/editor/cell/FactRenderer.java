...
public class FactRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/FactUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Fact",
	index,"/ingenias/editor/rendererxml/FactINGENIASPanel.xml");
  ...
  public static void setEntity(Fact ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Fact",ent.getPrefs().getView());
