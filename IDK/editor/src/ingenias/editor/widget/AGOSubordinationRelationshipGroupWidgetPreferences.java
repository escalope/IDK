...
public class AGOSubordinationRelationshipGroupWidgetPreferences extends EntityWidgetPreferences {
  ...
  public AGOSubordinationRelationshipGroupWidgetPreferences() {
  super();
