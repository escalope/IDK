...
public class UIInitiatesView extends NAryView {

static UIInitiatesRenderer renderer1 = new UIInitiatesRenderer();
 public static UIInitiatesRenderer renderer = new UIInitiatesRenderer();
  // Constructor.
  public UIInitiatesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.UIInitiates ent=(ingenias.editor.entities.UIInitiates)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.UIInitiates ent) {
