...
public class MentalInstanceSpecificationRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/MentalInstanceSpecificationUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("MentalInstanceSpecification",
	index,"/ingenias/editor/rendererxml/MentalInstanceSpecificationINGENIASPanel.xml");
  ...
  public static void setEntity(MentalInstanceSpecification ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("MentalInstanceSpecification",ent.getPrefs().getView());
