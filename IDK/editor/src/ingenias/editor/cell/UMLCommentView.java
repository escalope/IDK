...
public class UMLCommentView extends VertexView {

  public static UMLCommentRenderer renderer = new UMLCommentRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public UMLCommentView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.UMLComment ent=(ingenias.editor.entities.UMLComment)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(UMLComment ent) {
