...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AHasMSNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AHasMS",
	index,"/ingenias/editor/rendererxml/AHasMSINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AHasMS",
	index,"/ingenias/editor/rendererxml/AHasMSLABELPanel.xml");
 ...
 public static void setEntity(AHasMS ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AHasMS",ent.getPrefs().getView());
