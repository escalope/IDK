...
public class AGORelationshipMemberRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGORelationshipMember",
	index,"/rendererxml/AGORelationshipMemberNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGORelationshipMember",
	index,"/rendererxml/AGORelationshipMemberINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGORelationshipMember",
	index,"/rendererxml/AGORelationshipMemberLABELPanel.xml");
     ...
     */
     public AGORelationshipMemberRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGORelationshipMember",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGORelationshipMember ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGORelationshipMember",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGORelationshipMember",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGORelationshipMember",c);
	}
