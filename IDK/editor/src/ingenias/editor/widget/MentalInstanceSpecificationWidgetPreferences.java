...
public class MentalInstanceSpecificationWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public MentalInstanceSpecificationWidgetPreferences() {
  super();
  String[] preferredOrder={"id","InstanceType","Description","SlotsValues",""};
