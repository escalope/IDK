...
public class IUConcurrenceRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("IUConcurrence",
	index,"/rendererxml/IUConcurrenceUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IUConcurrence",
	index,"/rendererxml/IUConcurrenceINGENIASPanel.xml");
     ...
     */
    public IUConcurrenceRenderer() {
    }
    
      public JComponent getConcreteSubComponent(String fieldname, Entity ent, Map map) {
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("IUConcurrence",ent.getPrefs(map).getView());
	  return currentMap.get(fieldname);
  		}

    public Dimension getSize() {
    return RenderComponentManager.getSize("IUConcurrence",current);
    }
  ...
  public static void setEntity(IUConcurrence ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IUConcurrence",ent.getPrefs(attributes).getView());
  current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("IUConcurrence",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("IUConcurrence",current);
	}
