...
public class RoleView extends VertexView {
  ...
  public static RoleRenderer renderer = new RoleRenderer();
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Role ent=(ingenias.editor.entities.Role)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Role ent) {
