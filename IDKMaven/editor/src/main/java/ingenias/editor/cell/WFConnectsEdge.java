...
public class WFConnectsEdge extends NAryEdge {

  // Constructor with data content
  public WFConnectsEdge(ingenias.editor.entities.WFConnects userObject) {
    super(userObject);
    
     this.addRole("WFConnectssource");
     this.setArity("WFConnectssource",true,1);
     this.setArity("WFConnectssource",false,1);
     
this.addClass("WFConnectssource","ingenias.editor.entities.Workflow");
     
this.addClass("WFConnectssource","ingenias.editor.entities.Task");
     
    
     this.addRole("WFConnectstarget");
     this.setArity("WFConnectstarget",true,1);
     this.setArity("WFConnectstarget",false,2147483647);
     
this.addClass("WFConnectstarget","ingenias.editor.entities.Workflow");
     
this.addClass("WFConnectstarget","ingenias.editor.entities.Task");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof WFConnectsEdge)))
      return false;

    // n-edge to be considered.
    WFConnectsEdge edge = new WFConnectsEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof WFConnectsEdge)
      edge = (WFConnectsEdge) selectedEdge;
