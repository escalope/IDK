...
public class SimExtractedInformationWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public SimExtractedInformationWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","PollEachSimTimeUnits","PollAgentsInDeployment","EntitiesToExtract",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("PollEachSimTimeUnits",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("PollEachSimTimeUnits",result);
