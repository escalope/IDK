...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFPlaysNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFPlays",
	index,"/ingenias/editor/rendererxml/WFPlaysINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFPlays",
	index,"/ingenias/editor/rendererxml/WFPlaysLABELPanel.xml");
 ...
 public static void setEntity(WFPlays ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFPlays",ent.getPrefs().getView());
