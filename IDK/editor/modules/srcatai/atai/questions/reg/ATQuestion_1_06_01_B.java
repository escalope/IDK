...
public class ATQuestion_1_06_01_B extends ATQuestion {
	 ...
	 */
	static private String description = "The component will introduce changes " +
		"in the current work practices of the actor and his environment. " +
		"Among existing goals, what ones do you consider that must not suffer modifications?";
	/**
	 ...
	 */
	static ATQuestion_1_06_01_B theInstance = null;
...
//////////// ¿SERÁ ESTO NECESARIO?		
	...
	protected ATQuestion_1_06_01_B() {
		super();
		this.setArea(ATQuestion_1_06_01_B.area);
		this.setAspect(ATQuestion_1_06_01_B.aspect);
		this.setId(ATQuestion_1_06_01_B.id);
		this.setDescription(ATQuestion_1_06_01_B.description);
		this.setQuestion(ATQuestion_1_06_01_B.question);
		this.setTextualQuestion(ATQuestion_1_06_01_B.textualQuestion);
	}
	
	
	
	static public ATQuestion_1_06_01_B getInstance() {
		if (ATQuestion_1_06_01_B.theInstance == null)
			ATQuestion_1_06_01_B.theInstance = new ATQuestion_1_06_01_B();
		return ATQuestion_1_06_01_B.theInstance;
	}
