...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AHasMSProcessorNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AHasMSProcessor",
	index,"/ingenias/editor/rendererxml/AHasMSProcessorINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AHasMSProcessor",
	index,"/ingenias/editor/rendererxml/AHasMSProcessorLABELPanel.xml");
 ...
 public static void setEntity(AHasMSProcessor ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AHasMSProcessor",ent.getPrefs().getView());
