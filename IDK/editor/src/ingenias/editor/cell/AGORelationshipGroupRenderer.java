...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AGORelationshipGroupNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGORelationshipGroup",
	index,"/ingenias/editor/rendererxml/AGORelationshipGroupINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGORelationshipGroup",
	index,"/ingenias/editor/rendererxml/AGORelationshipGroupLABELPanel.xml");
 ...
 public static void setEntity(AGORelationshipGroup ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGORelationshipGroup",ent.getPrefs().getView());
