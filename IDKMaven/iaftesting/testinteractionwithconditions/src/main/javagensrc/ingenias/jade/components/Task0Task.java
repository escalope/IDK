...
public class Task0Task extends Task{
 ...
 public void execute() throws TaskException{
        ...
        ApplicationEventSlots0  eiApplicationEventSlots0=(ApplicationEventSlots0)this.getFirstInputOfType("ApplicationEventSlots0");             
		...
		FrameFact0 outputsdefaultFrameFact0=
			(FrameFact0)
				outputsdefault.getEntityByType("FrameFact0");								
