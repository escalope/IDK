...
public class AGOSubordinationRelationshipMemberWidgetPreferences extends EntityWidgetPreferences {
  ...
  public AGOSubordinationRelationshipMemberWidgetPreferences() {
  super();
