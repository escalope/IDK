...
public class EnvironmentApplicationRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/EnvironmentApplicationUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("EnvironmentApplication",
	index,"/ingenias/editor/rendererxml/EnvironmentApplicationINGENIASPanel.xml");
  ...
  public static void setEntity(EnvironmentApplication ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("EnvironmentApplication",ent.getPrefs().getView());
