...
public class EResourceBelongsToView extends NAryView {

static EResourceBelongsToRenderer renderer1 = new EResourceBelongsToRenderer();
 public static EResourceBelongsToRenderer renderer = new EResourceBelongsToRenderer();
  // Constructor.
  public EResourceBelongsToView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.EResourceBelongsTo ent=(ingenias.editor.entities.EResourceBelongsTo)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.EResourceBelongsTo ent) {
