...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/rendererxml/WFConsumesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFConsumes",
	index,"/rendererxml/WFConsumesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFConsumes",
	index,"/rendererxml/WFConsumesLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.WFConsumes ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFConsumes",ent.getPrefs(attributes).getView());
