...
public class InitialNodeView extends VertexView {

  public static InitialNodeRenderer renderer = new InitialNodeRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public InitialNodeView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.InitialNode ent=(ingenias.editor.entities.InitialNode)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(InitialNode ent) {
