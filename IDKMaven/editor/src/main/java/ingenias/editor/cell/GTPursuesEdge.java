...
public class GTPursuesEdge extends NAryEdge {

  // Constructor with data content
  public GTPursuesEdge(ingenias.editor.entities.GTPursues userObject) {
    super(userObject);
    
     this.addRole("GTPursuessource");
     this.setArity("GTPursuessource",true,1);
     this.setArity("GTPursuessource",false,1);
     
this.addClass("GTPursuessource","ingenias.editor.entities.Autonomous_entity");
     
this.addClass("GTPursuessource","ingenias.editor.entities.Role");
     
this.addClass("GTPursuessource","ingenias.editor.entities.AutonomousEntityQuery");
     
    
     this.addRole("GTPursuestarget");
     this.setArity("GTPursuestarget",true,1);
     this.setArity("GTPursuestarget",false,2147483647);
     
this.addClass("GTPursuestarget","ingenias.editor.entities.Goal");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof GTPursuesEdge)))
      return false;

    // n-edge to be considered.
    GTPursuesEdge edge = new GTPursuesEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof GTPursuesEdge)
      edge = (GTPursuesEdge) selectedEdge;
