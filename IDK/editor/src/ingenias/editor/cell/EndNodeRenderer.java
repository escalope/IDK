...
public class EndNodeRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/EndNodeUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("EndNode",
	index,"/ingenias/editor/rendererxml/EndNodeINGENIASPanel.xml");
  ...
  public static void setEntity(EndNode ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("EndNode",ent.getPrefs().getView());
