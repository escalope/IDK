...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/DefinesDeploymentNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("DefinesDeployment",
	index,"/ingenias/editor/rendererxml/DefinesDeploymentINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("DefinesDeployment",
	index,"/ingenias/editor/rendererxml/DefinesDeploymentLABELPanel.xml");
 ...
 public static void setEntity(DefinesDeployment ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("DefinesDeployment",ent.getPrefs().getView());
