...
public class FAERIECtxtValueView extends VertexView {

  public static FAERIECtxtValueRenderer renderer = new FAERIECtxtValueRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public FAERIECtxtValueView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.FAERIECtxtValue ent=(ingenias.editor.entities.FAERIECtxtValue)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(FAERIECtxtValue ent) {
