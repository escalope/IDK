...
public class WFEndsView extends NAryView {

static WFEndsRenderer renderer1 = new WFEndsRenderer();
 public static WFEndsRenderer renderer = new WFEndsRenderer();
  // Constructor.
  public WFEndsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFEnds ent=(ingenias.editor.entities.WFEnds)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFEnds ent) {
