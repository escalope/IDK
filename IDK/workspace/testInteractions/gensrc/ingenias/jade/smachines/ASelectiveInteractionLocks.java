...
*/
			...
			public class ASelectiveInteractionLocks implements CustomLocks {
			
			public ASelectiveInteractionLocks(){};
                  ...
                  if (interaction.equals("IntExample")){
                    InitiatorIntExampleDefaultCommControl.addDefaultLocks(lw);
                  }
