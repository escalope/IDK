...
public class WFCancelsView extends NAryView {

static WFCancelsRenderer renderer1 = new WFCancelsRenderer();
 public static WFCancelsRenderer renderer = new WFCancelsRenderer();
  // Constructor.
  public WFCancelsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFCancels ent=(ingenias.editor.entities.WFCancels)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFCancels ent) {
