...
public class IColaboratesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("IColaborates",
	index,"/rendererxml/IColaboratesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IColaborates",
	index,"/rendererxml/IColaboratesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("IColaborates",
	index,"/rendererxml/IColaboratesLABELPanel.xml");
     ...
     */
     public IColaboratesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("IColaborates",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.IColaborates ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IColaborates",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("IColaborates",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("IColaborates",c);
	}
