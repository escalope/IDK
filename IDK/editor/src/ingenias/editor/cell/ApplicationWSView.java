...
public class ApplicationWSView extends VertexView {

  public static ApplicationWSRenderer renderer = new ApplicationWSRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ApplicationWSView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.ApplicationWS ent=(ingenias.editor.entities.ApplicationWS)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ApplicationWS ent) {
