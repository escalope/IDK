...
public class IHasSpecRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("IHasSpec",
	index,"/rendererxml/IHasSpecNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IHasSpec",
	index,"/rendererxml/IHasSpecINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("IHasSpec",
	index,"/rendererxml/IHasSpecLABELPanel.xml");
     ...
     */
     public IHasSpecRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("IHasSpec",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.IHasSpec ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IHasSpec",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("IHasSpec",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("IHasSpec",c);
	}
