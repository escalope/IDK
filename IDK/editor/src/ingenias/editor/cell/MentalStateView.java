...
public class MentalStateView extends VertexView {

  public static MentalStateRenderer renderer = new MentalStateRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public MentalStateView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.MentalState ent=(ingenias.editor.entities.MentalState)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(MentalState ent) {
