...
public class FAERIECtxtModelInstWidgetPreferences extends AMIContextInstantiationWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public FAERIECtxtModelInstWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Model","EntityInstances",""};
