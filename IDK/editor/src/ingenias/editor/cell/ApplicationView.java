...
public class ApplicationView extends VertexView {

  public static ApplicationRenderer renderer = new ApplicationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ApplicationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Application ent=(ingenias.editor.entities.Application)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Application ent) {
