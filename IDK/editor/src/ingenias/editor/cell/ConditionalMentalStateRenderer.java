...
public class ConditionalMentalStateRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/ConditionalMentalStateUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ConditionalMentalState",
	index,"/ingenias/editor/rendererxml/ConditionalMentalStateINGENIASPanel.xml");
  ...
  public static void setEntity(ConditionalMentalState ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ConditionalMentalState",ent.getPrefs().getView());
