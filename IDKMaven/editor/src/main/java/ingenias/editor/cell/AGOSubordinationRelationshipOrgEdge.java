...
public class AGOSubordinationRelationshipOrgEdge extends NAryEdge {

  // Constructor with data content
  public AGOSubordinationRelationshipOrgEdge(ingenias.editor.entities.AGOSubordinationRelationshipOrg userObject) {
    super(userObject);
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof AGOSubordinationRelationshipOrgEdge)))
      return false;

    // n-edge to be considered.
    AGOSubordinationRelationshipOrgEdge edge = new AGOSubordinationRelationshipOrgEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof AGOSubordinationRelationshipOrgEdge)
      edge = (AGOSubordinationRelationshipOrgEdge) selectedEdge;
