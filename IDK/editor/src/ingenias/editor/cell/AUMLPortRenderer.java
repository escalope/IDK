...
public class AUMLPortRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/AUMLPortUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLPort",
	index,"/ingenias/editor/rendererxml/AUMLPortINGENIASPanel.xml");
  ...
  public static void setEntity(AUMLPort ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLPort",ent.getPrefs().getView());
