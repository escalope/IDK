...
public class AUMLSpecificationView extends VertexView {

  public static AUMLSpecificationRenderer renderer = new AUMLSpecificationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public AUMLSpecificationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.AUMLSpecification ent=(ingenias.editor.entities.AUMLSpecification)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(AUMLSpecification ent) {
