...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/UIColaboratesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UIColaborates",
	index,"/ingenias/editor/rendererxml/UIColaboratesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UIColaborates",
	index,"/ingenias/editor/rendererxml/UIColaboratesLABELPanel.xml");
 ...
 public static void setEntity(UIColaborates ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UIColaborates",ent.getPrefs().getView());
