...
public class OHasWFRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("OHasWF",
	index,"/rendererxml/OHasWFNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("OHasWF",
	index,"/rendererxml/OHasWFINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("OHasWF",
	index,"/rendererxml/OHasWFLABELPanel.xml");
     ...
     */
     public OHasWFRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("OHasWF",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.OHasWF ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("OHasWF",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("OHasWF",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("OHasWF",c);
	}
