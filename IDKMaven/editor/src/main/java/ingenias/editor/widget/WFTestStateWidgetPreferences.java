...
public class WFTestStateWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public WFTestStateWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","PartID","Task",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("PartID",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("PartID",result);
