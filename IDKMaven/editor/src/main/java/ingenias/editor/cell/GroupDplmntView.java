...
public class GroupDplmntView extends NAryView {

static GroupDplmntRenderer renderer1 = new GroupDplmntRenderer();
 public static GroupDplmntRenderer renderer = new GroupDplmntRenderer();
  // Constructor.
  public GroupDplmntView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GroupDplmnt ent=(ingenias.editor.entities.GroupDplmnt)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GroupDplmnt ent) {
