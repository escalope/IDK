...
public class MessagePassingView extends VertexView {

  public static MessagePassingRenderer renderer = new MessagePassingRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public MessagePassingView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.MessagePassing ent=(ingenias.editor.entities.MessagePassing)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(MessagePassing ent) {
