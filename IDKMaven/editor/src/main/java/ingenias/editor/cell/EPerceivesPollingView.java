...
public class EPerceivesPollingView extends NAryView {

static EPerceivesPollingRenderer renderer1 = new EPerceivesPollingRenderer();
 public static EPerceivesPollingRenderer renderer = new EPerceivesPollingRenderer();
  // Constructor.
  public EPerceivesPollingView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.EPerceivesPolling ent=(ingenias.editor.entities.EPerceivesPolling)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.EPerceivesPolling ent) {
