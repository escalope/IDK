...
public class TaskWSView extends VertexView {

  public static TaskWSRenderer renderer = new TaskWSRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public TaskWSView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.TaskWS ent=(ingenias.editor.entities.TaskWS)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(TaskWS ent) {
