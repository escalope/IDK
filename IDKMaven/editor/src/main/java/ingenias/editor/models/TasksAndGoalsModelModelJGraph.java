...
public class TasksAndGoalsModelModelJGraph extends ModelJGraph {
  ...
  protected void creaToolBar() {
   ...
   if (true){
    ...
    jb.setText("");
    jb.setName("Resource");	
    jb.setToolTipText("Resource:"+new Resource("").getHelpDesc()+"\n\n"+new Resource("").getHelpRecom());
    jb.addMouseListener(new MouseAdapter() {
				    final int defaultDismissTimeout = ToolTipManager.sharedInstance().getDismissDelay();
				    final int dismissDelayMinutes = (int) TimeUnit.MINUTES.toMillis(10); // 10 minutes
				    @Override
   ...
   if (true){
    ...
    jb.setToolTipText("MentalEntityInstanceCreation:"+new MentalEntityInstanceCreation("").getHelpDesc()+"\n\n"+new MentalEntityInstanceCreation("").getHelpRecom());
    jb.addMouseListener(new MouseAdapter() {
				    final int defaultDismissTimeout = ToolTipManager.sharedInstance().getDismissDelay();
				    final int dismissDelayMinutes = (int) TimeUnit.MINUTES.toMillis(10); // 10 minutes
				    @Override
   ...
   if (true){
    ...
    jb.setToolTipText("MentalEntityInstanceAccess:"+new MentalEntityInstanceAccess("").getHelpDesc()+"\n\n"+new MentalEntityInstanceAccess("").getHelpRecom());
    jb.addMouseListener(new MouseAdapter() {
				    final int defaultDismissTimeout = ToolTipManager.sharedInstance().getDismissDelay();
				    final int dismissDelayMinutes = (int) TimeUnit.MINUTES.toMillis(10); // 10 minutes
				    @Override
   ...
   if (true){
    ...
    jb.setText("");
    jb.setName("Workflow");	
    jb.setToolTipText("Workflow:"+new Workflow("").getHelpDesc()+"\n\n"+new Workflow("").getHelpRecom());
    jb.addMouseListener(new MouseAdapter() {
				    final int defaultDismissTimeout = ToolTipManager.sharedInstance().getDismissDelay();
				    final int dismissDelayMinutes = (int) TimeUnit.MINUTES.toMillis(10); // 10 minutes
				    @Override
   ...
   if (true){
    ...
    jb.setText("");
    jb.setName("RoleWS");	
    jb.setToolTipText("RoleWS:"+new RoleWS("").getHelpDesc()+"\n\n"+new RoleWS("").getHelpRecom());
    jb.addMouseListener(new MouseAdapter() {
				    final int defaultDismissTimeout = ToolTipManager.sharedInstance().getDismissDelay();
				    final int dismissDelayMinutes = (int) TimeUnit.MINUTES.toMillis(10); // 10 minutes
				    @Override
   ...
   if (true){
    ...
    jb.setToolTipText("ApplicationWS:"+new ApplicationWS("").getHelpDesc()+"\n\n"+new ApplicationWS("").getHelpRecom());
    jb.addMouseListener(new MouseAdapter() {
				    final int defaultDismissTimeout = ToolTipManager.sharedInstance().getDismissDelay();
				    final int dismissDelayMinutes = (int) TimeUnit.MINUTES.toMillis(10); // 10 minutes
				    @Override
   ...
   if (false){
    ...
    jb.setToolTipText("RemoteProcedureCall:"+new RemoteProcedureCall("").getHelpDesc()+"\n\n"+new RemoteProcedureCall("").getHelpRecom());
    jb.addMouseListener(new MouseAdapter() {
				    final int defaultDismissTimeout = ToolTipManager.sharedInstance().getDismissDelay();
				    final int dismissDelayMinutes = (int) TimeUnit.MINUTES.toMillis(10); // 10 minutes
				    @Override
   ...
   if (false){
    ...
    jb.setToolTipText("IUIterate:"+new IUIterate("").getHelpDesc()+"\n\n"+new IUIterate("").getHelpRecom());
    jb.addMouseListener(new MouseAdapter() {
				    final int defaultDismissTimeout = ToolTipManager.sharedInstance().getDismissDelay();
				    final int dismissDelayMinutes = (int) TimeUnit.MINUTES.toMillis(10); // 10 minutes
				    @Override
   ...
   if (false){
    ...
    jb.setToolTipText("MessagePassing:"+new MessagePassing("").getHelpDesc()+"\n\n"+new MessagePassing("").getHelpRecom());
    jb.addMouseListener(new MouseAdapter() {
				    final int defaultDismissTimeout = ToolTipManager.sharedInstance().getDismissDelay();
				    final int dismissDelayMinutes = (int) TimeUnit.MINUTES.toMillis(10); // 10 minutes
				    @Override
   ...
   if (false){
    ...
    jb.setToolTipText("ShareTouple:"+new ShareTouple("").getHelpDesc()+"\n\n"+new ShareTouple("").getHelpRecom());
    jb.addMouseListener(new MouseAdapter() {
				    final int defaultDismissTimeout = ToolTipManager.sharedInstance().getDismissDelay();
				    final int dismissDelayMinutes = (int) TimeUnit.MINUTES.toMillis(10); // 10 minutes
				    @Override
   ...
   if (false){
    ...
    jb.setToolTipText("IUConcurrence:"+new IUConcurrence("").getHelpDesc()+"\n\n"+new IUConcurrence("").getHelpRecom());
    jb.addMouseListener(new MouseAdapter() {
				    final int defaultDismissTimeout = ToolTipManager.sharedInstance().getDismissDelay();
				    final int dismissDelayMinutes = (int) TimeUnit.MINUTES.toMillis(10); // 10 minutes
				    @Override
   ...
   if (false){
    ...
    jb.setToolTipText("InteractionUnit:"+new InteractionUnit("").getHelpDesc()+"\n\n"+new InteractionUnit("").getHelpRecom());
    jb.addMouseListener(new MouseAdapter() {
				    final int defaultDismissTimeout = ToolTipManager.sharedInstance().getDismissDelay();
				    final int dismissDelayMinutes = (int) TimeUnit.MINUTES.toMillis(10); // 10 minutes
				    @Override
