...
public class MentalInstanceSpecificationView extends VertexView {

  public static MentalInstanceSpecificationRenderer renderer = new MentalInstanceSpecificationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public MentalInstanceSpecificationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.MentalInstanceSpecification ent=(ingenias.editor.entities.MentalInstanceSpecification)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(MentalInstanceSpecification ent) {
