...
public class WFParticipatesView extends NAryView {

static WFParticipatesRenderer renderer1 = new WFParticipatesRenderer();
 public static WFParticipatesRenderer renderer = new WFParticipatesRenderer();
  // Constructor.
  public WFParticipatesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFParticipates ent=(ingenias.editor.entities.WFParticipates)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFParticipates ent) {
