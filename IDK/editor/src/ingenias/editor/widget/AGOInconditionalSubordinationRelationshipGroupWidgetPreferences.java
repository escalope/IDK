...
public class AGOInconditionalSubordinationRelationshipGroupWidgetPreferences extends EntityWidgetPreferences {
  ...
  public AGOInconditionalSubordinationRelationshipGroupWidgetPreferences() {
  super();
