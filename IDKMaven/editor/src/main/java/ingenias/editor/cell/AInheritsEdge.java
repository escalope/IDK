...
public class AInheritsEdge extends NAryEdge {

  // Constructor with data content
  public AInheritsEdge(ingenias.editor.entities.AInherits userObject) {
    super(userObject);
    
     this.addRole("AInheritssource");
     this.setArity("AInheritssource",true,1);
     this.setArity("AInheritssource",false,1);
     
this.addClass("AInheritssource","ingenias.editor.entities.Agent");
     
    
     this.addRole("AInheritstarget");
     this.setArity("AInheritstarget",true,1);
     this.setArity("AInheritstarget",false,1);
     
this.addClass("AInheritstarget","ingenias.editor.entities.Agent");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof AInheritsEdge)))
      return false;

    // n-edge to be considered.
    AInheritsEdge edge = new AInheritsEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof AInheritsEdge)
      edge = (AInheritsEdge) selectedEdge;
