...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFDecomposesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFDecomposes",
	index,"/ingenias/editor/rendererxml/WFDecomposesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFDecomposes",
	index,"/ingenias/editor/rendererxml/WFDecomposesLABELPanel.xml");
 ...
 public static void setEntity(WFDecomposes ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFDecomposes",ent.getPrefs().getView());
