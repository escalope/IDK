...
public class SubProtocolView extends VertexView {

  public static SubProtocolRenderer renderer = new SubProtocolRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public SubProtocolView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.SubProtocol ent=(ingenias.editor.entities.SubProtocol)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(SubProtocol ent) {
