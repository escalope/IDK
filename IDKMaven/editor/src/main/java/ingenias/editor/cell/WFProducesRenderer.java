...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/rendererxml/WFProducesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFProduces",
	index,"/rendererxml/WFProducesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFProduces",
	index,"/rendererxml/WFProducesLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.WFProduces ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFProduces",ent.getPrefs(attributes).getView());
