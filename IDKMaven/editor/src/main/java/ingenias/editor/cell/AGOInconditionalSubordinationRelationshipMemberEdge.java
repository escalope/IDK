...
public class AGOInconditionalSubordinationRelationshipMemberEdge extends NAryEdge {

  // Constructor with data content
  public AGOInconditionalSubordinationRelationshipMemberEdge(ingenias.editor.entities.AGOInconditionalSubordinationRelationshipMember userObject) {
    super(userObject);
    
     this.addRole("AGORelationship3source");
     this.setArity("AGORelationship3source",true,1);
     this.setArity("AGORelationship3source",false,1);
     
this.addClass("AGORelationship3source","ingenias.editor.entities.Agent");
     
this.addClass("AGORelationship3source","ingenias.editor.entities.Role");
     
    
     this.addRole("AGORelationship3target");
     this.setArity("AGORelationship3target",true,1);
     this.setArity("AGORelationship3target",false,1);
     
this.addClass("AGORelationship3target","ingenias.editor.entities.Agent");
     
this.addClass("AGORelationship3target","ingenias.editor.entities.Role");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof AGOInconditionalSubordinationRelationshipMemberEdge)))
      return false;

    // n-edge to be considered.
    AGOInconditionalSubordinationRelationshipMemberEdge edge = new AGOInconditionalSubordinationRelationshipMemberEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof AGOInconditionalSubordinationRelationshipMemberEdge)
      edge = (AGOInconditionalSubordinationRelationshipMemberEdge) selectedEdge;
