...
public class ConversationView extends VertexView {

  public static ConversationRenderer renderer = new ConversationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ConversationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Conversation ent=(ingenias.editor.entities.Conversation)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Conversation ent) {
