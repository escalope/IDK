...
public class WFConnectsRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFConnects",
	index,"/rendererxml/WFConnectsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFConnects",
	index,"/rendererxml/WFConnectsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFConnects",
	index,"/rendererxml/WFConnectsLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.WFConnects ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFConnects",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFConnects",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFConnects",c);
	}
