...
public class GTModifiesView extends NAryView {

static GTModifiesRenderer renderer1 = new GTModifiesRenderer();
 public static GTModifiesRenderer renderer = new GTModifiesRenderer();
  // Constructor.
  public GTModifiesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GTModifies ent=(ingenias.editor.entities.GTModifies)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GTModifies ent) {
