...
public class UIColaboratessourceRoleWidgetPreferences extends EntityWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public UIColaboratessourceRoleWidgetPreferences() {
  super();
  String[] preferredOrder={"Timeout",""};
