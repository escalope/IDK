...
public class TextNoteRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/rendererxml/TextNoteUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("TextNote",
	index,"/rendererxml/TextNoteINGENIASPanel.xml");
    ...
    public TextNoteRenderer() {
	  ...
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("TextNote",ent.getPrefs(map).getView());
  ...
  public static void setEntity(TextNote ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("TextNote",ent.getPrefs(attributes).getView());
