...
public class UIInitiatesEdge extends NAryEdge {

  // Constructor with data content
  public UIInitiatesEdge(ingenias.editor.entities.UIInitiates userObject) {
    super(userObject);
    
     this.addRole("UIInitiatessource");
     this.setArity("UIInitiatessource",true,1);
     this.setArity("UIInitiatessource",false,1);
     
this.addClass("UIInitiatessource","ingenias.editor.entities.InteractionUnit");
     
this.addClass("UIInitiatessource","ingenias.editor.entities.Interaction");
     
    
     this.addRole("UIInitiatestarget");
     this.setArity("UIInitiatestarget",true,1);
     this.setArity("UIInitiatestarget",false,1);
     
this.addClass("UIInitiatestarget","ingenias.editor.entities.Agent");
     
this.addClass("UIInitiatestarget","ingenias.editor.entities.Role");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof UIInitiatesEdge)))
      return false;

    // n-edge to be considered.
    UIInitiatesEdge edge = new UIInitiatesEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof UIInitiatesEdge)
      edge = (UIInitiatesEdge) selectedEdge;
