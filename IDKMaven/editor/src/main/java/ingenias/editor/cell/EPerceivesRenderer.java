...
public class EPerceivesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("EPerceives",
	index,"/rendererxml/EPerceivesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("EPerceives",
	index,"/rendererxml/EPerceivesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("EPerceives",
	index,"/rendererxml/EPerceivesLABELPanel.xml");
     ...
     */
     public EPerceivesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("EPerceives",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.EPerceives ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("EPerceives",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("EPerceives",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("EPerceives",c);
	}
