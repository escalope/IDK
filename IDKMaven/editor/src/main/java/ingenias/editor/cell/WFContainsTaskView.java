...
public class WFContainsTaskView extends NAryView {

static WFContainsTaskRenderer renderer1 = new WFContainsTaskRenderer();
 public static WFContainsTaskRenderer renderer = new WFContainsTaskRenderer();
  // Constructor.
  public WFContainsTaskView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFContainsTask ent=(ingenias.editor.entities.WFContainsTask)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFContainsTask ent) {
