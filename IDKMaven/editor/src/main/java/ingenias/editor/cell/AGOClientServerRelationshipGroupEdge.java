...
public class AGOClientServerRelationshipGroupEdge extends NAryEdge {

  // Constructor with data content
  public AGOClientServerRelationshipGroupEdge(ingenias.editor.entities.AGOClientServerRelationshipGroup userObject) {
    super(userObject);
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof AGOClientServerRelationshipGroupEdge)))
      return false;

    // n-edge to be considered.
    AGOClientServerRelationshipGroupEdge edge = new AGOClientServerRelationshipGroupEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof AGOClientServerRelationshipGroupEdge)
      edge = (AGOClientServerRelationshipGroupEdge) selectedEdge;
