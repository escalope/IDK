...
public class TestingPackageRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/rendererxml/TestingPackageUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("TestingPackage",
	index,"/rendererxml/TestingPackageINGENIASPanel.xml");
    ...
    public TestingPackageRenderer() {
	  ...
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("TestingPackage",ent.getPrefs(map).getView());
  ...
  public static void setEntity(TestingPackage ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("TestingPackage",ent.getPrefs(attributes).getView());
