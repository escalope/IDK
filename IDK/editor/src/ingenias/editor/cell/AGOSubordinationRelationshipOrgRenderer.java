...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AGOSubordinationRelationshipOrgNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipOrg",
	index,"/ingenias/editor/rendererxml/AGOSubordinationRelationshipOrgINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipOrg",
	index,"/ingenias/editor/rendererxml/AGOSubordinationRelationshipOrgLABELPanel.xml");
 ...
 public static void setEntity(AGOSubordinationRelationshipOrg ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOSubordinationRelationshipOrg",ent.getPrefs().getView());
