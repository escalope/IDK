...
public class ResourceView extends VertexView {

  public static ResourceRenderer renderer = new ResourceRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ResourceView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Resource ent=(ingenias.editor.entities.Resource)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Resource ent) {
