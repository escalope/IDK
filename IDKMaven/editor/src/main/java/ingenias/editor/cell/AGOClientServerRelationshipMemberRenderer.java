...
public class AGOClientServerRelationshipMemberRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGOClientServerRelationshipMember",
	index,"/rendererxml/AGOClientServerRelationshipMemberNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOClientServerRelationshipMember",
	index,"/rendererxml/AGOClientServerRelationshipMemberINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOClientServerRelationshipMember",
	index,"/rendererxml/AGOClientServerRelationshipMemberLABELPanel.xml");
     ...
     */
     public AGOClientServerRelationshipMemberRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGOClientServerRelationshipMember",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGOClientServerRelationshipMember ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOClientServerRelationshipMember",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGOClientServerRelationshipMember",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGOClientServerRelationshipMember",c);
	}
