...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AUMLSelectionNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLSelection",
	index,"/ingenias/editor/rendererxml/AUMLSelectionINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AUMLSelection",
	index,"/ingenias/editor/rendererxml/AUMLSelectionLABELPanel.xml");
 ...
 public static void setEntity(AUMLSelection ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLSelection",ent.getPrefs().getView());
