...
public class RemoteProcedureCallView extends VertexView {

  public static RemoteProcedureCallRenderer renderer = new RemoteProcedureCallRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public RemoteProcedureCallView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.RemoteProcedureCall ent=(ingenias.editor.entities.RemoteProcedureCall)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(RemoteProcedureCall ent) {
