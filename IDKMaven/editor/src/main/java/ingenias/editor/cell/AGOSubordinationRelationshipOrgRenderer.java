...
public class AGOSubordinationRelationshipOrgRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipOrg",
	index,"/rendererxml/AGOSubordinationRelationshipOrgNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipOrg",
	index,"/rendererxml/AGOSubordinationRelationshipOrgINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipOrg",
	index,"/rendererxml/AGOSubordinationRelationshipOrgLABELPanel.xml");
     ...
     */
     public AGOSubordinationRelationshipOrgRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGOSubordinationRelationshipOrg",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGOSubordinationRelationshipOrg ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOSubordinationRelationshipOrg",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGOSubordinationRelationshipOrg",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGOSubordinationRelationshipOrg",c);
	}
