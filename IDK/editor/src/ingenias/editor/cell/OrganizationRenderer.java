...
public class OrganizationRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/OrganizationUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Organization",
	index,"/ingenias/editor/rendererxml/OrganizationINGENIASPanel.xml");
  ...
  public static void setEntity(Organization ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Organization",ent.getPrefs().getView());
