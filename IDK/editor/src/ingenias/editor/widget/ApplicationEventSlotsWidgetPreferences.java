...
public class ApplicationEventSlotsWidgetPreferences extends ApplicationEventWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public ApplicationEventSlotsWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Source","Slots",""};
