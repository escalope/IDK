...
public class ATAnswer implements Answer {
	 ...
	 * @param newElements  
	 */
	public ATAnswer(String language,
			Map<String, ATRole> entityTypes,
	...
	public Map<String, String> getEntityTypes() {
		...
		for (String key : this.getEntityATRoles().keySet())
			result.put(key, this.getEntityATRoles().get(key).toString());
		return result;
	}
	...
	public void setEntityTypes(Map<String, String> entityTypes) {
		...
		for (String key : entityTypes.keySet())
			types.put(key, ATRole.valueOf( entityTypes.get(key) ));
	...
	public Map<String, String> getRelationTypes() {
		Map<String, String> result = new HashMap<String, String>();
		for (String key : this.getRelationATTypes().keySet())
			result.put(key, this.getRelationATTypes().get(key).toString());
		return result;
	}
