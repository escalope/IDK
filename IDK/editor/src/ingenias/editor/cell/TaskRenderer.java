...
public class TaskRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/TaskUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Task",
	index,"/ingenias/editor/rendererxml/TaskINGENIASPanel.xml");
  ...
  public static void setEntity(Task ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Task",ent.getPrefs().getView());
