...
public class IUIterateRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/rendererxml/IUIterateUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IUIterate",
	index,"/rendererxml/IUIterateINGENIASPanel.xml");
    ...
    public IUIterateRenderer() {
	  ...
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("IUIterate",ent.getPrefs(map).getView());
  ...
  public static void setEntity(IUIterate ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IUIterate",ent.getPrefs(attributes).getView());
