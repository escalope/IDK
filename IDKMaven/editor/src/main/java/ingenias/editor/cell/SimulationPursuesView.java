...
public class SimulationPursuesView extends NAryView {

static SimulationPursuesRenderer renderer1 = new SimulationPursuesRenderer();
 public static SimulationPursuesRenderer renderer = new SimulationPursuesRenderer();
  // Constructor.
  public SimulationPursuesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.SimulationPursues ent=(ingenias.editor.entities.SimulationPursues)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.SimulationPursues ent) {
