...
public class OHasMemberEdge extends NAryEdge {

  // Constructor with data content
  public OHasMemberEdge(ingenias.editor.entities.OHasMember userObject) {
    super(userObject);
    
     this.addRole("OHasMembersource");
     this.setArity("OHasMembersource",true,1);
     this.setArity("OHasMembersource",false,1);
     
this.addClass("OHasMembersource","ingenias.editor.entities.OrganizationGroup");
     
    
     this.addRole("OHasMembertarget");
     this.setArity("OHasMembertarget",true,1);
     this.setArity("OHasMembertarget",false,2147483647);
     
this.addClass("OHasMembertarget","ingenias.editor.entities.Agent");
     
this.addClass("OHasMembertarget","ingenias.editor.entities.Role");
     
this.addClass("OHasMembertarget","ingenias.editor.entities.Resource");
     
this.addClass("OHasMembertarget","ingenias.editor.entities.Application");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof OHasMemberEdge)))
      return false;

    // n-edge to be considered.
    OHasMemberEdge edge = new OHasMemberEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof OHasMemberEdge)
      edge = (OHasMemberEdge) selectedEdge;
