...
public class ShareToupleRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/ShareToupleUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ShareTouple",
	index,"/ingenias/editor/rendererxml/ShareToupleINGENIASPanel.xml");
  ...
  public static void setEntity(ShareTouple ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ShareTouple",ent.getPrefs().getView());
