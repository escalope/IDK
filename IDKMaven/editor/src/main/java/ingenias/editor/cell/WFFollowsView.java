...
public class WFFollowsView extends NAryView {

static WFFollowsRenderer renderer1 = new WFFollowsRenderer();
 public static WFFollowsRenderer renderer = new WFFollowsRenderer();
  // Constructor.
  public WFFollowsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFFollows ent=(ingenias.editor.entities.WFFollows)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFFollows ent) {
