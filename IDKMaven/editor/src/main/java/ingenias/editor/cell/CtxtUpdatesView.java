...
public class CtxtUpdatesView extends NAryView {

static CtxtUpdatesRenderer renderer1 = new CtxtUpdatesRenderer();
 public static CtxtUpdatesRenderer renderer = new CtxtUpdatesRenderer();
  // Constructor.
  public CtxtUpdatesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.CtxtUpdates ent=(ingenias.editor.entities.CtxtUpdates)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.CtxtUpdates ent) {
