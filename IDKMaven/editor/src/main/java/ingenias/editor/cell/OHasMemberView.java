...
public class OHasMemberView extends NAryView {

static OHasMemberRenderer renderer1 = new OHasMemberRenderer();
 public static OHasMemberRenderer renderer = new OHasMemberRenderer();
  // Constructor.
  public OHasMemberView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.OHasMember ent=(ingenias.editor.entities.OHasMember)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.OHasMember ent) {
