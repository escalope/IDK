...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/IAccessesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IAccesses",
	index,"/ingenias/editor/rendererxml/IAccessesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("IAccesses",
	index,"/ingenias/editor/rendererxml/IAccessesLABELPanel.xml");
 ...
 public static void setEntity(IAccesses ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IAccesses",ent.getPrefs().getView());
