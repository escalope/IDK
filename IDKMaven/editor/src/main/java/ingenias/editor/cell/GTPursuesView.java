...
public class GTPursuesView extends NAryView {

static GTPursuesRenderer renderer1 = new GTPursuesRenderer();
 public static GTPursuesRenderer renderer = new GTPursuesRenderer();
  // Constructor.
  public GTPursuesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GTPursues ent=(ingenias.editor.entities.GTPursues)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GTPursues ent) {
