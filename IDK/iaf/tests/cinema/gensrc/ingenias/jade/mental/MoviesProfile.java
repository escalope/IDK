...
public class MoviesProfile extends ingenias.editor.entities.RuntimeFact{
   
    Vector<String> moviesILike;   
  ...
  public MoviesProfile (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="MoviesProfile";
  }
  ...
  public String getParentType(){
   ...
   public void setmoviesILike(Vector<String> value){
     moviesILike=value;   
   };
   
   public Vector<String> getmoviesILike(){
     return moviesILike;      
   }
