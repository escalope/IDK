...
public class SimExtractedInformationView extends VertexView {

  public static SimExtractedInformationRenderer renderer = new SimExtractedInformationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public SimExtractedInformationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.SimExtractedInformation ent=(ingenias.editor.entities.SimExtractedInformation)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(SimExtractedInformation ent) {
