...
public class WFPlaysRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFPlays",
	index,"/rendererxml/WFPlaysNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFPlays",
	index,"/rendererxml/WFPlaysINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFPlays",
	index,"/rendererxml/WFPlaysLABELPanel.xml");
     ...
     */
     public WFPlaysRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFPlays",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.WFPlays ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFPlays",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFPlays",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFPlays",c);
	}
