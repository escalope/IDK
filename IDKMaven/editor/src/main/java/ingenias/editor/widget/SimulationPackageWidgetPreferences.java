...
public class SimulationPackageWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public SimulationPackageWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","DeltaT","SimLength","SimulationDeployment","InjectedEvents","ExtractedInformation","Parameters",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("DeltaT",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("DeltaT",result);
  
   preferredWidget.put("SimLength",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("SimLength",result);
