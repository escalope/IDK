...
public class WorkflowBoxRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/WorkflowBoxUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WorkflowBox",
	index,"/ingenias/editor/rendererxml/WorkflowBoxINGENIASPanel.xml");
  ...
  public static void setEntity(WorkflowBox ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WorkflowBox",ent.getPrefs().getView());
