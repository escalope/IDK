...
public class EnvironmentApplicationWidgetPreferences extends ApplicationWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public EnvironmentApplicationWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Methods",""};
