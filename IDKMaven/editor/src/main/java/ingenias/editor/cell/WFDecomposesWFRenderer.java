...
public class WFDecomposesWFRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFDecomposesWF",
	index,"/rendererxml/WFDecomposesWFNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFDecomposesWF",
	index,"/rendererxml/WFDecomposesWFINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFDecomposesWF",
	index,"/rendererxml/WFDecomposesWFLABELPanel.xml");
     ...
     */
     public WFDecomposesWFRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFDecomposesWF",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.WFDecomposesWF ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFDecomposesWF",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFDecomposesWF",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFDecomposesWF",c);
	}
