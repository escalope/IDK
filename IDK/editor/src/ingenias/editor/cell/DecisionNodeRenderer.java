...
public class DecisionNodeRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/DecisionNodeUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("DecisionNode",
	index,"/ingenias/editor/rendererxml/DecisionNodeINGENIASPanel.xml");
  ...
  public static void setEntity(DecisionNode ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("DecisionNode",ent.getPrefs().getView());
