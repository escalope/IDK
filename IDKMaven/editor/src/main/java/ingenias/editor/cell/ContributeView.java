...
public class ContributeView extends NAryView {

static ContributeRenderer renderer1 = new ContributeRenderer();
 public static ContributeRenderer renderer = new ContributeRenderer();
  // Constructor.
  public ContributeView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.Contribute ent=(ingenias.editor.entities.Contribute)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.Contribute ent) {
