...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/IInitiatesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IInitiates",
	index,"/ingenias/editor/rendererxml/IInitiatesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("IInitiates",
	index,"/ingenias/editor/rendererxml/IInitiatesLABELPanel.xml");
 ...
 public static void setEntity(IInitiates ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IInitiates",ent.getPrefs().getView());
