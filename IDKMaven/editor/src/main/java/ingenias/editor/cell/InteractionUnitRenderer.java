...
public class InteractionUnitRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/rendererxml/InteractionUnitUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("InteractionUnit",
	index,"/rendererxml/InteractionUnitINGENIASPanel.xml");
    ...
    public InteractionUnitRenderer() {
	  ...
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("InteractionUnit",ent.getPrefs(map).getView());
  ...
  public static void setEntity(InteractionUnit ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("InteractionUnit",ent.getPrefs(attributes).getView());
