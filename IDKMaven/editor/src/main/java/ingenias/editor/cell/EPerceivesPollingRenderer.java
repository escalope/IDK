...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/rendererxml/EPerceivesPollingNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("EPerceivesPolling",
	index,"/rendererxml/EPerceivesPollingINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("EPerceivesPolling",
	index,"/rendererxml/EPerceivesPollingLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.EPerceivesPolling ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("EPerceivesPolling",ent.getPrefs(attributes).getView());
