...
public class AddSourceIntoSystemTask extends Task{
 ...
 public void execute() throws TaskException{
        ...
        //  Uncomment the following and write down a proper local id of the agent
        // Find an agent playing the role "GestorFuentesRole"
      	//eoRequestToAddSource.addCollaborators("Local ID of the collaborator");
       	


//#start_node:IntroducirFuenteSistemaTaskImpl <--- DO NOT REMOVE THIS	

        System.out.println(this.getClass().getName()+" << ");
        trabajomaster.demo.supervisor.Tareas.introducirFuenteSistemaTask(this.getAgentID(),eiSourceToProcess,
...
//#end_node:IntroducirFuenteSistemaTaskImpl <--- DO NOT REMOVE THIS
