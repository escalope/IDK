...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/rendererxml/WFResponsableNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFResponsable",
	index,"/rendererxml/WFResponsableINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFResponsable",
	index,"/rendererxml/WFResponsableLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.WFResponsable ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFResponsable",ent.getPrefs(attributes).getView());
