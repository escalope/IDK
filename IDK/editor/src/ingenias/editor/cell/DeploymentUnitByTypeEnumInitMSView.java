...
public class DeploymentUnitByTypeEnumInitMSView extends VertexView {

  public static DeploymentUnitByTypeEnumInitMSRenderer renderer = new DeploymentUnitByTypeEnumInitMSRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public DeploymentUnitByTypeEnumInitMSView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.DeploymentUnitByTypeEnumInitMS ent=(ingenias.editor.entities.DeploymentUnitByTypeEnumInitMS)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(DeploymentUnitByTypeEnumInitMS ent) {
