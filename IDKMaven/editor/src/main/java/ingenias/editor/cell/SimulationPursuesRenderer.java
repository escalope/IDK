...
public class SimulationPursuesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("SimulationPursues",
	index,"/rendererxml/SimulationPursuesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("SimulationPursues",
	index,"/rendererxml/SimulationPursuesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("SimulationPursues",
	index,"/rendererxml/SimulationPursuesLABELPanel.xml");
     ...
     */
     public SimulationPursuesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("SimulationPursues",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.SimulationPursues ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("SimulationPursues",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("SimulationPursues",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("SimulationPursues",c);
	}
