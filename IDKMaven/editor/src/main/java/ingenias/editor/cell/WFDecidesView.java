...
public class WFDecidesView extends NAryView {

static WFDecidesRenderer renderer1 = new WFDecidesRenderer();
 public static WFDecidesRenderer renderer = new WFDecidesRenderer();
  // Constructor.
  public WFDecidesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFDecides ent=(ingenias.editor.entities.WFDecides)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFDecides ent) {
