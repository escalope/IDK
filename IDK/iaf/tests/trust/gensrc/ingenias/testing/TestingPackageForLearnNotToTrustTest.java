...
public class TestingPackageForLearnNotToTrustTest extends LearnNotToTrustTest{
...
{
        // Create a new agent
        final jade.wrapper.AgentController agcAutonomousColaborator_0AutonomousColaboratorDU = ac.createNewAgent("AutonomousColaborator_0AutonomousColaboratorDU",
            "ingenias.jade.agents.AutonomousColaboratorJADEAgent", new Object[0]);	
	
	
        new Thread(){
          public void run(){
            try {
               System.out.println("Starting up AutonomousColaborator_0AutonomousColaboratorDU...");
              agcAutonomousColaborator_0AutonomousColaboratorDU.start();
        ...
        // Create a new agent
        final jade.wrapper.AgentController agcSourcesAlfaInspector_0SourcesAlfaInspectorDU = ac.createNewAgent("SourcesAlfaInspector_0SourcesAlfaInspectorDU",
        ...
        new Thread(){
          public void run(){
            try {
               System.out.println("Starting up SourcesAlfaInspector_0SourcesAlfaInspectorDU...");
              agcSourcesAlfaInspector_0SourcesAlfaInspectorDU.start();
