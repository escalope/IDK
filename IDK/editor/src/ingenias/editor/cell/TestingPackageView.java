...
public class TestingPackageView extends VertexView {

  public static TestingPackageRenderer renderer = new TestingPackageRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public TestingPackageView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.TestingPackage ent=(ingenias.editor.entities.TestingPackage)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(TestingPackage ent) {
