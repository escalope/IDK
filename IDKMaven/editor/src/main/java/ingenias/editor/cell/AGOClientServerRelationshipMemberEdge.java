...
public class AGOClientServerRelationshipMemberEdge extends NAryEdge {

  // Constructor with data content
  public AGOClientServerRelationshipMemberEdge(ingenias.editor.entities.AGOClientServerRelationshipMember userObject) {
    super(userObject);
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof AGOClientServerRelationshipMemberEdge)))
      return false;

    // n-edge to be considered.
    AGOClientServerRelationshipMemberEdge edge = new AGOClientServerRelationshipMemberEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof AGOClientServerRelationshipMemberEdge)
      edge = (AGOClientServerRelationshipMemberEdge) selectedEdge;
