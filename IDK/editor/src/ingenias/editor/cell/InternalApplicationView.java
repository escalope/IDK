...
public class InternalApplicationView extends VertexView {

  public static InternalApplicationRenderer renderer = new InternalApplicationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public InternalApplicationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.InternalApplication ent=(ingenias.editor.entities.InternalApplication)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(InternalApplication ent) {
