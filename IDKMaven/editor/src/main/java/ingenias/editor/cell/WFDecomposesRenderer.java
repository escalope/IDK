...
public class WFDecomposesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFDecomposes",
	index,"/rendererxml/WFDecomposesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFDecomposes",
	index,"/rendererxml/WFDecomposesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFDecomposes",
	index,"/rendererxml/WFDecomposesLABELPanel.xml");
     ...
     */
     public WFDecomposesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFDecomposes",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.WFDecomposes ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFDecomposes",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFDecomposes",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFDecomposes",c);
	}
