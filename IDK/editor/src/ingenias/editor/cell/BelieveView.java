...
public class BelieveView extends VertexView {

  public static BelieveRenderer renderer = new BelieveRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public BelieveView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Believe ent=(ingenias.editor.entities.Believe)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Believe ent) {
