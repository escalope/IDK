...
public class GoalStateWSRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/GoalStateWSUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GoalStateWS",
	index,"/ingenias/editor/rendererxml/GoalStateWSINGENIASPanel.xml");
  ...
  public static void setEntity(GoalStateWS ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GoalStateWS",ent.getPrefs().getView());
