...
public class MentalStateManagerRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/MentalStateManagerUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("MentalStateManager",
	index,"/ingenias/editor/rendererxml/MentalStateManagerINGENIASPanel.xml");
  ...
  public static void setEntity(MentalStateManager ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("MentalStateManager",ent.getPrefs().getView());
