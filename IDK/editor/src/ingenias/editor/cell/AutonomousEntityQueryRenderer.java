...
public class AutonomousEntityQueryRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/AutonomousEntityQueryUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AutonomousEntityQuery",
	index,"/ingenias/editor/rendererxml/AutonomousEntityQueryINGENIASPanel.xml");
  ...
  public static void setEntity(AutonomousEntityQuery ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AutonomousEntityQuery",ent.getPrefs().getView());
