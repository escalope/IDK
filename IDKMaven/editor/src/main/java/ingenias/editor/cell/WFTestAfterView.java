...
public class WFTestAfterView extends NAryView {

static WFTestAfterRenderer renderer1 = new WFTestAfterRenderer();
 public static WFTestAfterRenderer renderer = new WFTestAfterRenderer();
  // Constructor.
  public WFTestAfterView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFTestAfter ent=(ingenias.editor.entities.WFTestAfter)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFTestAfter ent) {
