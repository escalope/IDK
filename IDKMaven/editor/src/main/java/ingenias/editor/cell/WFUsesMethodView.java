...
public class WFUsesMethodView extends NAryView {

static WFUsesMethodRenderer renderer1 = new WFUsesMethodRenderer();
 public static WFUsesMethodRenderer renderer = new WFUsesMethodRenderer();
  // Constructor.
  public WFUsesMethodView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFUsesMethod ent=(ingenias.editor.entities.WFUsesMethod)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFUsesMethod ent) {
