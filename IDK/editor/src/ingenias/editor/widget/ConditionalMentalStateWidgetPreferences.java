...
public class ConditionalMentalStateWidgetPreferences extends MentalStateWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public ConditionalMentalStateWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Condition",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("Condition",ingenias.editor.widget.ScrolledTArea.class);
   result=new Vector();
