...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GTInheritsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTInherits",
	index,"/ingenias/editor/rendererxml/GTInheritsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTInherits",
	index,"/ingenias/editor/rendererxml/GTInheritsLABELPanel.xml");
 ...
 public static void setEntity(GTInherits ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTInherits",ent.getPrefs().getView());
