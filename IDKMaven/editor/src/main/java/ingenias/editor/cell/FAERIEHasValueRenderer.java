...
public class FAERIEHasValueRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("FAERIEHasValue",
	index,"/rendererxml/FAERIEHasValueNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("FAERIEHasValue",
	index,"/rendererxml/FAERIEHasValueINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("FAERIEHasValue",
	index,"/rendererxml/FAERIEHasValueLABELPanel.xml");
     ...
     */
     public FAERIEHasValueRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("FAERIEHasValue",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.FAERIEHasValue ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("FAERIEHasValue",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("FAERIEHasValue",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("FAERIEHasValue",c);
	}
