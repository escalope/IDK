...
public class AInstanceOfView extends NAryView {

static AInstanceOfRenderer renderer1 = new AInstanceOfRenderer();
 public static AInstanceOfRenderer renderer = new AInstanceOfRenderer();
  // Constructor.
  public AInstanceOfView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AInstanceOf ent=(ingenias.editor.entities.AInstanceOf)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AInstanceOf ent) {
