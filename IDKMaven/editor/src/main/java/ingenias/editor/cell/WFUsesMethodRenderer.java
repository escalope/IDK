...
public class WFUsesMethodRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFUsesMethod",
	index,"/rendererxml/WFUsesMethodNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFUsesMethod",
	index,"/rendererxml/WFUsesMethodINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFUsesMethod",
	index,"/rendererxml/WFUsesMethodLABELPanel.xml");
     ...
     */
     public WFUsesMethodRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFUsesMethod",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.WFUsesMethod ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFUsesMethod",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFUsesMethod",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFUsesMethod",c);
	}
