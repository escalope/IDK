...
public class ContextReleaseTaskView extends VertexView {

  public static ContextReleaseTaskRenderer renderer = new ContextReleaseTaskRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ContextReleaseTaskView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.ContextReleaseTask ent=(ingenias.editor.entities.ContextReleaseTask)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ContextReleaseTask ent) {
