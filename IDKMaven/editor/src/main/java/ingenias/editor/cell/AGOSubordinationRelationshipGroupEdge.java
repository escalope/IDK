...
public class AGOSubordinationRelationshipGroupEdge extends NAryEdge {

  // Constructor with data content
  public AGOSubordinationRelationshipGroupEdge(ingenias.editor.entities.AGOSubordinationRelationshipGroup userObject) {
    super(userObject);
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof AGOSubordinationRelationshipGroupEdge)))
      return false;

    // n-edge to be considered.
    AGOSubordinationRelationshipGroupEdge edge = new AGOSubordinationRelationshipGroupEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof AGOSubordinationRelationshipGroupEdge)
      edge = (AGOSubordinationRelationshipGroupEdge) selectedEdge;
