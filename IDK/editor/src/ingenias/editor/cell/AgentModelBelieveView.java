...
public class AgentModelBelieveView extends VertexView {

  public static AgentModelBelieveRenderer renderer = new AgentModelBelieveRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public AgentModelBelieveView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.AgentModelBelieve ent=(ingenias.editor.entities.AgentModelBelieve)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(AgentModelBelieve ent) {
