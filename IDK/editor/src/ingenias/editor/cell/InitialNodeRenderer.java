...
public class InitialNodeRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/InitialNodeUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("InitialNode",
	index,"/ingenias/editor/rendererxml/InitialNodeINGENIASPanel.xml");
  ...
  public static void setEntity(InitialNode ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("InitialNode",ent.getPrefs().getView());
