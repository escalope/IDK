...
*/
			...
			public class AutonomousColaboratorInteractionLocks implements CustomLocks {
			
			public AutonomousColaboratorInteractionLocks(){};
                  ...
                  if (interaction.equals("PerformProposal")&& role.equals("ColaboratorRole")){
                    ColaboratorRolePerformProposalDefaultCommControl.addDefaultLocks(lw);
                  }
