...
public class ShareToupleView extends VertexView {

  public static ShareToupleRenderer renderer = new ShareToupleRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ShareToupleView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.ShareTouple ent=(ingenias.editor.entities.ShareTouple)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ShareTouple ent) {
