...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/ContributePositivelyNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ContributePositively",
	index,"/ingenias/editor/rendererxml/ContributePositivelyINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ContributePositively",
	index,"/ingenias/editor/rendererxml/ContributePositivelyLABELPanel.xml");
 ...
 public static void setEntity(ContributePositively ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ContributePositively",ent.getPrefs().getView());
