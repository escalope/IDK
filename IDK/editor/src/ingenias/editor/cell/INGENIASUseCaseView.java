...
public class INGENIASUseCaseView extends VertexView {

  public static INGENIASUseCaseRenderer renderer = new INGENIASUseCaseRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public INGENIASUseCaseView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.INGENIASUseCase ent=(ingenias.editor.entities.INGENIASUseCase)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(INGENIASUseCase ent) {
