...
public class ForkNodeView extends VertexView {

  public static ForkNodeRenderer renderer = new ForkNodeRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ForkNodeView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.ForkNode ent=(ingenias.editor.entities.ForkNode)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ForkNode ent) {
