...
public class DecisionNodeInputView extends NAryView {

static DecisionNodeInputRenderer renderer1 = new DecisionNodeInputRenderer();

  // Constructor.
  public DecisionNodeInputView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.DecisionNodeInput ent=(ingenias.editor.entities.DecisionNodeInput)((DefaultGraphCell)this.getCell()).getUserObject();
