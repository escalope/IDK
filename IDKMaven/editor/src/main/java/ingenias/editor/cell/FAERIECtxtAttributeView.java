...
public class FAERIECtxtAttributeView extends VertexView {

  public static FAERIECtxtAttributeRenderer renderer = new FAERIECtxtAttributeRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public FAERIECtxtAttributeView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.FAERIECtxtAttribute ent=(ingenias.editor.entities.FAERIECtxtAttribute)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(FAERIECtxtAttribute ent) {
