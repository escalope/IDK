...
public class WorkflowBoxWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public WorkflowBoxWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Tasks","Role","Workflow",""};
