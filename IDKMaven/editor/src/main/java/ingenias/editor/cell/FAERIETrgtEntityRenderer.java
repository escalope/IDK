...
public class FAERIETrgtEntityRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("FAERIETrgtEntity",
	index,"/rendererxml/FAERIETrgtEntityNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("FAERIETrgtEntity",
	index,"/rendererxml/FAERIETrgtEntityINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("FAERIETrgtEntity",
	index,"/rendererxml/FAERIETrgtEntityLABELPanel.xml");
     ...
     */
     public FAERIETrgtEntityRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("FAERIETrgtEntity",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.FAERIETrgtEntity ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("FAERIETrgtEntity",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("FAERIETrgtEntity",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("FAERIETrgtEntity",c);
	}
