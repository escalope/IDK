...
public class Provider1Protocol implements AgentProtocols{

public Provider1Protocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
          StateBehavior   sb=null;
		   ...
		   if (conv.getInteraction().getId().equals("RFP") && conv.getPlayedRole().equals("Requestee")){
		   	DefaultCommControl dcc=new RequesteeRFPDefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new RequesteeRFPStateBehavior(agentName,
				msr, msu,
				conv,                           		
				conv.getPlayedRole(),
			   	actors,
