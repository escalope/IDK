...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/UseCasePursuesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UseCasePursues",
	index,"/ingenias/editor/rendererxml/UseCasePursuesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UseCasePursues",
	index,"/ingenias/editor/rendererxml/UseCasePursuesLABELPanel.xml");
 ...
 public static void setEntity(UseCasePursues ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UseCasePursues",ent.getPrefs().getView());
