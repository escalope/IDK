...
public class INGENIASUseCaseWidgetPreferences extends UseCaseWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public INGENIASUseCaseWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Precondition","Postcondition","Scenarios",""};
