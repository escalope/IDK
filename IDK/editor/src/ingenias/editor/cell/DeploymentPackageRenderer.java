...
public class DeploymentPackageRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/DeploymentPackageUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("DeploymentPackage",
	index,"/ingenias/editor/rendererxml/DeploymentPackageINGENIASPanel.xml");
  ...
  public static void setEntity(DeploymentPackage ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("DeploymentPackage",ent.getPrefs().getView());
