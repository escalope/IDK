...
public class GeneralEventRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/rendererxml/GeneralEventUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GeneralEvent",
	index,"/rendererxml/GeneralEventINGENIASPanel.xml");
    ...
    public GeneralEventRenderer() {
	  ...
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("GeneralEvent",ent.getPrefs(map).getView());
  ...
  public static void setEntity(GeneralEvent ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GeneralEvent",ent.getPrefs(attributes).getView());
