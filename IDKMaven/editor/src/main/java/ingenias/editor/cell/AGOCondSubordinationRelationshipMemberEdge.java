...
public class AGOCondSubordinationRelationshipMemberEdge extends NAryEdge {

  // Constructor with data content
  public AGOCondSubordinationRelationshipMemberEdge(ingenias.editor.entities.AGOCondSubordinationRelationshipMember userObject) {
    super(userObject);
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof AGOCondSubordinationRelationshipMemberEdge)))
      return false;

    // n-edge to be considered.
    AGOCondSubordinationRelationshipMemberEdge edge = new AGOCondSubordinationRelationshipMemberEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof AGOCondSubordinationRelationshipMemberEdge)
      edge = (AGOCondSubordinationRelationshipMemberEdge) selectedEdge;
