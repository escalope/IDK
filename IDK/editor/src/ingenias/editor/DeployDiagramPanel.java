...
public class DeployDiagramPanel extends JGraph {
 ...
 entities.add("DeploymentUnitByTypeMSEntity");
  ...
  public DefaultGraphCell createCell(String entity) throws InvalidEntity{
    ...
    TestingPackage nentity=new TestingPackage(Editor.getNewId("TestingPackage"));
    ...
    DeploymentPackage nentity=new DeploymentPackage(Editor.getNewId("DeploymentPackage"));
      DefaultGraphCell vertex = new
    ...
    DeploymentUnitByType nentity=new DeploymentUnitByType(Editor.getNewId("DeploymentUnitByType"));
      DefaultGraphCell vertex = new
    ...
    DeploymentUnitByTypeEnumInitMS nentity=new DeploymentUnitByTypeEnumInitMS(Editor.getNewId("DeploymentUnitByTypeEnumInitMS"));
      DefaultGraphCell vertex = new
