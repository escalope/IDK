...
public class FactView extends VertexView {

  public static FactRenderer renderer = new FactRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public FactView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Fact ent=(ingenias.editor.entities.Fact)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Fact ent) {
