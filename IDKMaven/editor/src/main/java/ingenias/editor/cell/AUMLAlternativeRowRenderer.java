...
public class AUMLAlternativeRowRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("AUMLAlternativeRow",
	index,"/rendererxml/AUMLAlternativeRowUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLAlternativeRow",
	index,"/rendererxml/AUMLAlternativeRowINGENIASPanel.xml");
     ...
     */
    public AUMLAlternativeRowRenderer() {
    }
    
      public JComponent getConcreteSubComponent(String fieldname, Entity ent, Map map) {
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLAlternativeRow",ent.getPrefs(map).getView());
	  return currentMap.get(fieldname);
  		}

    public Dimension getSize() {
    return RenderComponentManager.getSize("AUMLAlternativeRow",current);
    }
  ...
  public static void setEntity(AUMLAlternativeRow ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLAlternativeRow",ent.getPrefs(attributes).getView());
  current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AUMLAlternativeRow",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AUMLAlternativeRow",current);
	}
