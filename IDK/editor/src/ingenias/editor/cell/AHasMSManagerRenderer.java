...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AHasMSManagerNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AHasMSManager",
	index,"/ingenias/editor/rendererxml/AHasMSManagerINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AHasMSManager",
	index,"/ingenias/editor/rendererxml/AHasMSManagerLABELPanel.xml");
 ...
 public static void setEntity(AHasMSManager ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AHasMSManager",ent.getPrefs().getView());
