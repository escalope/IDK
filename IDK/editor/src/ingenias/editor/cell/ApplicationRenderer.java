...
public class ApplicationRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/ApplicationUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Application",
	index,"/ingenias/editor/rendererxml/ApplicationINGENIASPanel.xml");
  ...
  public static void setEntity(Application ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Application",ent.getPrefs().getView());
