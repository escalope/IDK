...
public class About extends JDialog  implements java.io.Serializable {
  ...
  private void jbInit() throws Exception {
    ...
    jTextPane1.setText("<html><body>" +
    		...
    		"Version @editor.ver@ <p>developed by: <br>Jorge Gomez Sanz (jjgomez@sip.ucm.es)<br>Ruben Fuentes (ruben@sip.ucm.es)<br>Juan Pav&oacute;n (jpavon@sip.ucm.es)</b></font></body></html>");
