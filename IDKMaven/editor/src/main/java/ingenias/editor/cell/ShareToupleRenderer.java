...
public class ShareToupleRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("ShareTouple",
	index,"/rendererxml/ShareToupleUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ShareTouple",
	index,"/rendererxml/ShareToupleINGENIASPanel.xml");
     ...
     */
    public ShareToupleRenderer() {
    }
    
      public JComponent getConcreteSubComponent(String fieldname, Entity ent, Map map) {
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("ShareTouple",ent.getPrefs(map).getView());
	  return currentMap.get(fieldname);
  		}

    public Dimension getSize() {
    return RenderComponentManager.getSize("ShareTouple",current);
    }
  ...
  public static void setEntity(ShareTouple ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ShareTouple",ent.getPrefs(attributes).getView());
  current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("ShareTouple",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("ShareTouple",current);
	}
