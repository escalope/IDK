...
public class AUMLSpecificationRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("AUMLSpecification",
	index,"/ingenias/editor/rendererxml/AUMLSpecificationUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLSpecification",
	index,"/ingenias/editor/rendererxml/AUMLSpecificationINGENIASPanel.xml");
     ...
     */
    public AUMLSpecificationRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AUMLSpecification",current);
    }
  ...
  public static void setEntity(AUMLSpecification ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLSpecification",ent.getPrefs().getView());
	...
	{
	return RenderComponentManager.retrievePanel("AUMLSpecification",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AUMLSpecification",current);
	}
