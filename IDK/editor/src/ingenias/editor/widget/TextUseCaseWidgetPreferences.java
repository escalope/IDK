...
public class TextUseCaseWidgetPreferences extends UseCaseWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public TextUseCaseWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Precondition","Postcondition",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("Postcondition",ingenias.editor.widget.ScrolledTArea.class);
   result=new Vector();
   
   defaultValues.put("Postcondition",result);
  
   preferredWidget.put("Precondition",ingenias.editor.widget.ScrolledTArea.class);
   result=new Vector();
   
   defaultValues.put("Precondition",result);
