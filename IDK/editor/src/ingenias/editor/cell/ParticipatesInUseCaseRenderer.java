...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/ParticipatesInUseCaseNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ParticipatesInUseCase",
	index,"/ingenias/editor/rendererxml/ParticipatesInUseCaseINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ParticipatesInUseCase",
	index,"/ingenias/editor/rendererxml/ParticipatesInUseCaseLABELPanel.xml");
 ...
 public static void setEntity(ParticipatesInUseCase ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ParticipatesInUseCase",ent.getPrefs().getView());
