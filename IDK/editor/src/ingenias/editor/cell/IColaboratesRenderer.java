...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/IColaboratesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IColaborates",
	index,"/ingenias/editor/rendererxml/IColaboratesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("IColaborates",
	index,"/ingenias/editor/rendererxml/IColaboratesLABELPanel.xml");
 ...
 public static void setEntity(IColaborates ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IColaborates",ent.getPrefs().getView());
