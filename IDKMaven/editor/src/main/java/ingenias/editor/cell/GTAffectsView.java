...
public class GTAffectsView extends NAryView {

static GTAffectsRenderer renderer1 = new GTAffectsRenderer();
 public static GTAffectsRenderer renderer = new GTAffectsRenderer();
  // Constructor.
  public GTAffectsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GTAffects ent=(ingenias.editor.entities.GTAffects)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GTAffects ent) {
