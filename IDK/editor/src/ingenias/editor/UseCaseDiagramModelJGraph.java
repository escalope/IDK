...
public class UseCaseDiagramModelJGraph extends ModelJGraph {
 ...
 entities.add("Organization");
    ...
    if (nAryEdgesNum <= 1 && edgesNum == 0) {
      ...
      if (relacion.equalsIgnoreCase("Extends")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new ExtendsEdge(new Extends(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("Includes")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new IncludesEdge(new Includes(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("Generalizes")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new GeneralizesEdge(new Generalizes(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("ParticipatesInUseCase")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new ParticipatesInUseCaseEdge(new ParticipatesInUseCase(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("UMLDescribesUseCase")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new UMLDescribesUseCaseEdge(new UMLDescribesUseCase(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("UMLAssociation")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new UMLAssociationEdge(new UMLAssociation(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("UseCasePursues")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new UseCasePursuesEdge(new UseCasePursues(Editor.getNewId()));
        }
      }
  ...
  public DefaultGraphCell createCell(String entity) throws InvalidEntity{
    ...
    TextUseCase nentity=getOM().createTextUseCase( Editor.getNewId("TextUseCase"));
    ...
    INGENIASUseCase nentity=getOM().createINGENIASUseCase( Editor.getNewId("INGENIASUseCase"));
      DefaultGraphCell vertex = new
...
JOptionPane.showMessageDialog(IDE.ide,
 ...
 public synchronized JGraph cloneJGraph(){
		 ...
		 UseCaseDiagramModelJGraph jg=new  UseCaseDiagramModelJGraph(
				(UseCaseDiagramDataEntity) this.mde,this.name,IDEAbs.ide.ids.om,
