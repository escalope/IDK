...
public class BoxedTaskWidgetPreferences extends TaskWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public BoxedTaskWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Inputs","Outputs",""};
