...
public class ColaboratorSampleInteractionStateBehavior extends StateBehavior{
private MentalStateReader msr=null;
  public ColaboratorSampleInteractionStateBehavior( String agentName,
  ...
  public synchronized void action() {
    ...
    if (this.isState("disabled")){     
     ...
     CommActCreator.generateRWithoutCID((JADEAgent)myAgent,
      "SampleInteraction","enable",this.getPlayedRole(),options,this);
  ...
  if (this.isState("InteractionUnit1")) {
     ...
     try {
      ...
      if (this.getDCC().notifyMessageSent("InteractionUnit1",optionsA,this)){
           ...
           "InteractionUnit1","SampleInteraction",this.getContentForNextMessage());
           getTimeout().stop();
