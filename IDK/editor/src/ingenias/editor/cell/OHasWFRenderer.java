...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/OHasWFNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("OHasWF",
	index,"/ingenias/editor/rendererxml/OHasWFINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("OHasWF",
	index,"/ingenias/editor/rendererxml/OHasWFLABELPanel.xml");
 ...
 public static void setEntity(OHasWF ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("OHasWF",ent.getPrefs().getView());
