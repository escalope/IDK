...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/EPerceivesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("EPerceives",
	index,"/ingenias/editor/rendererxml/EPerceivesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("EPerceives",
	index,"/ingenias/editor/rendererxml/EPerceivesLABELPanel.xml");
 ...
 public static void setEntity(EPerceives ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("EPerceives",ent.getPrefs().getView());
