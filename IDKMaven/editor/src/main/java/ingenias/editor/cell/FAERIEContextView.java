...
public class FAERIEContextView extends VertexView {

  public static FAERIEContextRenderer renderer = new FAERIEContextRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public FAERIEContextView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.FAERIEContext ent=(ingenias.editor.entities.FAERIEContext)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(FAERIEContext ent) {
