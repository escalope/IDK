...
public class AUMLSelectionRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AUMLSelection",
	index,"/rendererxml/AUMLSelectionNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLSelection",
	index,"/rendererxml/AUMLSelectionINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AUMLSelection",
	index,"/rendererxml/AUMLSelectionLABELPanel.xml");
     ...
     */
     public AUMLSelectionRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AUMLSelection",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AUMLSelection ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLSelection",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AUMLSelection",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AUMLSelection",c);
	}
