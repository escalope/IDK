...
public class MethodWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public MethodWidgetPreferences() {
  super();
  String[] preferredOrder={"Name","Result","Parameter","Description",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("Result",CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("Result",result);
  
   preferredWidget.put("Name",CustomJTextField.class);
   result=new Vector();
