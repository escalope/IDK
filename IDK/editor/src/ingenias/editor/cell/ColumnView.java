...
public class ColumnView extends VertexView {

  public static ColumnRenderer renderer = new ColumnRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ColumnView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Column ent=(ingenias.editor.entities.Column)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Column ent) {
