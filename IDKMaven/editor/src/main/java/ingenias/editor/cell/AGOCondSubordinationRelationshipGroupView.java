...
public class AGOCondSubordinationRelationshipGroupView extends NAryView {

static AGOCondSubordinationRelationshipGroupRenderer renderer1 = new AGOCondSubordinationRelationshipGroupRenderer();
 public static AGOCondSubordinationRelationshipGroupRenderer renderer = new AGOCondSubordinationRelationshipGroupRenderer();
  // Constructor.
  public AGOCondSubordinationRelationshipGroupView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGOCondSubordinationRelationshipGroup ent=(ingenias.editor.entities.AGOCondSubordinationRelationshipGroup)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGOCondSubordinationRelationshipGroup ent) {
