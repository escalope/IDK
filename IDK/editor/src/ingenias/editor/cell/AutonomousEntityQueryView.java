...
public class AutonomousEntityQueryView extends VertexView {

  public static AutonomousEntityQueryRenderer renderer = new AutonomousEntityQueryRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public AutonomousEntityQueryView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.AutonomousEntityQuery ent=(ingenias.editor.entities.AutonomousEntityQuery)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(AutonomousEntityQuery ent) {
