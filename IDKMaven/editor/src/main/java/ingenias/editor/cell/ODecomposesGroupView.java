...
public class ODecomposesGroupView extends NAryView {

static ODecomposesGroupRenderer renderer1 = new ODecomposesGroupRenderer();
 public static ODecomposesGroupRenderer renderer = new ODecomposesGroupRenderer();
  // Constructor.
  public ODecomposesGroupView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.ODecomposesGroup ent=(ingenias.editor.entities.ODecomposesGroup)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.ODecomposesGroup ent) {
