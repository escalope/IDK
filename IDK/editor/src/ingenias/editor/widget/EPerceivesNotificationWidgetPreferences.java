...
public class EPerceivesNotificationWidgetPreferences extends EntityWidgetPreferences {
  ...
  public EPerceivesNotificationWidgetPreferences() {
  super();
  String[] preferredOrder={"Label","ApplicationMethod","Event",""};
