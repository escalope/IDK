...
public class UMLAssociationView extends NAryView {

static UMLAssociationRenderer renderer1 = new UMLAssociationRenderer();
 public static UMLAssociationRenderer renderer = new UMLAssociationRenderer();
  // Constructor.
  public UMLAssociationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.UMLAssociation ent=(ingenias.editor.entities.UMLAssociation)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.UMLAssociation ent) {
