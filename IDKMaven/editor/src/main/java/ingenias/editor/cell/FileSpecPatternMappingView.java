...
public class FileSpecPatternMappingView extends VertexView {

  public static FileSpecPatternMappingRenderer renderer = new FileSpecPatternMappingRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public FileSpecPatternMappingView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.FileSpecPatternMapping ent=(ingenias.editor.entities.FileSpecPatternMapping)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(FileSpecPatternMapping ent) {
