...
public class OrgDplmntView extends NAryView {

static OrgDplmntRenderer renderer1 = new OrgDplmntRenderer();
 public static OrgDplmntRenderer renderer = new OrgDplmntRenderer();
  // Constructor.
  public OrgDplmntView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.OrgDplmnt ent=(ingenias.editor.entities.OrgDplmnt)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.OrgDplmnt ent) {
