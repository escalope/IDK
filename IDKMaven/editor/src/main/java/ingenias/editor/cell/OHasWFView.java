...
public class OHasWFView extends NAryView {

static OHasWFRenderer renderer1 = new OHasWFRenderer();
 public static OHasWFRenderer renderer = new OHasWFRenderer();
  // Constructor.
  public OHasWFView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.OHasWF ent=(ingenias.editor.entities.OHasWF)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.OHasWF ent) {
