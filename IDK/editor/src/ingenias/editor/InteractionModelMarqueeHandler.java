...
public class InteractionModelMarqueeHandler extends MarqueeHandler  implements java.io.Serializable {

	



        public InteractionModelMarqueeHandler(ModelJGraph graph){
	super(graph);
        }
