...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/ODecomposesGroupNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ODecomposesGroup",
	index,"/ingenias/editor/rendererxml/ODecomposesGroupINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ODecomposesGroup",
	index,"/ingenias/editor/rendererxml/ODecomposesGroupLABELPanel.xml");
 ...
 public static void setEntity(ODecomposesGroup ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ODecomposesGroup",ent.getPrefs().getView());
