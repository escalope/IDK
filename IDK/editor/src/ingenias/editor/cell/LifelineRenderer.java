...
public class LifelineRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/LifelineUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Lifeline",
	index,"/ingenias/editor/rendererxml/LifelineINGENIASPanel.xml");
  ...
  public static void setEntity(Lifeline ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Lifeline",ent.getPrefs().getView());
