...
public class UMLSpecification extends Specification {
  ...
  public UMLSpecification(String id) {
    super(id);
    this.setHelpDesc("<br>A specification of an interaction that uses UML concepts. In INGENIAS it is assumed that the user<br>will apply collaboration diagrams as specification mechanism<br>			");
    this.setHelpRecom("");
  }
