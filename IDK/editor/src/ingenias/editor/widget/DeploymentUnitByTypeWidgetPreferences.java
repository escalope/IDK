...
public class DeploymentUnitByTypeWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public DeploymentUnitByTypeWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","AgentTypeDeployed","NumberInstances",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("NumberInstances",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("NumberInstances",result);
