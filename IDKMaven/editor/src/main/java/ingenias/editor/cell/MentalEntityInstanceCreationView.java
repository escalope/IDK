...
public class MentalEntityInstanceCreationView extends VertexView {

  public static MentalEntityInstanceCreationRenderer renderer = new MentalEntityInstanceCreationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public MentalEntityInstanceCreationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.MentalEntityInstanceCreation ent=(ingenias.editor.entities.MentalEntityInstanceCreation)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(MentalEntityInstanceCreation ent) {
