    ...
    Enumeration enumeration = null;
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.FAERIECtxtAttribute){
          ingenias.editor.entities.FAERIECtxtAttribute nen=(ingenias.editor.entities.FAERIECtxtAttribute)en;
	  String _name;
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.AMICtxtModel){
          ingenias.editor.entities.AMICtxtModel nen=(ingenias.editor.entities.AMICtxtModel)en;
	  String _name;
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.ContextBindingTask){
          ingenias.editor.entities.ContextBindingTask nen=(ingenias.editor.entities.ContextBindingTask)en;
	  String _name;
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.BoxedTask){
          ingenias.editor.entities.BoxedTask nen=(ingenias.editor.entities.BoxedTask)en;
	  String _name;
          
          
          os.write("<objectproperty id=\"Inputs\" collection=\"true\">\n");
             enumeration=nen.getInputsElements();
          while (enumeration.hasMoreElements()){
            ingenias.editor.entities.Entity next=(ingenias.editor.entities.Entity)enumeration.nextElement();
           saveObject(next,os);
          }
          ...
          os.write("<objectproperty id=\"Outputs\" collection=\"true\">\n");
             enumeration=nen.getOutputsElements();
          while (enumeration.hasMoreElements()){
            ingenias.editor.entities.Entity next=(ingenias.editor.entities.Entity)enumeration.nextElement();
           saveObject(next,os);
          }
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.FAERIECtxtModel){
          ingenias.editor.entities.FAERIECtxtModel nen=(ingenias.editor.entities.FAERIECtxtModel)en;
	  String _name;
          
          
          os.write("<objectproperty id=\"CtxtValues\" collection=\"true\">\n");
             enumeration=nen.getCtxtValuesElements();
          while (enumeration.hasMoreElements()){
            ingenias.editor.entities.Entity next=(ingenias.editor.entities.Entity)enumeration.nextElement();
           saveObject(next,os);
          }
          ...
          os.write("<objectproperty id=\"CtxtElements\" collection=\"true\">\n");
             enumeration=nen.getCtxtElementsElements();
          while (enumeration.hasMoreElements()){
            ingenias.editor.entities.Entity next=(ingenias.editor.entities.Entity)enumeration.nextElement();
           saveObject(next,os);
          }
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.MentalEntityInstanceCreation){
          ingenias.editor.entities.MentalEntityInstanceCreation nen=(ingenias.editor.entities.MentalEntityInstanceCreation)en;
	  String _name;
          
          _name=ingenias.editor.entities.Entity.encodeutf8Text("MentalEntity");
          os.write("<objectproperty id=\""+_name+"\">\n");
          if (nen.getMentalEntity()!=null)
           saveObject(nen.getMentalEntity(),os);
          os.write("</objectproperty>\n");
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.FAERIECtxtRelationship){
          ingenias.editor.entities.FAERIECtxtRelationship nen=(ingenias.editor.entities.FAERIECtxtRelationship)en;
	  String _name;
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.FAERIECtxtEntity){
          ingenias.editor.entities.FAERIECtxtEntity nen=(ingenias.editor.entities.FAERIECtxtEntity)en;
	  String _name;
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.ContextReleaseTask){
          ingenias.editor.entities.ContextReleaseTask nen=(ingenias.editor.entities.ContextReleaseTask)en;
	  String _name;
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.FAERIECtxtElement){
          ingenias.editor.entities.FAERIECtxtElement nen=(ingenias.editor.entities.FAERIECtxtElement)en;
	  String _name;
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.SimExtractedInformation){
          ingenias.editor.entities.SimExtractedInformation nen=(ingenias.editor.entities.SimExtractedInformation)en;
	  String _name;
          
          _name=ingenias.editor.entities.Entity.encodeutf8Text("PollAgentsInDeployment");
          os.write("<objectproperty id=\""+_name+"\">\n");
          if (nen.getPollAgentsInDeployment()!=null)
           saveObject(nen.getPollAgentsInDeployment(),os);
          os.write("</objectproperty>\n");
          
          
          os.write("<objectproperty id=\"EntitiesToExtract\" collection=\"true\">\n");
             enumeration=nen.getEntitiesToExtractElements();
          while (enumeration.hasMoreElements()){
            ingenias.editor.entities.Entity next=(ingenias.editor.entities.Entity)enumeration.nextElement();
           saveObject(next,os);
          }
	  ...
	  String _name;
          ...
          os.write("<objectproperty id=\"InjectedEvents\" collection=\"true\">\n");
             enumeration=nen.getInjectedEventsElements();
          while (enumeration.hasMoreElements()){
            ingenias.editor.entities.Entity next=(ingenias.editor.entities.Entity)enumeration.nextElement();
           saveObject(next,os);
          }
          ...
          os.write("<objectproperty id=\"ExtractedInformation\" collection=\"true\">\n");
             enumeration=nen.getExtractedInformationElements();
          while (enumeration.hasMoreElements()){
            ingenias.editor.entities.Entity next=(ingenias.editor.entities.Entity)enumeration.nextElement();
           saveObject(next,os);
          }
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.MentalEntityInstanceAccess){
          ingenias.editor.entities.MentalEntityInstanceAccess nen=(ingenias.editor.entities.MentalEntityInstanceAccess)en;
	  String _name;
	  ...
	  String _name;
        ...
        if (en instanceof ingenias.editor.entities.SimulationEvent){
          ingenias.editor.entities.SimulationEvent nen=(ingenias.editor.entities.SimulationEvent)en;
	  String _name;
          
          _name=ingenias.editor.entities.Entity.encodeutf8Text("ReceivedByAgentsInDeployment");
          os.write("<objectproperty id=\""+_name+"\">\n");
          if (nen.getReceivedByAgentsInDeployment()!=null)
           saveObject(nen.getReceivedByAgentsInDeployment(),os);
          os.write("</objectproperty>\n");
          
          _name=ingenias.editor.entities.Entity.encodeutf8Text("NewInformation");
          os.write("<objectproperty id=\""+_name+"\">\n");
          if (nen.getNewInformation()!=null)
           saveObject(nen.getNewInformation(),os);
          os.write("</objectproperty>\n");
        ...
        if (en instanceof ingenias.editor.entities.FAERIEContext){
          ingenias.editor.entities.FAERIEContext nen=(ingenias.editor.entities.FAERIEContext)en;
	  String _name;
	 ...
	 String _name;
         ...
         if (en.getClass().equals(ingenias.editor.entities.HasCtxModel.class)){
          ingenias.editor.entities.HasCtxModel nen=(ingenias.editor.entities.HasCtxModel)en;
         ...
         if (en.getClass().equals(ingenias.editor.entities.FAERIETrgtEntity.class)){
          ingenias.editor.entities.FAERIETrgtEntity nen=(ingenias.editor.entities.FAERIETrgtEntity)en;
         ...
         if (en.getClass().equals(ingenias.editor.entities.FAERIESrcEntity.class)){
          ingenias.editor.entities.FAERIESrcEntity nen=(ingenias.editor.entities.FAERIESrcEntity)en;
         ...
         if (en.getClass().equals(ingenias.editor.entities.FAERIEGeneratedBy.class)){
          ingenias.editor.entities.FAERIEGeneratedBy nen=(ingenias.editor.entities.FAERIEGeneratedBy)en;
          
          
        }
        
         if (en.getClass().equals(ingenias.editor.entities.FAERIEAppliedTo.class)){
          ingenias.editor.entities.FAERIEAppliedTo nen=(ingenias.editor.entities.FAERIEAppliedTo)en;
         ...
         if (en.getClass().equals(ingenias.editor.entities.SimulationPursues.class)){
          ingenias.editor.entities.SimulationPursues nen=(ingenias.editor.entities.SimulationPursues)en;
         ...
         if (en.getClass().equals(ingenias.editor.entities.FAERIEHasValue.class)){
          ingenias.editor.entities.FAERIEHasValue nen=(ingenias.editor.entities.FAERIEHasValue)en;
