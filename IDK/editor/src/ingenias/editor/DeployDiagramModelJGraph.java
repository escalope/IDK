...
public class DeployDiagramModelJGraph extends ModelJGraph {
 ...
 entities.add("DeploymentUnitByTypeMSEntity");
    ...
    if (nAryEdgesNum <= 1 && edgesNum == 0) {
      ...
      if (relacion.equalsIgnoreCase("DefinesDeployment")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new DefinesDeploymentEdge(new DefinesDeployment(Editor.getNewId()));
        }
      }
  ...
  public DefaultGraphCell createCell(String entity) throws InvalidEntity{
    ...
    TestingPackage nentity=getOM().createTestingPackage( Editor.getNewId("TestingPackage"));
    ...
    DeploymentPackage nentity=getOM().createDeploymentPackage( Editor.getNewId("DeploymentPackage"));
      DefaultGraphCell vertex = new
    ...
    INGENIASComponent nentity=getOM().createINGENIASComponent( Editor.getNewId("INGENIASComponent"));
      DefaultGraphCell vertex = new
    ...
    DeploymentUnitByType nentity=getOM().createDeploymentUnitByType( Editor.getNewId("DeploymentUnitByType"));
      DefaultGraphCell vertex = new
    ...
    DeploymentUnitByTypeEnumInitMS nentity=getOM().createDeploymentUnitByTypeEnumInitMS( Editor.getNewId("DeploymentUnitByTypeEnumInitMS"));
      DefaultGraphCell vertex = new
...
JOptionPane.showMessageDialog(IDE.ide,
 ...
 public synchronized JGraph cloneJGraph(){
		 ...
		 DeployDiagramModelJGraph jg=new  DeployDiagramModelJGraph(
				(DeployDiagramDataEntity) this.mde,this.name,IDEAbs.ide.ids.om,
