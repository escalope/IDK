...
public class DeploymentUnitByTypeEnumInitMSRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/DeploymentUnitByTypeEnumInitMSUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("DeploymentUnitByTypeEnumInitMS",
	index,"/ingenias/editor/rendererxml/DeploymentUnitByTypeEnumInitMSINGENIASPanel.xml");
  ...
  public static void setEntity(DeploymentUnitByTypeEnumInitMS ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("DeploymentUnitByTypeEnumInitMS",ent.getPrefs().getView());
