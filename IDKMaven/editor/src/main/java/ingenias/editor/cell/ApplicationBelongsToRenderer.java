...
public class ApplicationBelongsToRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("ApplicationBelongsTo",
	index,"/rendererxml/ApplicationBelongsToNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ApplicationBelongsTo",
	index,"/rendererxml/ApplicationBelongsToINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ApplicationBelongsTo",
	index,"/rendererxml/ApplicationBelongsToLABELPanel.xml");
     ...
     */
     public ApplicationBelongsToRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("ApplicationBelongsTo",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.ApplicationBelongsTo ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ApplicationBelongsTo",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("ApplicationBelongsTo",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("ApplicationBelongsTo",c);
	}
