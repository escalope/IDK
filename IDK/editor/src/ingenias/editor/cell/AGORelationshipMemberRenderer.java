...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AGORelationshipMemberNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGORelationshipMember",
	index,"/ingenias/editor/rendererxml/AGORelationshipMemberINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGORelationshipMember",
	index,"/ingenias/editor/rendererxml/AGORelationshipMemberLABELPanel.xml");
 ...
 public static void setEntity(AGORelationshipMember ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGORelationshipMember",ent.getPrefs().getView());
