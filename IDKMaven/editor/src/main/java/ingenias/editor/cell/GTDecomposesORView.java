...
public class GTDecomposesORView extends NAryView {

static GTDecomposesORRenderer renderer1 = new GTDecomposesORRenderer();
 public static GTDecomposesORRenderer renderer = new GTDecomposesORRenderer();
  // Constructor.
  public GTDecomposesORView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GTDecomposesOR ent=(ingenias.editor.entities.GTDecomposesOR)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GTDecomposesOR ent) {
