...
public class UMLAnnotatedElementView extends NAryView {

static UMLAnnotatedElementRenderer renderer1 = new UMLAnnotatedElementRenderer();
 public static UMLAnnotatedElementRenderer renderer = new UMLAnnotatedElementRenderer();
  // Constructor.
  public UMLAnnotatedElementView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.UMLAnnotatedElement ent=(ingenias.editor.entities.UMLAnnotatedElement)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.UMLAnnotatedElement ent) {
