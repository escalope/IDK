...
public class AMICtxtModelView extends VertexView {

  public static AMICtxtModelRenderer renderer = new AMICtxtModelRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public AMICtxtModelView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.AMICtxtModel ent=(ingenias.editor.entities.AMICtxtModel)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(AMICtxtModel ent) {
