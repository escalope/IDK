...
public class WFResponsibleEdge extends NAryEdge {
  ...
  public WFResponsibleEdge(ingenias.editor.entities.WFResponsible userObject) {
    super(userObject);
...
this.addClass("WFResponsiblesource","ingenias.editor.entities.Agent");
     
this.addClass("WFResponsiblesource","ingenias.editor.entities.AutonomousEntityQuery");
     
this.addClass("WFResponsiblesource","ingenias.editor.entities.Role");
...
this.addClass("WFResponsibletarget","ingenias.editor.entities.Task");
     
this.addClass("WFResponsibletarget","ingenias.editor.entities.Plan");
