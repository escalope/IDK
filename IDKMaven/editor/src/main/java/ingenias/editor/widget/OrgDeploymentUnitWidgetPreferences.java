...
public class OrgDeploymentUnitWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public OrgDeploymentUnitWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","InstOrganization","InstanceName",""};
