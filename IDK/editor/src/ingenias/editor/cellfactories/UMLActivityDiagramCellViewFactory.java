...
public class UMLActivityDiagramCellViewFactory implements CellViewFactory {

public UMLActivityDiagramCellViewFactory() {}
  ...
  protected VertexView createVertexView(Object v) {
   ...
   if (userObject.getClass().equals(ActionUML.class)){
           return new ActionUMLView(v);
   }

   if (userObject.getClass().equals(ActivityFinal.class)){
           return new ActivityFinalView(v);
   }
