...
*/
			...
			public class InterfaceAgentInteractionLocks implements CustomLocks {
			
			public InterfaceAgentInteractionLocks(){};
                  ...
                  if (interaction.equals("Asking_for_a_ticket")&& role.equals("User_assistant")){
                    User_assistantAsking_for_a_ticketDefaultCommControl.addDefaultLocks(lw);
                  }
				  
                  if (interaction.equals("BuyerAssignment")&& role.equals("User_assistant")){
                    User_assistantBuyerAssignmentDefaultCommControl.addDefaultLocks(lw);
                  }
