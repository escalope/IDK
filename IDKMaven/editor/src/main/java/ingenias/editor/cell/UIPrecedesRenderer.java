...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/rendererxml/UIPrecedesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UIPrecedes",
	index,"/rendererxml/UIPrecedesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UIPrecedes",
	index,"/rendererxml/UIPrecedesLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.UIPrecedes ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UIPrecedes",ent.getPrefs(attributes).getView());
