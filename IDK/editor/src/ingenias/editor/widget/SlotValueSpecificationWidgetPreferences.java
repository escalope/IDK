...
public class SlotValueSpecificationWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public SlotValueSpecificationWidgetPreferences() {
  super();
  String[] preferredOrder={"Slot","Value",""};
