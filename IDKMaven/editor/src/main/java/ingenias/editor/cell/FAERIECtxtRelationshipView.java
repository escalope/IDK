...
public class FAERIECtxtRelationshipView extends VertexView {

  public static FAERIECtxtRelationshipRenderer renderer = new FAERIECtxtRelationshipRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public FAERIECtxtRelationshipView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.FAERIECtxtRelationship ent=(ingenias.editor.entities.FAERIECtxtRelationship)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(FAERIECtxtRelationship ent) {
