...
public class TestEventInjectionView extends NAryView {

static TestEventInjectionRenderer renderer1 = new TestEventInjectionRenderer();
 public static TestEventInjectionRenderer renderer = new TestEventInjectionRenderer();
  // Constructor.
  public TestEventInjectionView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.TestEventInjection ent=(ingenias.editor.entities.TestEventInjection)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.TestEventInjection ent) {
