...
public class GTSatisfiesWidgetPreferences extends EntityWidgetPreferences {
  ...
  public GTSatisfiesWidgetPreferences() {
  super();
  String[] preferredOrder={"Label","SatisfactionCondition",""};
