...
public class BasicUseCaseDiagramMarqueeHandler extends MarqueeHandler  implements java.io.Serializable {

	



        public BasicUseCaseDiagramMarqueeHandler(ModelJGraph graph){
	super(graph);
        }
