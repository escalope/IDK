...
public class OHasMembersourceRole extends RoleEntity {
 ...
 public OHasMembersourceRole() {
	    super("OHasMembersourceRole"+idCounter);
	    idCounter++;
  ...
  public OHasMembersourceRole(String id) {
    super(id);
