...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/rendererxml/GTSatisfiesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTSatisfies",
	index,"/rendererxml/GTSatisfiesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTSatisfies",
	index,"/rendererxml/GTSatisfiesLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.GTSatisfies ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTSatisfies",ent.getPrefs(attributes).getView());
