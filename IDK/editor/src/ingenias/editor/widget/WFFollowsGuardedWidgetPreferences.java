...
public class WFFollowsGuardedWidgetPreferences extends EntityWidgetPreferences {
  ...
  public WFFollowsGuardedWidgetPreferences() {
  super();
  String[] preferredOrder={"Label","Condition",""};
