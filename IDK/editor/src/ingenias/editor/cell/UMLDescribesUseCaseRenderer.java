...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/UMLDescribesUseCaseNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UMLDescribesUseCase",
	index,"/ingenias/editor/rendererxml/UMLDescribesUseCaseINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UMLDescribesUseCase",
	index,"/ingenias/editor/rendererxml/UMLDescribesUseCaseLABELPanel.xml");
 ...
 public static void setEntity(UMLDescribesUseCase ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UMLDescribesUseCase",ent.getPrefs().getView());
