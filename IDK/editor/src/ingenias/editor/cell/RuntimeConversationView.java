...
public class RuntimeConversationView extends VertexView {

  public static RuntimeConversationRenderer renderer = new RuntimeConversationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public RuntimeConversationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.RuntimeConversation ent=(ingenias.editor.entities.RuntimeConversation)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(RuntimeConversation ent) {
