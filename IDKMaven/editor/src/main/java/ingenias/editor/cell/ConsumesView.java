...
public class ConsumesView extends NAryView {

static ConsumesRenderer renderer1 = new ConsumesRenderer();
 public static ConsumesRenderer renderer = new ConsumesRenderer();
  // Constructor.
  public ConsumesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.Consumes ent=(ingenias.editor.entities.Consumes)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.Consumes ent) {
