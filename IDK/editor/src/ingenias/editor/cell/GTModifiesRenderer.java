...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GTModifiesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTModifies",
	index,"/ingenias/editor/rendererxml/GTModifiesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTModifies",
	index,"/ingenias/editor/rendererxml/GTModifiesLABELPanel.xml");
 ...
 public static void setEntity(GTModifies ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTModifies",ent.getPrefs().getView());
