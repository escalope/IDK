...
public class GRASIASpecificationView extends VertexView {

  public static GRASIASpecificationRenderer renderer = new GRASIASpecificationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public GRASIASpecificationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.GRASIASpecification ent=(ingenias.editor.entities.GRASIASpecification)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(GRASIASpecification ent) {
