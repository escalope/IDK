...
*/
			...
			public class SellerAgent2InteractionLocks implements CustomLocks {
			
			public SellerAgent2InteractionLocks(){};
			
			        public void addInteractionLocks(String interaction, LocksWriter lw, String role){
                                    
                   if (interaction.equals("Buy_ticket") && role.equals("Seller") ){
                            SellerBuy_ticketDefaultCommControl.addDefaultLocks(lw);
                   }
