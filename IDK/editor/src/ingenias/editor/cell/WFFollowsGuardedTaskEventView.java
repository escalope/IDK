...
public class WFFollowsGuardedTaskEventView extends NAryView {

static WFFollowsGuardedTaskEventRenderer renderer1 = new WFFollowsGuardedTaskEventRenderer();

  // Constructor.
  public WFFollowsGuardedTaskEventView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.WFFollowsGuardedTaskEvent ent=(ingenias.editor.entities.WFFollowsGuardedTaskEvent)((DefaultGraphCell)this.getCell()).getUserObject();
