...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GTDestroysNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTDestroys",
	index,"/ingenias/editor/rendererxml/GTDestroysINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTDestroys",
	index,"/ingenias/editor/rendererxml/GTDestroysLABELPanel.xml");
 ...
 public static void setEntity(GTDestroys ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTDestroys",ent.getPrefs().getView());
