...
public class DeploymentPackageWithContextView extends VertexView {

  public static DeploymentPackageWithContextRenderer renderer = new DeploymentPackageWithContextRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public DeploymentPackageWithContextView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.DeploymentPackageWithContext ent=(ingenias.editor.entities.DeploymentPackageWithContext)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(DeploymentPackageWithContext ent) {
