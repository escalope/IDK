...
public class UIColaboratesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("UIColaborates",
	index,"/rendererxml/UIColaboratesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UIColaborates",
	index,"/rendererxml/UIColaboratesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UIColaborates",
	index,"/rendererxml/UIColaboratesLABELPanel.xml");
     ...
     */
     public UIColaboratesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("UIColaborates",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.UIColaborates ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UIColaborates",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("UIColaborates",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("UIColaborates",c);
	}
