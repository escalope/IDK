...
public class NaturalLanguageAgentDescriptionWidgetPreferences extends AgentDescriptionWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public NaturalLanguageAgentDescriptionWidgetPreferences() {
  super();
