...
public class MessagePassingRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/MessagePassingUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("MessagePassing",
	index,"/ingenias/editor/rendererxml/MessagePassingINGENIASPanel.xml");
  ...
  public static void setEntity(MessagePassing ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("MessagePassing",ent.getPrefs().getView());
