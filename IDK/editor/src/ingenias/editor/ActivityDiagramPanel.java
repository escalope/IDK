...
public class ActivityDiagramPanel extends JGraph {
 ...
 entities.add("TextNote");
  ...
  public DefaultGraphCell createCell(String entity) throws InvalidEntity{
    ...
    InitialNode nentity=new InitialNode(Editor.getNewId("InitialNode"));
    ...
    DecisionNode nentity=new DecisionNode(Editor.getNewId("DecisionNode"));
      DefaultGraphCell vertex = new
    ...
    ForkNode nentity=new ForkNode(Editor.getNewId("ForkNode"));
      DefaultGraphCell vertex = new
    ...
    EndNode nentity=new EndNode(Editor.getNewId("EndNode"));
      DefaultGraphCell vertex = new
          EndNodeCell(nentity);
      // Default Size for the cell with the new entity
     return vertex;
