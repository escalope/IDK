...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AUMLUseProtocol",
	index,"/rendererxml/AUMLUseProtocolNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLUseProtocol",
	index,"/rendererxml/AUMLUseProtocolINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AUMLUseProtocol",
	index,"/rendererxml/AUMLUseProtocolLABELPanel.xml");
     ...
     */
     public AUMLUseProtocolRenderer() {
    }
 ...
 public static void setEntity(ingenias.editor.entities.AUMLUseProtocol ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLUseProtocol",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AUMLUseProtocol",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AUMLUseProtocol",c);
	}
