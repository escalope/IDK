...
public class GroupDeploymentUnitView extends VertexView {

  public static GroupDeploymentUnitRenderer renderer = new GroupDeploymentUnitRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public GroupDeploymentUnitView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.GroupDeploymentUnit ent=(ingenias.editor.entities.GroupDeploymentUnit)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(GroupDeploymentUnit ent) {
