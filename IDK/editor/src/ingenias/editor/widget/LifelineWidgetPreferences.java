...
public class LifelineWidgetPreferences extends AUMLContainerWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public LifelineWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Name","Agent","Role","Cardinality","Description",""};
  this.setPreferredOrder(preferredOrder);
   ...
   preferredWidget.put("Cardinality",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("Cardinality",result);
