...
public class ApplicationBelongsToView extends NAryView {

static ApplicationBelongsToRenderer renderer1 = new ApplicationBelongsToRenderer();
 public static ApplicationBelongsToRenderer renderer = new ApplicationBelongsToRenderer();
  // Constructor.
  public ApplicationBelongsToView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.ApplicationBelongsTo ent=(ingenias.editor.entities.ApplicationBelongsTo)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.ApplicationBelongsTo ent) {
