...
public class JoinNodeRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/JoinNodeUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("JoinNode",
	index,"/ingenias/editor/rendererxml/JoinNodeINGENIASPanel.xml");
  ...
  public static void setEntity(JoinNode ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("JoinNode",ent.getPrefs().getView());
