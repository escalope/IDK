...
public class CopyOfCheckingATicketWasObtained {
	@Test
...
MentalStateManager msmB = 
	 MSMRepository.getInstance().waitFor("BuyerAgent_0multipleBuyers");
MentalStateProcessor mspB = 
	MSPRepository.getInstance().waitFor("BuyerAgent_0multipleBuyers");
TestUtils.waitForAgentInitialised(mspB);

MentalStateManager msmIA = 
	 MSMRepository.getInstance().waitFor("InterfaceAgent_0multipleInterfaceAgents");
MentalStateProcessor mspIA = 
	MSPRepository.getInstance().waitFor("InterfaceAgent_0multipleInterfaceAgents");
