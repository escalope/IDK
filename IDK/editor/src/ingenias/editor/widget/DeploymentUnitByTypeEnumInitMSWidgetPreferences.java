...
public class DeploymentUnitByTypeEnumInitMSWidgetPreferences extends DeploymentUnitByTypeWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public DeploymentUnitByTypeEnumInitMSWidgetPreferences() {
  super();
