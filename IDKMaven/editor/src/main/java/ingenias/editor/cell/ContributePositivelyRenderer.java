...
public class ContributePositivelyRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("ContributePositively",
	index,"/rendererxml/ContributePositivelyNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ContributePositively",
	index,"/rendererxml/ContributePositivelyINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ContributePositively",
	index,"/rendererxml/ContributePositivelyLABELPanel.xml");
     ...
     */
     public ContributePositivelyRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("ContributePositively",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.ContributePositively ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ContributePositively",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("ContributePositively",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("ContributePositively",c);
	}
