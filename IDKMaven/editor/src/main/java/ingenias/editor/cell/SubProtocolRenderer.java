...
public class SubProtocolRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/rendererxml/SubProtocolUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("SubProtocol",
	index,"/rendererxml/SubProtocolINGENIASPanel.xml");
    ...
    public SubProtocolRenderer() {
	  ...
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("SubProtocol",ent.getPrefs(map).getView());
  ...
  public static void setEntity(SubProtocol ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("SubProtocol",ent.getPrefs(attributes).getView());
