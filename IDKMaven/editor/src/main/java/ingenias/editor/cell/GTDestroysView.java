...
public class GTDestroysView extends NAryView {

static GTDestroysRenderer renderer1 = new GTDestroysRenderer();
 public static GTDestroysRenderer renderer = new GTDestroysRenderer();
  // Constructor.
  public GTDestroysView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GTDestroys ent=(ingenias.editor.entities.GTDestroys)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GTDestroys ent) {
