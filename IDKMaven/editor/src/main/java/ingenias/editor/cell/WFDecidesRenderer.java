...
public class WFDecidesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFDecides",
	index,"/rendererxml/WFDecidesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFDecides",
	index,"/rendererxml/WFDecidesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFDecides",
	index,"/rendererxml/WFDecidesLABELPanel.xml");
     ...
     */
     public WFDecidesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFDecides",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.WFDecides ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFDecides",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFDecides",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFDecides",c);
	}
