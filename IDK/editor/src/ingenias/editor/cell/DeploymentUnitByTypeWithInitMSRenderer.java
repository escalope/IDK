...
public class DeploymentUnitByTypeWithInitMSRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/DeploymentUnitByTypeWithInitMSUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("DeploymentUnitByTypeWithInitMS",
	index,"/ingenias/editor/rendererxml/DeploymentUnitByTypeWithInitMSINGENIASPanel.xml");
  ...
  public static void setEntity(DeploymentUnitByTypeWithInitMS ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("DeploymentUnitByTypeWithInitMS",ent.getPrefs().getView());
