...
public class WFSpecifiesExecutionRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFSpecifiesExecution",
	index,"/rendererxml/WFSpecifiesExecutionNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFSpecifiesExecution",
	index,"/rendererxml/WFSpecifiesExecutionINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFSpecifiesExecution",
	index,"/rendererxml/WFSpecifiesExecutionLABELPanel.xml");
     ...
     */
     public WFSpecifiesExecutionRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFSpecifiesExecution",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.WFSpecifiesExecution ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFSpecifiesExecution",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFSpecifiesExecution",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFSpecifiesExecution",c);
	}
