...
public class BelieveRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/BelieveUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Believe",
	index,"/ingenias/editor/rendererxml/BelieveINGENIASPanel.xml");
  ...
  public static void setEntity(Believe ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Believe",ent.getPrefs().getView());
