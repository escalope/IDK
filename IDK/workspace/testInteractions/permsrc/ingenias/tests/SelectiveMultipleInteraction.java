...
public class SelectiveMultipleInteraction {
	@Test
	public void testDemo() throws TimeOut{			
		...
		// initiator
		MentalStateManager msmA = MSMRepository.getInstance().waitFor("ASelective_0"); 
		MentalStateProcessor mspA = MSPRepository.getInstance().waitFor("ASelective_0"); 
		...
		TestUtils.printSnapshot("snapB0Initial");
		assertTrue("Agent B_0 should remain the same and I found the following differences "+differencesB0,differencesB0.size()==0);

		//*************************************************
		// Agent B1
		//*************************************************
		
		ingenias.editor.entities.RuntimeConversation conv= TestUtils.checkFirstConversation(msmB1,"B_1","finished");						
		...
		conv = TestUtils.checkFirstConversation(msmA,"ASelective_0","finished");

					
		TestUtils.checkNOExistenceMEWithinMS(msmA, "InitialQuestion", "ASelective_0");
		TestUtils.checkExistenceMEWithinConv(conv, "InitialQuestion", "ASelective_0",1);

		TestUtils.checkNOExistenceMEWithinMS(msmA, "MultipleAnswer", "ASelective_0");
		TestUtils.checkNOExistenceMEWithinConv(conv, "MultipleAnswer", "ASelective_0");

		TestUtils.checkNOExistenceMEWithinMS(msmA, "SingleQuestion", "ASelective_0");
		TestUtils.checkExistenceMEWithinConv(conv, "SingleQuestion", "ASelective_0",1);

		TestUtils.checkNOExistenceMEWithinMS(msmA, "InitialFact", "ASelective_0");
		TestUtils.checkNOExistenceMEWithinConv(conv, "InitialFact", "ASelective_0");
		...
		//TestUtils.printSnapshot("snapC4Initial");
