...
public class TextUseCaseRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/TextUseCaseUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("TextUseCase",
	index,"/ingenias/editor/rendererxml/TextUseCaseINGENIASPanel.xml");
  ...
  public static void setEntity(TextUseCase ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("TextUseCase",ent.getPrefs().getView());
