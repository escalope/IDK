...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GTOrDependsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTOrDepends",
	index,"/ingenias/editor/rendererxml/GTOrDependsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTOrDepends",
	index,"/ingenias/editor/rendererxml/GTOrDependsLABELPanel.xml");
 ...
 public static void setEntity(GTOrDepends ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTOrDepends",ent.getPrefs().getView());
