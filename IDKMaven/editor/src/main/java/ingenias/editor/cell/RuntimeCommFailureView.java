...
public class RuntimeCommFailureView extends VertexView {

  public static RuntimeCommFailureRenderer renderer = new RuntimeCommFailureRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public RuntimeCommFailureView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.RuntimeCommFailure ent=(ingenias.editor.entities.RuntimeCommFailure)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(RuntimeCommFailure ent) {
