...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/UISelectionNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UISelection",
	index,"/ingenias/editor/rendererxml/UISelectionINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UISelection",
	index,"/ingenias/editor/rendererxml/UISelectionLABELPanel.xml");
 ...
 public static void setEntity(UISelection ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UISelection",ent.getPrefs().getView());
