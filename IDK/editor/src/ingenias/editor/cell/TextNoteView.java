...
public class TextNoteView extends VertexView {

  public static TextNoteRenderer renderer = new TextNoteRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public TextNoteView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.TextNote ent=(ingenias.editor.entities.TextNote)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(TextNote ent) {
