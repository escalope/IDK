...
public class ApplicationEventWidgetPreferences extends GeneralEventWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public ApplicationEventWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Source",""};
