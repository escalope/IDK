...
public class AUMLAlternativeRowWidgetPreferences extends AUMLContainerWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public AUMLAlternativeRowWidgetPreferences() {
  super();
  String[] preferredOrder={"Condition",""};
