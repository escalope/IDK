...
public class ContributeNegativelyView extends NAryView {

static ContributeNegativelyRenderer renderer1 = new ContributeNegativelyRenderer();
 public static ContributeNegativelyRenderer renderer = new ContributeNegativelyRenderer();
  // Constructor.
  public ContributeNegativelyView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.ContributeNegatively ent=(ingenias.editor.entities.ContributeNegatively)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.ContributeNegatively ent) {
