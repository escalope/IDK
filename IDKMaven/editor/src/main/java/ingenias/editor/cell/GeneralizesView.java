...
public class GeneralizesView extends NAryView {

static GeneralizesRenderer renderer1 = new GeneralizesRenderer();
 public static GeneralizesRenderer renderer = new GeneralizesRenderer();
  // Constructor.
  public GeneralizesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.Generalizes ent=(ingenias.editor.entities.Generalizes)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.Generalizes ent) {
