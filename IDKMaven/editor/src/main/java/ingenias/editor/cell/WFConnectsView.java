...
public class WFConnectsView extends NAryView {

static WFConnectsRenderer renderer1 = new WFConnectsRenderer();
 public static WFConnectsRenderer renderer = new WFConnectsRenderer();
  // Constructor.
  public WFConnectsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFConnects ent=(ingenias.editor.entities.WFConnects)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFConnects ent) {
