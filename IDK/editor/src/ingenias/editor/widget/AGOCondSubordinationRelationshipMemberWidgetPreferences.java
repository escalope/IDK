...
public class AGOCondSubordinationRelationshipMemberWidgetPreferences extends EntityWidgetPreferences {
  ...
  public AGOCondSubordinationRelationshipMemberWidgetPreferences() {
  super();
