...
public class ActionUMLRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/ActionUMLUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ActionUML",
	index,"/ingenias/editor/rendererxml/ActionUMLINGENIASPanel.xml");
  ...
  public static void setEntity(ActionUML ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ActionUML",ent.getPrefs().getView());
