...
public class DeploymentUnitByTypeWithInitMSWidgetPreferences extends DeploymentUnitByTypeWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public DeploymentUnitByTypeWithInitMSWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","AgentTypeDeployed","NumberInstances","InitialState",""};
