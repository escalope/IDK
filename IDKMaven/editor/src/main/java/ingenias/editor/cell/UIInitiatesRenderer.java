...
public class UIInitiatesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("UIInitiates",
	index,"/rendererxml/UIInitiatesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UIInitiates",
	index,"/rendererxml/UIInitiatesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UIInitiates",
	index,"/rendererxml/UIInitiatesLABELPanel.xml");
     ...
     */
     public UIInitiatesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("UIInitiates",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.UIInitiates ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UIInitiates",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("UIInitiates",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("UIInitiates",c);
	}
