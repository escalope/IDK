...
public class OHasMemberRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("OHasMember",
	index,"/rendererxml/OHasMemberNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("OHasMember",
	index,"/rendererxml/OHasMemberINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("OHasMember",
	index,"/rendererxml/OHasMemberLABELPanel.xml");
     ...
     */
     public OHasMemberRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("OHasMember",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.OHasMember ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("OHasMember",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("OHasMember",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("OHasMember",c);
	}
