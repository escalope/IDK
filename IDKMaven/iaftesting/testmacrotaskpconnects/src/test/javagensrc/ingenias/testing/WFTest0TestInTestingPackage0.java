...
public class WFTest0TestInTestingPackage0 extends TestingPackage0ForWFTest0 {
  ...
  public void testDemo() throws TimeOut{		
			...
			ga.addStateTransition("WFTestInitialState0","Agent0_0DeploymentUnitByType0-Task1","WFTestState0");
			
			ga.addStateTransition("WFTestState0","Agent0_0DeploymentUnitByType0-Task2","WFTestFinalState1");
        	...
        	tev.registerTask("Agent0_0DeploymentUnitByType0","Task1");
        	
        	tev.registerTask("Agent0_0DeploymentUnitByType0","Task2");
