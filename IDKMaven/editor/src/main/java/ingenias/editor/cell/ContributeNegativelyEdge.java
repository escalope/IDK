...
public class ContributeNegativelyEdge extends NAryEdge {

  // Constructor with data content
  public ContributeNegativelyEdge(ingenias.editor.entities.ContributeNegatively userObject) {
    super(userObject);
    
     this.addRole("Contributesource");
     this.setArity("Contributesource",true,1);
     this.setArity("Contributesource",false,1);
     
this.addClass("Contributesource","ingenias.editor.entities.Goal");
     
    
     this.addRole("Contributetarget");
     this.setArity("Contributetarget",true,1);
     this.setArity("Contributetarget",false,2147483647);
     
this.addClass("Contributetarget","ingenias.editor.entities.Goal");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof ContributeNegativelyEdge)))
      return false;

    // n-edge to be considered.
    ContributeNegativelyEdge edge = new ContributeNegativelyEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof ContributeNegativelyEdge)
      edge = (ContributeNegativelyEdge) selectedEdge;
