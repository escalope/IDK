...
public class WFUsesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFUses",
	index,"/rendererxml/WFUsesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFUses",
	index,"/rendererxml/WFUsesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFUses",
	index,"/rendererxml/WFUsesLABELPanel.xml");
     ...
     */
     public WFUsesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFUses",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.WFUses ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFUses",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFUses",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFUses",c);
	}
