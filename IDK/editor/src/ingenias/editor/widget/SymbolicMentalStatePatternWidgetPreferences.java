...
public class SymbolicMentalStatePatternWidgetPreferences extends MentalStatePatternWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public SymbolicMentalStatePatternWidgetPreferences() {
  super();
