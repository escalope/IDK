...
public class Make_Buyer_an_AssitantTask extends Task{

 public Make_Buyer_an_AssitantTask(String id){
  super(id,"Make_Buyer_an_Assitant");
 }
 ...
 public void execute() throws TaskException{
        ...
        SimulationKernelApp eaSimulationKernel=(SimulationKernelApp)this.getApplication("SimulationKernel");
		...
		AssignedBuyer outputsdefaultAssignedBuyer=
			(AssignedBuyer)
				outputsdefault.getEntityByType("AssignedBuyer");
...
//#start_node:INGENIASCodeComponent6 <--- DO NOT REMOVE THIS	
        outputsdefaultAssignedBuyer.setbuyerName(eiBuyersToConsult.getbuyerBeingConsulted());
