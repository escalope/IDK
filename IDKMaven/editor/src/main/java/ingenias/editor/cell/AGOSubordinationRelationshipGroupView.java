...
public class AGOSubordinationRelationshipGroupView extends NAryView {

static AGOSubordinationRelationshipGroupRenderer renderer1 = new AGOSubordinationRelationshipGroupRenderer();
 public static AGOSubordinationRelationshipGroupRenderer renderer = new AGOSubordinationRelationshipGroupRenderer();
  // Constructor.
  public AGOSubordinationRelationshipGroupView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGOSubordinationRelationshipGroup ent=(ingenias.editor.entities.AGOSubordinationRelationshipGroup)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGOSubordinationRelationshipGroup ent) {
