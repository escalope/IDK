...
public class AGOInconditionalSubordinationRelationshipMemberView extends NAryView {

static AGOInconditionalSubordinationRelationshipMemberRenderer renderer1 = new AGOInconditionalSubordinationRelationshipMemberRenderer();
 public static AGOInconditionalSubordinationRelationshipMemberRenderer renderer = new AGOInconditionalSubordinationRelationshipMemberRenderer();
  // Constructor.
  public AGOInconditionalSubordinationRelationshipMemberView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGOInconditionalSubordinationRelationshipMember ent=(ingenias.editor.entities.AGOInconditionalSubordinationRelationshipMember)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGOInconditionalSubordinationRelationshipMember ent) {
