...
public class OrganizationModelPanel extends JGraph {
 ...
 entities.add("WorkflowBox");
  ...
  public DefaultGraphCell createCell(String entity) throws InvalidEntity{
    ...
    Organization nentity=new Organization(Editor.getNewId("Organization"));
      DefaultGraphCell vertex = new
    ...
    OrganizationGroup nentity=new OrganizationGroup(Editor.getNewId("OrganizationGroup"));
      DefaultGraphCell vertex = new
    ...
    OrganizationNetwork nentity=new OrganizationNetwork(Editor.getNewId("OrganizationNetwork"));
      DefaultGraphCell vertex = new
    ...
    Resource nentity=new Resource(Editor.getNewId("Resource"));
      DefaultGraphCell vertex = new
    ...
    Workflow nentity=new Workflow(Editor.getNewId("Workflow"));
      DefaultGraphCell vertex = new
    ...
    WorkflowBox nentity=new WorkflowBox(Editor.getNewId("WorkflowBox"));
      DefaultGraphCell vertex = new
