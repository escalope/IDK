...
public class AUMLContainerView extends VertexView {

  public static AUMLContainerRenderer renderer = new AUMLContainerRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public AUMLContainerView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.AUMLContainer ent=(ingenias.editor.entities.AUMLContainer)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(AUMLContainer ent) {
