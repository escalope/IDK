...
public class AInstanceOfRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AInstanceOf",
	index,"/rendererxml/AInstanceOfNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AInstanceOf",
	index,"/rendererxml/AInstanceOfINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AInstanceOf",
	index,"/rendererxml/AInstanceOfLABELPanel.xml");
     ...
     */
     public AInstanceOfRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AInstanceOf",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AInstanceOf ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AInstanceOf",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AInstanceOf",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AInstanceOf",c);
	}
