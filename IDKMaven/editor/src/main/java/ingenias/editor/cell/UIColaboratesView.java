...
public class UIColaboratesView extends NAryView {

static UIColaboratesRenderer renderer1 = new UIColaboratesRenderer();
 public static UIColaboratesRenderer renderer = new UIColaboratesRenderer();
  // Constructor.
  public UIColaboratesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.UIColaborates ent=(ingenias.editor.entities.UIColaborates)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.UIColaborates ent) {
