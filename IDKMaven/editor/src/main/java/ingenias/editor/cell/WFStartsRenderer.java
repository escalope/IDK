...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/rendererxml/WFStartsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFStarts",
	index,"/rendererxml/WFStartsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFStarts",
	index,"/rendererxml/WFStartsLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.WFStarts ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFStarts",ent.getPrefs(attributes).getView());
