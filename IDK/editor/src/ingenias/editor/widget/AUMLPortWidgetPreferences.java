...
public class AUMLPortWidgetPreferences extends AUMLComponentWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public AUMLPortWidgetPreferences() {
  super();
  String[] preferredOrder={""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("Dest",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("Dest",result);
