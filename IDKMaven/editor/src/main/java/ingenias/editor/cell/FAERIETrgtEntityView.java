...
public class FAERIETrgtEntityView extends NAryView {

static FAERIETrgtEntityRenderer renderer1 = new FAERIETrgtEntityRenderer();
 public static FAERIETrgtEntityRenderer renderer = new FAERIETrgtEntityRenderer();
  // Constructor.
  public FAERIETrgtEntityView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.FAERIETrgtEntity ent=(ingenias.editor.entities.FAERIETrgtEntity)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.FAERIETrgtEntity ent) {
