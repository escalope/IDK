...
public class AGOClientServerRelationshipMemberWidgetPreferences extends EntityWidgetPreferences {
  ...
  public AGOClientServerRelationshipMemberWidgetPreferences() {
  super();
  String[] preferredOrder={"OfferedGoalService","Label",""};
