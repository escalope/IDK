...
public class UMLAnnotatedElementEdge extends NAryEdge {

  // Constructor with data content
  public UMLAnnotatedElementEdge(ingenias.editor.entities.UMLAnnotatedElement userObject) {
    super(userObject);
    
     this.addRole("HasCommentsource");
     this.setArity("HasCommentsource",true,1);
     this.setArity("HasCommentsource",false,1);
     
this.addClass("HasCommentsource","ingenias.editor.entities.UMLComment");
     
    
     this.addRole("HasCommenttarget");
     this.setArity("HasCommenttarget",true,1);
     this.setArity("HasCommenttarget",false,1);
     
this.addClass("HasCommenttarget","ingenias.editor.entities.INGENIASObject");
     
this.addClass("HasCommenttarget","ingenias.editor.entities.UMLObject");
     
this.addClass("HasCommenttarget","ingenias.editor.entities.UMLClassifier");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof UMLAnnotatedElementEdge)))
      return false;

    // n-edge to be considered.
    UMLAnnotatedElementEdge edge = new UMLAnnotatedElementEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof UMLAnnotatedElementEdge)
      edge = (UMLAnnotatedElementEdge) selectedEdge;
