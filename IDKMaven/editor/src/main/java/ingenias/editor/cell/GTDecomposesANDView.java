...
public class GTDecomposesANDView extends NAryView {

static GTDecomposesANDRenderer renderer1 = new GTDecomposesANDRenderer();
 public static GTDecomposesANDRenderer renderer = new GTDecomposesANDRenderer();
  // Constructor.
  public GTDecomposesANDView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GTDecomposesAND ent=(ingenias.editor.entities.GTDecomposesAND)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GTDecomposesAND ent) {
