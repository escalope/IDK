...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/IHasSpecNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IHasSpec",
	index,"/ingenias/editor/rendererxml/IHasSpecINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("IHasSpec",
	index,"/ingenias/editor/rendererxml/IHasSpecLABELPanel.xml");
 ...
 public static void setEntity(IHasSpec ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IHasSpec",ent.getPrefs().getView());
