	...
	super(resources,state);
	 ...
	 protected Vector<AbstractAction> createChangeViewActions(final DefaultGraphCell cell, final ModelJGraph graph) {
		...
		final ingenias.editor.entities.Entity ent=((ingenias.editor.entities.Entity)cell.getUserObject());
			 ...
			 if (ent.getClass().getName().equals("ingenias.editor.entities.DeploymentPackageWithContext")){
			 final ViewPreferences.ViewType current1=ViewPreferences.ViewType.UML;
                   possibleViews.add(new AbstractAction("UML") {
                     public void actionPerformed(ActionEvent e) {
                     graph.getListenerContainer().storeContraints(cell);      
			 ...
			 if (ent.getClass().getName().equals("ingenias.editor.entities.SimulationEvent")){
			 final ViewPreferences.ViewType current1=ViewPreferences.ViewType.UML;
                   possibleViews.add(new AbstractAction("UML") {
                     public void actionPerformed(ActionEvent e) {
                     graph.getListenerContainer().storeContraints(cell);      
			 ...
			 if (ent.getClass().getName().equals("ingenias.editor.entities.SimExtractedInformation")){
			 final ViewPreferences.ViewType current1=ViewPreferences.ViewType.UML;
                   possibleViews.add(new AbstractAction("UML") {
                     public void actionPerformed(ActionEvent e) {
                     graph.getListenerContainer().storeContraints(cell);      
		  ...
		  /*   ingenias.editor.cell.RenderComponentManager.setRelationshipView(ViewPreferences.ViewType.LABEL,
			 ...
			 if (ent.getClass().getName().equals("ingenias.editor.entities.SimulationPursues")){
			...
			new AbstractAction("Insert DeploymentPackageWithContext") {
				public void actionPerformed(ActionEvent ev) {
					try {
						...
						e.printStackTrace();
						JOptionPane.showMessageDialog(graph, "Object type DeploymentPackageWithContext is not allowed in this diagram",
                                "Warning", JOptionPane.WARNING_MESSAGE);
					}
				}
			});
			...
			new AbstractAction("Insert SimulationEvent") {
				public void actionPerformed(ActionEvent ev) {
					try {
						...
						e.printStackTrace();
						JOptionPane.showMessageDialog(graph, "Object type SimulationEvent is not allowed in this diagram",
                                "Warning", JOptionPane.WARNING_MESSAGE);
					}
				}
			});
			...
			new AbstractAction("Insert SimExtractedInformation") {
				public void actionPerformed(ActionEvent ev) {
					try {
						...
						e.printStackTrace();
						JOptionPane.showMessageDialog(graph, "Object type SimExtractedInformation is not allowed in this diagram",
                                "Warning", JOptionPane.WARNING_MESSAGE);
					}
				}
			});
