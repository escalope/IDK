...
public class TestEventInjectionRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("TestEventInjection",
	index,"/rendererxml/TestEventInjectionNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("TestEventInjection",
	index,"/rendererxml/TestEventInjectionINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("TestEventInjection",
	index,"/rendererxml/TestEventInjectionLABELPanel.xml");
     ...
     */
     public TestEventInjectionRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("TestEventInjection",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.TestEventInjection ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("TestEventInjection",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("TestEventInjection",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("TestEventInjection",c);
	}
