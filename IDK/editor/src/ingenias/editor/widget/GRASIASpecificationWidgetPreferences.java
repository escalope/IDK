...
public class GRASIASpecificationWidgetPreferences extends SpecificationWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public GRASIASpecificationWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","ModelThatContainsSpecification",""};
