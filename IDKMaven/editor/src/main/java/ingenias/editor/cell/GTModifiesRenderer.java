...
public class GTModifiesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("GTModifies",
	index,"/rendererxml/GTModifiesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTModifies",
	index,"/rendererxml/GTModifiesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTModifies",
	index,"/rendererxml/GTModifiesLABELPanel.xml");
     ...
     */
     public GTModifiesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("GTModifies",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.GTModifies ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTModifies",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("GTModifies",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("GTModifies",c);
	}
