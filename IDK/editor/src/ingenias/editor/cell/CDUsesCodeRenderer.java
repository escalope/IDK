...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/CDUsesCodeNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("CDUsesCode",
	index,"/ingenias/editor/rendererxml/CDUsesCodeINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("CDUsesCode",
	index,"/ingenias/editor/rendererxml/CDUsesCodeLABELPanel.xml");
 ...
 public static void setEntity(CDUsesCode ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("CDUsesCode",ent.getPrefs().getView());
