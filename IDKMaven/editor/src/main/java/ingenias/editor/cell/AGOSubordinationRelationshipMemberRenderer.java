...
public class AGOSubordinationRelationshipMemberRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipMember",
	index,"/rendererxml/AGOSubordinationRelationshipMemberNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipMember",
	index,"/rendererxml/AGOSubordinationRelationshipMemberINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipMember",
	index,"/rendererxml/AGOSubordinationRelationshipMemberLABELPanel.xml");
     ...
     */
     public AGOSubordinationRelationshipMemberRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGOSubordinationRelationshipMember",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGOSubordinationRelationshipMember ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOSubordinationRelationshipMember",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGOSubordinationRelationshipMember",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGOSubordinationRelationshipMember",c);
	}
