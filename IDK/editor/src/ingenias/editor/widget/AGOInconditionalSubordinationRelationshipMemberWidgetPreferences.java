...
public class AGOInconditionalSubordinationRelationshipMemberWidgetPreferences extends EntityWidgetPreferences {
  ...
  public AGOInconditionalSubordinationRelationshipMemberWidgetPreferences() {
  super();
