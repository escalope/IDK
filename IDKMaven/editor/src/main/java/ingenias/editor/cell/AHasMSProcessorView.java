...
public class AHasMSProcessorView extends NAryView {

static AHasMSProcessorRenderer renderer1 = new AHasMSProcessorRenderer();
 public static AHasMSProcessorRenderer renderer = new AHasMSProcessorRenderer();
  // Constructor.
  public AHasMSProcessorView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AHasMSProcessor ent=(ingenias.editor.entities.AHasMSProcessor)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AHasMSProcessor ent) {
