...
public class GUIAgentProtocol implements AgentProtocols{
...
public GUIAgentProtocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("Interaction0") && conv.getPlayedRole().equals("Role0")){
		   DefaultCommControl dcc=new Role0Interaction0DefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new Role0Interaction0StateBehavior(
			agentName,
				msr,msu,
					conv,                           		
				   conv.getPlayedRole(),
               ...
               if (interaction.equals("Interaction0")){
                ...
                Vector<AgentExternalDescription> cols=new Vector<AgentExternalDescription>();
                 ...
                 String cardinality="";
                   ...
                   if (cardinality.equals("1") || cardinality.equals(""))
                    cols.add(new AgentExternalDescription(agents[0].getName(),"Role1"));
                    else
                	   if (cardinality.equals("1__*"))
						   for (int k=0;k<agents.length;k++)
