...
public class AGORelationshipGroupRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGORelationshipGroup",
	index,"/rendererxml/AGORelationshipGroupNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGORelationshipGroup",
	index,"/rendererxml/AGORelationshipGroupINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGORelationshipGroup",
	index,"/rendererxml/AGORelationshipGroupLABELPanel.xml");
     ...
     */
     public AGORelationshipGroupRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGORelationshipGroup",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGORelationshipGroup ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGORelationshipGroup",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGORelationshipGroup",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGORelationshipGroup",c);
	}
