...
public class OrganizationModelModelJGraph extends ModelJGraph {
 ...
 entities.add("WorkflowBox");
    ...
    if (nAryEdgesNum <= 1 && edgesNum == 0) {
      ...
      if (relacion.equalsIgnoreCase("EResourceBelongsTo")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new EResourceBelongsToEdge(new EResourceBelongsTo(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("OHasGroup")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new OHasGroupEdge(new OHasGroup(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("OHasMember")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new OHasMemberEdge(new OHasMember(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("OHasWF")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new OHasWFEdge(new OHasWF(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("ODecomposesGroup")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new ODecomposesGroupEdge(new ODecomposesGroup(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("ODecomposesWF")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new ODecomposesWFEdge(new ODecomposesWF(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("WFConnects")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new WFConnectsEdge(new WFConnects(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("WFContainsTask")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new WFContainsTaskEdge(new WFContainsTask(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGORelationshipGroup")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGORelationshipGroupEdge(new AGORelationshipGroup(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGORelationshipMember")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGORelationshipMemberEdge(new AGORelationshipMember(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGORelationshipOrg")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGORelationshipOrgEdge(new AGORelationshipOrg(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGOSubordinationRelationshipGroup")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGOSubordinationRelationshipGroupEdge(new AGOSubordinationRelationshipGroup(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGOSubordinationRelationshipMember")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGOSubordinationRelationshipMemberEdge(new AGOSubordinationRelationshipMember(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGOSubordinationRelationshipOrg")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGOSubordinationRelationshipOrgEdge(new AGOSubordinationRelationshipOrg(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGOCondSubordinationRelationshipGroup")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGOCondSubordinationRelationshipGroupEdge(new AGOCondSubordinationRelationshipGroup(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGOCondSubordinationRelationshipMember")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGOCondSubordinationRelationshipMemberEdge(new AGOCondSubordinationRelationshipMember(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGOCondSubordinationRelationshipOrg")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGOCondSubordinationRelationshipOrgEdge(new AGOCondSubordinationRelationshipOrg(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGOInconditionalSubordinationRelationshipGroup")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGOInconditionalSubordinationRelationshipGroupEdge(new AGOInconditionalSubordinationRelationshipGroup(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGOInconditionalSubordinationRelationshipMember")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGOInconditionalSubordinationRelationshipMemberEdge(new AGOInconditionalSubordinationRelationshipMember(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGOInconditionalSubordinationRelationshipOrg")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGOInconditionalSubordinationRelationshipOrgEdge(new AGOInconditionalSubordinationRelationshipOrg(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGOClientServerRelationshipGroup")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGOClientServerRelationshipGroupEdge(new AGOClientServerRelationshipGroup(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGOClientServerRelationshipMember")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGOClientServerRelationshipMemberEdge(new AGOClientServerRelationshipMember(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("AGOClientServerRelationshipOrg")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new AGOClientServerRelationshipOrgEdge(new AGOClientServerRelationshipOrg(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("WFSpecifiesExecution")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new WFSpecifiesExecutionEdge(new WFSpecifiesExecution(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("WFPlays")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new WFPlaysEdge(new WFPlays(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("WFDecomposesWF")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new WFDecomposesWFEdge(new WFDecomposesWF(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("WSConnects")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new WSConnectsEdge(new WSConnects(Editor.getNewId()));
        }
      }
  ...
  public DefaultGraphCell createCell(String entity) throws InvalidEntity{
    ...
    Organization nentity=getOM().createOrganization( Editor.getNewId("Organization"));
      DefaultGraphCell vertex = new
    ...
    OrganizationGroup nentity=getOM().createOrganizationGroup( Editor.getNewId("OrganizationGroup"));
      DefaultGraphCell vertex = new
    ...
    OrganizationNetwork nentity=getOM().createOrganizationNetwork( Editor.getNewId("OrganizationNetwork"));
      DefaultGraphCell vertex = new
    ...
    AutonomousEntityQuery nentity=getOM().createAutonomousEntityQuery( Editor.getNewId("AutonomousEntityQuery"));
      DefaultGraphCell vertex = new
    ...
    AgentRequirementsQuery nentity=getOM().createAgentRequirementsQuery( Editor.getNewId("AgentRequirementsQuery"));
      DefaultGraphCell vertex = new
    ...
    ConcreteAgent nentity=getOM().createConcreteAgent( Editor.getNewId("ConcreteAgent"));
      DefaultGraphCell vertex = new
...
JOptionPane.showMessageDialog(IDE.ide,
 ...
 public synchronized JGraph cloneJGraph(){
		 ...
		 OrganizationModelModelJGraph jg=new  OrganizationModelModelJGraph(
				(OrganizationModelDataEntity) this.mde,this.name,IDEAbs.ide.ids.om,
