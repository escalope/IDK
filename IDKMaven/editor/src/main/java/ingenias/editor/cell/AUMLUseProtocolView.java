...
public class AUMLUseProtocolView extends NAryView {

static AUMLUseProtocolRenderer renderer1 = new AUMLUseProtocolRenderer();
 public static AUMLUseProtocolRenderer renderer = new AUMLUseProtocolRenderer();
  // Constructor.
  public AUMLUseProtocolView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AUMLUseProtocol ent=(ingenias.editor.entities.AUMLUseProtocol)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AUMLUseProtocol ent) {
