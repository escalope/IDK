...
public class IHasSpecView extends NAryView {

static IHasSpecRenderer renderer1 = new IHasSpecRenderer();
 public static IHasSpecRenderer renderer = new IHasSpecRenderer();
  // Constructor.
  public IHasSpecView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.IHasSpec ent=(ingenias.editor.entities.IHasSpec)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.IHasSpec ent) {
