...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFUsesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFUses",
	index,"/ingenias/editor/rendererxml/WFUsesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFUses",
	index,"/ingenias/editor/rendererxml/WFUsesLABELPanel.xml");
 ...
 public static void setEntity(WFUses ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFUses",ent.getPrefs().getView());
