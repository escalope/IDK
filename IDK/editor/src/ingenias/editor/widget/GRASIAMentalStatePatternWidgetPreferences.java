...
public class GRASIAMentalStatePatternWidgetPreferences extends SymbolicMentalStatePatternWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public GRASIAMentalStatePatternWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","DescriptionWithAgentModel",""};
