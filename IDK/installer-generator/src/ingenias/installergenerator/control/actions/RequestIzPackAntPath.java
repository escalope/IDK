 ...
 * @author Carlos
 */
public class RequestIzPackAntPath implements Action{

    public RequestIzPackAntPath() {
    }

    public void execute(AbstractEvent event) {
        UpdateCommandFactory factory = UpdateCommandFactory.getInstance();
        UpdateCommand command = factory.createCommand(UpdateCommandId.IzPackAntPathFormView);
        command.execute();
    }
