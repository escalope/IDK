...
public class GroupBelongsToOrganizationRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("GroupBelongsToOrganization",
	index,"/rendererxml/GroupBelongsToOrganizationNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GroupBelongsToOrganization",
	index,"/rendererxml/GroupBelongsToOrganizationINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GroupBelongsToOrganization",
	index,"/rendererxml/GroupBelongsToOrganizationLABELPanel.xml");
     ...
     */
     public GroupBelongsToOrganizationRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("GroupBelongsToOrganization",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.GroupBelongsToOrganization ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GroupBelongsToOrganization",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("GroupBelongsToOrganization",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("GroupBelongsToOrganization",c);
	}
