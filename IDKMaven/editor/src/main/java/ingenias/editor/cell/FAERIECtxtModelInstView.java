...
public class FAERIECtxtModelInstView extends VertexView {

  public static FAERIECtxtModelInstRenderer renderer = new FAERIECtxtModelInstRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public FAERIECtxtModelInstView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.FAERIECtxtModelInst ent=(ingenias.editor.entities.FAERIECtxtModelInst)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(FAERIECtxtModelInst ent) {
