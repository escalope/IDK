...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GTCreatesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTCreates",
	index,"/ingenias/editor/rendererxml/GTCreatesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTCreates",
	index,"/ingenias/editor/rendererxml/GTCreatesLABELPanel.xml");
 ...
 public static void setEntity(GTCreates ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTCreates",ent.getPrefs().getView());
