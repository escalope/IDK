...
public class ValidatesView extends NAryView {

static ValidatesRenderer renderer1 = new ValidatesRenderer();

  // Constructor.
  public ValidatesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
          ingenias.editor.entities.Validates ent=(ingenias.editor.entities.Validates)((DefaultGraphCell)this.getCell()).getUserObject();
