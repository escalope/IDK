...
public class AMIContextView extends VertexView {

  public static AMIContextRenderer renderer = new AMIContextRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public AMIContextView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.AMIContext ent=(ingenias.editor.entities.AMIContext)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(AMIContext ent) {
