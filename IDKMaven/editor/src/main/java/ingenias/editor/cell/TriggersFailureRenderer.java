...
public class TriggersFailureRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("TriggersFailure",
	index,"/rendererxml/TriggersFailureNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("TriggersFailure",
	index,"/rendererxml/TriggersFailureINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("TriggersFailure",
	index,"/rendererxml/TriggersFailureLABELPanel.xml");
     ...
     */
     public TriggersFailureRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("TriggersFailure",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.TriggersFailure ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("TriggersFailure",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("TriggersFailure",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("TriggersFailure",c);
	}
