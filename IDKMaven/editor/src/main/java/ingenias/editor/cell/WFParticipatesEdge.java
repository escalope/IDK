...
public class WFParticipatesEdge extends NAryEdge {

  // Constructor with data content
  public WFParticipatesEdge(ingenias.editor.entities.WFParticipates userObject) {
    super(userObject);
    
     this.addRole("WFParticipatessource");
     this.setArity("WFParticipatessource",true,1);
     this.setArity("WFParticipatessource",false,1);
     
this.addClass("WFParticipatessource","ingenias.editor.entities.Agent");
     
this.addClass("WFParticipatessource","ingenias.editor.entities.AutonomousEntityQuery");
     
this.addClass("WFParticipatessource","ingenias.editor.entities.Role");
     
    
     this.addRole("WFParticipatestarget");
     this.setArity("WFParticipatestarget",true,1);
     this.setArity("WFParticipatestarget",false,2147483647);
     
this.addClass("WFParticipatestarget","ingenias.editor.entities.Workflow");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof WFParticipatesEdge)))
      return false;

    // n-edge to be considered.
    WFParticipatesEdge edge = new WFParticipatesEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof WFParticipatesEdge)
      edge = (WFParticipatesEdge) selectedEdge;
