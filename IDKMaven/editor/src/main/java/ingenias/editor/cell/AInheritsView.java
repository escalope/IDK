...
public class AInheritsView extends NAryView {

static AInheritsRenderer renderer1 = new AInheritsRenderer();
 public static AInheritsRenderer renderer = new AInheritsRenderer();
  // Constructor.
  public AInheritsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AInherits ent=(ingenias.editor.entities.AInherits)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AInherits ent) {
