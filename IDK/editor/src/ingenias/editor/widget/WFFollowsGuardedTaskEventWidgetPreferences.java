...
public class WFFollowsGuardedTaskEventWidgetPreferences extends EntityWidgetPreferences {
  ...
  public WFFollowsGuardedTaskEventWidgetPreferences() {
  super();
  String[] preferredOrder={"Label","Condition","ActionToExecute","OccurringEvent",""};
  this.setPreferredOrder(preferredOrder);
  Vector result=null;
  
   preferredWidget.put("Condition",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("Condition",result);
