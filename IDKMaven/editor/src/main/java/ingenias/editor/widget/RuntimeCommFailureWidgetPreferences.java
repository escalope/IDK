...
public class RuntimeCommFailureWidgetPreferences extends RuntimeEventWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public RuntimeCommFailureWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("FailureType",ingenias.editor.widget.CustomJComboBox.class);
   result=new Vector();
   
   result.add("AgentNotFound");
   
   result.add("TimeOut");
   
   result.add("Other");
   
   defaultValues.put("FailureType",result);
  
   preferredWidget.put("Message",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("Message",result);
  
   preferredWidget.put("Stage",ingenias.editor.widget.CustomJComboBox.class);
   result=new Vector();
   ...
   defaultValues.put("Stage",result);
