...
public class StateGoalWidgetPreferences extends GoalWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public StateGoalWidgetPreferences() {
  super();
  String[] preferredOrder={"id","State","LinkedGoal","Description",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("State",ingenias.editor.widget.CustomJComboBox.class);
   result=new Vector();
