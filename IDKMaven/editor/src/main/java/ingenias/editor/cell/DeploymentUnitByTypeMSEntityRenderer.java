...
public class DeploymentUnitByTypeMSEntityRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("DeploymentUnitByTypeMSEntity",
	index,"/rendererxml/DeploymentUnitByTypeMSEntityUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("DeploymentUnitByTypeMSEntity",
	index,"/rendererxml/DeploymentUnitByTypeMSEntityINGENIASPanel.xml");
     ...
     */
    public DeploymentUnitByTypeMSEntityRenderer() {
    }
    
      public JComponent getConcreteSubComponent(String fieldname, Entity ent, Map map) {
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("DeploymentUnitByTypeMSEntity",ent.getPrefs(map).getView());
  ...
  public static void setEntity(DeploymentUnitByTypeMSEntity ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("DeploymentUnitByTypeMSEntity",ent.getPrefs(attributes).getView());
  current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("DeploymentUnitByTypeMSEntity",
