...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFContainsTaskNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFContainsTask",
	index,"/ingenias/editor/rendererxml/WFContainsTaskINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFContainsTask",
	index,"/ingenias/editor/rendererxml/WFContainsTaskLABELPanel.xml");
 ...
 public static void setEntity(WFContainsTask ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFContainsTask",ent.getPrefs().getView());
