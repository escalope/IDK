...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/rendererxml/WFResponsibleNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFResponsible",
	index,"/rendererxml/WFResponsibleINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFResponsible",
	index,"/rendererxml/WFResponsibleLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.WFResponsible ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFResponsible",ent.getPrefs(attributes).getView());
