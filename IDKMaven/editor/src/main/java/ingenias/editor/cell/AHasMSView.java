...
public class AHasMSView extends NAryView {

static AHasMSRenderer renderer1 = new AHasMSRenderer();
 public static AHasMSRenderer renderer = new AHasMSRenderer();
  // Constructor.
  public AHasMSView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AHasMS ent=(ingenias.editor.entities.AHasMS)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AHasMS ent) {
