...
public class EResourceBelongsToRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("EResourceBelongsTo",
	index,"/rendererxml/EResourceBelongsToNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("EResourceBelongsTo",
	index,"/rendererxml/EResourceBelongsToINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("EResourceBelongsTo",
	index,"/rendererxml/EResourceBelongsToLABELPanel.xml");
     ...
     */
     public EResourceBelongsToRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("EResourceBelongsTo",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.EResourceBelongsTo ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("EResourceBelongsTo",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("EResourceBelongsTo",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("EResourceBelongsTo",c);
	}
