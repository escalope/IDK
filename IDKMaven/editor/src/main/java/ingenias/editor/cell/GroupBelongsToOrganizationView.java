...
public class GroupBelongsToOrganizationView extends NAryView {

static GroupBelongsToOrganizationRenderer renderer1 = new GroupBelongsToOrganizationRenderer();
 public static GroupBelongsToOrganizationRenderer renderer = new GroupBelongsToOrganizationRenderer();
  // Constructor.
  public GroupBelongsToOrganizationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GroupBelongsToOrganization ent=(ingenias.editor.entities.GroupBelongsToOrganization)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GroupBelongsToOrganization ent) {
