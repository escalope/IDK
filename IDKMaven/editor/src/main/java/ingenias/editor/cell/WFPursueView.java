...
public class WFPursueView extends NAryView {

static WFPursueRenderer renderer1 = new WFPursueRenderer();
 public static WFPursueRenderer renderer = new WFPursueRenderer();
  // Constructor.
  public WFPursueView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFPursue ent=(ingenias.editor.entities.WFPursue)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFPursue ent) {
