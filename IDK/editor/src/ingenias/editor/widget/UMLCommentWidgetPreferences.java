...
public class UMLCommentWidgetPreferences extends UMLObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public UMLCommentWidgetPreferences() {
  super();
  String[] preferredOrder={"Text",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("Text",ingenias.editor.widget.ScrolledTArea.class);
   result=new Vector();
   
   defaultValues.put("Text",result);
