...
public class Ticket_data extends ingenias.editor.entities.RuntimeFact{
  ...
  public Ticket_data (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="Ticket_data";
  }
  ...
  public String getParentType(){
   ...
   public void setseat(java.lang.String value){
     seat=value;   
   };
