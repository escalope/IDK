...
public class SimulationPackageView extends VertexView {

  public static SimulationPackageRenderer renderer = new SimulationPackageRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public SimulationPackageView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.SimulationPackage ent=(ingenias.editor.entities.SimulationPackage)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(SimulationPackage ent) {
