...
public class CtxtNotifiesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("CtxtNotifies",
	index,"/rendererxml/CtxtNotifiesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("CtxtNotifies",
	index,"/rendererxml/CtxtNotifiesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("CtxtNotifies",
	index,"/rendererxml/CtxtNotifiesLABELPanel.xml");
     ...
     */
     public CtxtNotifiesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("CtxtNotifies",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.CtxtNotifies ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("CtxtNotifies",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("CtxtNotifies",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("CtxtNotifies",c);
	}
