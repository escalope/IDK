...
public class OrganizationNetworkView extends VertexView {

  public static OrganizationNetworkRenderer renderer = new OrganizationNetworkRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public OrganizationNetworkView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.OrganizationNetwork ent=(ingenias.editor.entities.OrganizationNetwork)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(OrganizationNetwork ent) {
