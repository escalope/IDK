...
public class ObjectSlotWidgetPreferences extends SlotWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public ObjectSlotWidgetPreferences() {
  super();
  String[] preferredOrder={"Name","Type","Description",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("ObjectValue",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("ObjectValue",result);
