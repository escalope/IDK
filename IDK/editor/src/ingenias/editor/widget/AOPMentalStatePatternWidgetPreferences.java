...
public class AOPMentalStatePatternWidgetPreferences extends SymbolicMentalStatePatternWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public AOPMentalStatePatternWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","AOPExpression",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("AOPExpression",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("AOPExpression",result);
