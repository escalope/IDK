...
public class AContainsMERenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AContainsME",
	index,"/rendererxml/AContainsMENOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AContainsME",
	index,"/rendererxml/AContainsMEINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AContainsME",
	index,"/rendererxml/AContainsMELABELPanel.xml");
     ...
     */
     public AContainsMERenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AContainsME",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AContainsME ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AContainsME",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AContainsME",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AContainsME",c);
	}
