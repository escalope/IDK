...
public class EResourceBelongsToEdge extends NAryEdge {

  // Constructor with data content
  public EResourceBelongsToEdge(ingenias.editor.entities.EResourceBelongsTo userObject) {
    super(userObject);
    
     this.addRole("EResourceBelongsTosource");
     this.setArity("EResourceBelongsTosource",true,1);
     this.setArity("EResourceBelongsTosource",false,1);
     
this.addClass("EResourceBelongsTosource","ingenias.editor.entities.OrganizationGroup");
     
this.addClass("EResourceBelongsTosource","ingenias.editor.entities.Agent");
     
this.addClass("EResourceBelongsTosource","ingenias.editor.entities.Role");
     
    
     this.addRole("EResourceBelongsTotarget");
     this.setArity("EResourceBelongsTotarget",true,1);
     this.setArity("EResourceBelongsTotarget",false,1);
     
this.addClass("EResourceBelongsTotarget","ingenias.editor.entities.Resource");
     
this.addClass("EResourceBelongsTotarget","ingenias.editor.entities.Application");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof EResourceBelongsToEdge)))
      return false;

    // n-edge to be considered.
    EResourceBelongsToEdge edge = new EResourceBelongsToEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof EResourceBelongsToEdge)
      edge = (EResourceBelongsToEdge) selectedEdge;
