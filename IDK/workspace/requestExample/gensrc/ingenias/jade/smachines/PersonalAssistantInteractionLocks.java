...
*/
			...
			public class PersonalAssistantInteractionLocks implements CustomLocks {
			
			public PersonalAssistantInteractionLocks(){};
                  ...
                  if (interaction.equals("RFP")){
                    RequesterRFPDefaultCommControl.addDefaultLocks(lw);
                  }
