...
public class GTDecomposesANDRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("GTDecomposesAND",
	index,"/rendererxml/GTDecomposesANDNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTDecomposesAND",
	index,"/rendererxml/GTDecomposesANDINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTDecomposesAND",
	index,"/rendererxml/GTDecomposesANDLABELPanel.xml");
     ...
     */
     public GTDecomposesANDRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("GTDecomposesAND",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.GTDecomposesAND ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTDecomposesAND",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("GTDecomposesAND",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("GTDecomposesAND",c);
	}
