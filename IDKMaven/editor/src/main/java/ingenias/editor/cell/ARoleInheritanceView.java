...
public class ARoleInheritanceView extends NAryView {

static ARoleInheritanceRenderer renderer1 = new ARoleInheritanceRenderer();
 public static ARoleInheritanceRenderer renderer = new ARoleInheritanceRenderer();
  // Constructor.
  public ARoleInheritanceView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.ARoleInheritance ent=(ingenias.editor.entities.ARoleInheritance)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.ARoleInheritance ent) {
