...
*/
			...
			public class SourcesManagerInteractionLocks implements CustomLocks {
			
			public SourcesManagerInteractionLocks(){};
			
			        public void addInteractionLocks(String interaction, LocksWriter lw, String role){
                                    
                   if (interaction.equals("RequestToAddSource") && role.equals("SourcesManagerRole") ){
                            SourcesManagerRoleRequestToAddSourceDefaultCommControl.addDefaultLocks(lw);
                   }
