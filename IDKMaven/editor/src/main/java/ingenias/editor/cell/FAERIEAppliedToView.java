...
public class FAERIEAppliedToView extends NAryView {

static FAERIEAppliedToRenderer renderer1 = new FAERIEAppliedToRenderer();
 public static FAERIEAppliedToRenderer renderer = new FAERIEAppliedToRenderer();
  // Constructor.
  public FAERIEAppliedToView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.FAERIEAppliedTo ent=(ingenias.editor.entities.FAERIEAppliedTo)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.FAERIEAppliedTo ent) {
