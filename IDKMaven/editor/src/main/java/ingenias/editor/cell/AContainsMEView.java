...
public class AContainsMEView extends NAryView {

static AContainsMERenderer renderer1 = new AContainsMERenderer();
 public static AContainsMERenderer renderer = new AContainsMERenderer();
  // Constructor.
  public AContainsMEView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AContainsME ent=(ingenias.editor.entities.AContainsME)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AContainsME ent) {
