...
public class UMLRealizesView extends NAryView {

static UMLRealizesRenderer renderer1 = new UMLRealizesRenderer();
 public static UMLRealizesRenderer renderer = new UMLRealizesRenderer();
  // Constructor.
  public UMLRealizesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.UMLRealizes ent=(ingenias.editor.entities.UMLRealizes)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.UMLRealizes ent) {
