...
public class FrameFactView extends VertexView {

  public static FrameFactRenderer renderer = new FrameFactRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public FrameFactView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.FrameFact ent=(ingenias.editor.entities.FrameFact)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(FrameFact ent) {
