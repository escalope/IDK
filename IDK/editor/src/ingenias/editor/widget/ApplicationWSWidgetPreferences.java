...
public class ApplicationWSWidgetPreferences extends ApplicationWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public ApplicationWSWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","UsesServiceRole",""};
