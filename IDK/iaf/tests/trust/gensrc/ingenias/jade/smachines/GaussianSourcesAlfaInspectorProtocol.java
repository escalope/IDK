...
public class GaussianSourcesAlfaInspectorProtocol implements AgentProtocols{

public GaussianSourcesAlfaInspectorProtocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("AlphaQualityInspectionRequest") && conv.getPlayedRole().equals("SourcesAlphaQualityInspectorRole")){
		   	DefaultCommControl dcc=new SourcesAlphaQualityInspectorRoleAlphaQualityInspectionRequestDefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new SourcesAlphaQualityInspectorRoleAlphaQualityInspectionRequestStateBehavior(agentName,
				msr, msu,
				conv,                           		
				conv.getPlayedRole(),
			   	actors,
