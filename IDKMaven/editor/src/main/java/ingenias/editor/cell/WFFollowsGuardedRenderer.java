...
public class WFFollowsGuardedRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFFollowsGuarded",
	index,"/rendererxml/WFFollowsGuardedNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFFollowsGuarded",
	index,"/rendererxml/WFFollowsGuardedINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFFollowsGuarded",
	index,"/rendererxml/WFFollowsGuardedLABELPanel.xml");
     ...
     */
     public WFFollowsGuardedRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFFollowsGuarded",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.WFFollowsGuarded ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFFollowsGuarded",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFFollowsGuarded",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFFollowsGuarded",c);
	}
