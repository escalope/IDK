...
public class AUMLDiagramChangesManager
  ...
  public static void portsToFront(ingenias.editor.Model m){
  ...
  public void graphChanged(org.jgraph.event.GraphModelEvent gme) {
    ...
    if (enabled &&
      ...
      try {
        workingObject = "hola";
         this.portsToFront((ingenias.editor.Model)gme.getSource());
        ...
        if (!duringChange) {
          ...
          ( (ingenias.editor.Model) gme.getSource()).fireChange();
