...
public class WFTestInitialStateView extends VertexView {

  public static WFTestInitialStateRenderer renderer = new WFTestInitialStateRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public WFTestInitialStateView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.WFTestInitialState ent=(ingenias.editor.entities.WFTestInitialState)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(WFTestInitialState ent) {
