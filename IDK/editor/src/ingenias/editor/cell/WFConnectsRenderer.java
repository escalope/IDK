...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFConnectsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFConnects",
	index,"/ingenias/editor/rendererxml/WFConnectsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFConnects",
	index,"/ingenias/editor/rendererxml/WFConnectsLABELPanel.xml");
 ...
 public static void setEntity(WFConnects ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFConnects",ent.getPrefs().getView());
