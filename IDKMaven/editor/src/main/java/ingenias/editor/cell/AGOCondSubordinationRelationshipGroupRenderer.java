...
public class AGOCondSubordinationRelationshipGroupRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGOCondSubordinationRelationshipGroup",
	index,"/rendererxml/AGOCondSubordinationRelationshipGroupNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOCondSubordinationRelationshipGroup",
	index,"/rendererxml/AGOCondSubordinationRelationshipGroupINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOCondSubordinationRelationshipGroup",
	index,"/rendererxml/AGOCondSubordinationRelationshipGroupLABELPanel.xml");
     ...
     */
     public AGOCondSubordinationRelationshipGroupRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGOCondSubordinationRelationshipGroup",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGOCondSubordinationRelationshipGroup ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOCondSubordinationRelationshipGroup",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGOCondSubordinationRelationshipGroup",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGOCondSubordinationRelationshipGroup",c);
	}
