...
public class AGOSubordinationRelationshipMemberEdge extends NAryEdge {

  // Constructor with data content
  public AGOSubordinationRelationshipMemberEdge(ingenias.editor.entities.AGOSubordinationRelationshipMember userObject) {
    super(userObject);
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof AGOSubordinationRelationshipMemberEdge)))
      return false;

    // n-edge to be considered.
    AGOSubordinationRelationshipMemberEdge edge = new AGOSubordinationRelationshipMemberEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof AGOSubordinationRelationshipMemberEdge)
      edge = (AGOSubordinationRelationshipMemberEdge) selectedEdge;
