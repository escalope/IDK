...
public class InteractionRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/InteractionUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Interaction",
	index,"/ingenias/editor/rendererxml/InteractionINGENIASPanel.xml");
  ...
  public static void setEntity(Interaction ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Interaction",ent.getPrefs().getView());
