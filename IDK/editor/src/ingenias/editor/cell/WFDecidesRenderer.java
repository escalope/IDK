...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFDecidesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFDecides",
	index,"/ingenias/editor/rendererxml/WFDecidesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFDecides",
	index,"/ingenias/editor/rendererxml/WFDecidesLABELPanel.xml");
 ...
 public static void setEntity(WFDecides ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFDecides",ent.getPrefs().getView());
