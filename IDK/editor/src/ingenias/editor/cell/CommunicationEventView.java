...
public class CommunicationEventView extends VertexView {

  public static CommunicationEventRenderer renderer = new CommunicationEventRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public CommunicationEventView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.CommunicationEvent ent=(ingenias.editor.entities.CommunicationEvent)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(CommunicationEvent ent) {
