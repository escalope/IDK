...
public class GTCreatesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("GTCreates",
	index,"/rendererxml/GTCreatesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTCreates",
	index,"/rendererxml/GTCreatesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTCreates",
	index,"/rendererxml/GTCreatesLABELPanel.xml");
     ...
     */
     public GTCreatesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("GTCreates",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.GTCreates ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTCreates",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("GTCreates",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("GTCreates",c);
	}
