...
public class GTAffectsEdge extends NAryEdge {

  // Constructor with data content
  public GTAffectsEdge(ingenias.editor.entities.GTAffects userObject) {
    super(userObject);
    
     this.addRole("GTAffectssource");
     this.setArity("GTAffectssource",true,1);
     this.setArity("GTAffectssource",false,1);
     
this.addClass("GTAffectssource","ingenias.editor.entities.Task");
     
this.addClass("GTAffectssource","ingenias.editor.entities.Workflow");
     
this.addClass("GTAffectssource","ingenias.editor.entities.Plan");
     
    
     this.addRole("GTAffectstarget");
     this.setArity("GTAffectstarget",true,1);
     this.setArity("GTAffectstarget",false,2147483647);
     
this.addClass("GTAffectstarget","ingenias.editor.entities.MentalEntity");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof GTAffectsEdge)))
      return false;

    // n-edge to be considered.
    GTAffectsEdge edge = new GTAffectsEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof GTAffectsEdge)
      edge = (GTAffectsEdge) selectedEdge;
