...
public class AUMLUseProtocolWidgetPreferences extends EntityWidgetPreferences {
  ...
  public AUMLUseProtocolWidgetPreferences() {
  super();
  String[] preferredOrder={"Label","Protocol",""};
