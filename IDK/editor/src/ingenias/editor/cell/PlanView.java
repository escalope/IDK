...
public class PlanView extends VertexView {

  public static PlanRenderer renderer = new PlanRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public PlanView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Plan ent=(ingenias.editor.entities.Plan)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Plan ent) {
