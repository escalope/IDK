...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/UMLAnnotatedElementNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UMLAnnotatedElement",
	index,"/ingenias/editor/rendererxml/UMLAnnotatedElementINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UMLAnnotatedElement",
	index,"/ingenias/editor/rendererxml/UMLAnnotatedElementLABELPanel.xml");
