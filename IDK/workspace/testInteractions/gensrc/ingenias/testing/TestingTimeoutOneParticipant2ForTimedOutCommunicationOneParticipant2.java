...
public class TestingTimeoutOneParticipant2ForTimedOutCommunicationOneParticipant2 extends TimedOutCommunicationOneParticipant2{
...

{
	...
	{ FailOneParticipan2 ment=new FailOneParticipan2();
	   ...
	   agcATimeOut_0.putO2AObject(ment, false);
        ...
        new Thread(){
	      ...
	      MainInteractionManager.getInstance().setTitle("node DeploymentForOneParticipant2Timeout");
