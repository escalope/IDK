...
public class FAERIESrcEntityRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("FAERIESrcEntity",
	index,"/rendererxml/FAERIESrcEntityNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("FAERIESrcEntity",
	index,"/rendererxml/FAERIESrcEntityINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("FAERIESrcEntity",
	index,"/rendererxml/FAERIESrcEntityLABELPanel.xml");
     ...
     */
     public FAERIESrcEntityRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("FAERIESrcEntity",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.FAERIESrcEntity ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("FAERIESrcEntity",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("FAERIESrcEntity",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("FAERIESrcEntity",c);
	}
