...
public class StateGoalView extends VertexView {

  public static StateGoalRenderer renderer = new StateGoalRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public StateGoalView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.StateGoal ent=(ingenias.editor.entities.StateGoal)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(StateGoal ent) {
