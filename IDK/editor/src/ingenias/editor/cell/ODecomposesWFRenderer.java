...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/ODecomposesWFNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ODecomposesWF",
	index,"/ingenias/editor/rendererxml/ODecomposesWFINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ODecomposesWF",
	index,"/ingenias/editor/rendererxml/ODecomposesWFLABELPanel.xml");
 ...
 public static void setEntity(ODecomposesWF ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ODecomposesWF",ent.getPrefs().getView());
