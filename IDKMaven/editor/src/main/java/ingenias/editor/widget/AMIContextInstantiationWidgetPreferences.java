...
public class AMIContextInstantiationWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public AMIContextInstantiationWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Model",""};
