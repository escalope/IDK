...
public class AGOCondSubordinationRelationshipOrgView extends NAryView {

static AGOCondSubordinationRelationshipOrgRenderer renderer1 = new AGOCondSubordinationRelationshipOrgRenderer();
 public static AGOCondSubordinationRelationshipOrgRenderer renderer = new AGOCondSubordinationRelationshipOrgRenderer();
  // Constructor.
  public AGOCondSubordinationRelationshipOrgView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGOCondSubordinationRelationshipOrg ent=(ingenias.editor.entities.AGOCondSubordinationRelationshipOrg)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGOCondSubordinationRelationshipOrg ent) {
