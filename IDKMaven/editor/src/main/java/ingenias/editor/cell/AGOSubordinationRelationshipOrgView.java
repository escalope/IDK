...
public class AGOSubordinationRelationshipOrgView extends NAryView {

static AGOSubordinationRelationshipOrgRenderer renderer1 = new AGOSubordinationRelationshipOrgRenderer();
 public static AGOSubordinationRelationshipOrgRenderer renderer = new AGOSubordinationRelationshipOrgRenderer();
  // Constructor.
  public AGOSubordinationRelationshipOrgView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGOSubordinationRelationshipOrg ent=(ingenias.editor.entities.AGOSubordinationRelationshipOrg)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGOSubordinationRelationshipOrg ent) {
