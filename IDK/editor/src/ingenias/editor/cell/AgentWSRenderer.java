...
public class AgentWSRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/AgentWSUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AgentWS",
	index,"/ingenias/editor/rendererxml/AgentWSINGENIASPanel.xml");
  ...
  public static void setEntity(AgentWS ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AgentWS",ent.getPrefs().getView());
