...
public class ProtocolView extends VertexView {

  public static ProtocolRenderer renderer = new ProtocolRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ProtocolView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Protocol ent=(ingenias.editor.entities.Protocol)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Protocol ent) {
