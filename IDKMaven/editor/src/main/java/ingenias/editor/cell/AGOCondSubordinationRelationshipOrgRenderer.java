...
public class AGOCondSubordinationRelationshipOrgRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGOCondSubordinationRelationshipOrg",
	index,"/rendererxml/AGOCondSubordinationRelationshipOrgNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOCondSubordinationRelationshipOrg",
	index,"/rendererxml/AGOCondSubordinationRelationshipOrgINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOCondSubordinationRelationshipOrg",
	index,"/rendererxml/AGOCondSubordinationRelationshipOrgLABELPanel.xml");
     ...
     */
     public AGOCondSubordinationRelationshipOrgRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGOCondSubordinationRelationshipOrg",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGOCondSubordinationRelationshipOrg ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOCondSubordinationRelationshipOrg",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGOCondSubordinationRelationshipOrg",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGOCondSubordinationRelationshipOrg",c);
	}
