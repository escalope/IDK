...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GTDependsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTDepends",
	index,"/ingenias/editor/rendererxml/GTDependsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTDepends",
	index,"/ingenias/editor/rendererxml/GTDependsLABELPanel.xml");
 ...
 public static void setEntity(GTDepends ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTDepends",ent.getPrefs().getView());
