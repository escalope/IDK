...
public Agent1Protocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("Interaction0") && conv.getPlayedRole().equals("Role1")){
		   	DefaultCommControl dcc=new Role1Interaction0DefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new Role1Interaction0StateBehavior(agentName,
				msr, msu,
				conv,                           		
				conv.getPlayedRole(),
			   	actors,
