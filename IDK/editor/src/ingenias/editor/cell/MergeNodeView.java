...
public class MergeNodeView extends VertexView {

  public static MergeNodeRenderer renderer = new MergeNodeRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public MergeNodeView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.MergeNode ent=(ingenias.editor.entities.MergeNode)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(MergeNode ent) {
