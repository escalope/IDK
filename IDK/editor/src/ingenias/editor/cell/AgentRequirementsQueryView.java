...
public class AgentRequirementsQueryView extends VertexView {

  public static AgentRequirementsQueryRenderer renderer = new AgentRequirementsQueryRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public AgentRequirementsQueryView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.AgentRequirementsQuery ent=(ingenias.editor.entities.AgentRequirementsQuery)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(AgentRequirementsQuery ent) {
