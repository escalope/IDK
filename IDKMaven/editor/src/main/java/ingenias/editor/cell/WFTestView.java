...
public class WFTestView extends VertexView {

  public static WFTestRenderer renderer = new WFTestRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public WFTestView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.WFTest ent=(ingenias.editor.entities.WFTest)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(WFTest ent) {
