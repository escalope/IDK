...
public class SourceToProcess extends ingenias.editor.entities.RuntimeFact{
  ...
  public SourceToProcess (String id){
   super(id);
   this.getPrefs().setView(ViewType.UML);
   this.type="SourceToProcess";
  }
  

  public SourceToProcess (){
