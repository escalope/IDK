...
public class JoinNodeView extends VertexView {

  public static JoinNodeRenderer renderer = new JoinNodeRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public JoinNodeView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.JoinNode ent=(ingenias.editor.entities.JoinNode)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(JoinNode ent) {
