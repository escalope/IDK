...
public class UMLSendsMessageWidgetPreferences extends EntityWidgetPreferences {
  ...
  public UMLSendsMessageWidgetPreferences() {
  super();
  String[] preferredOrder={"Order","Message",""};
  this.setPreferredOrder(preferredOrder);
  Vector result=null;
  
   preferredWidget.put("Order",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("Order",result);
  
   preferredWidget.put("Message",ingenias.editor.widget.ScrolledTArea.class);
   result=new Vector();
