...
public class CompromiseRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("Compromise",
	index,"/rendererxml/CompromiseUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Compromise",
	index,"/rendererxml/CompromiseINGENIASPanel.xml");
    ...
    public CompromiseRenderer() {
	  ...
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("Compromise",ent.getPrefs(map).getView());
  ...
  public static void setEntity(Compromise ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Compromise",ent.getPrefs(attributes).getView());
  current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("Compromise",
