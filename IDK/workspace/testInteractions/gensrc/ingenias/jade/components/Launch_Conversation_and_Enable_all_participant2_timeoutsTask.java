...
public class Launch_Conversation_and_Enable_all_participant2_timeoutsTask extends Task{

 public Launch_Conversation_and_Enable_all_participant2_timeoutsTask(String id){
  super(id,"Launch_Conversation_and_Enable_all_participant2_timeouts");
 }
 ...
 public void execute() throws TaskException{
        ...
        FailAllParticipant2  eiFailAllParticipant2=(FailAllParticipant2)this.getFirstInputOfType("FailAllParticipant2");             
		...
		eaTimeOut_generator.requestTaskFailure("GeneratingAnswerWithinMultipleDeliver","C_3");
