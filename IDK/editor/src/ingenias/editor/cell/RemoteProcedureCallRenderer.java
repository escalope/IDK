...
public class RemoteProcedureCallRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/RemoteProcedureCallUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("RemoteProcedureCall",
	index,"/ingenias/editor/rendererxml/RemoteProcedureCallINGENIASPanel.xml");
  ...
  public static void setEntity(RemoteProcedureCall ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("RemoteProcedureCall",ent.getPrefs().getView());
