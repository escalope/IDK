...
public class InteractionModelModelJGraph extends ModelJGraph {
 ...
 entities.add("UMLComment");
    ...
    if (nAryEdgesNum <= 1 && edgesNum == 0) {
      ...
      if (relacion.equalsIgnoreCase("IInitiates")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new IInitiatesEdge(new IInitiates(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("IColaborates")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new IColaboratesEdge(new IColaborates(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("UIInitiates")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new UIInitiatesEdge(new UIInitiates(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("UIColaborates")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new UIColaboratesEdge(new UIColaborates(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("UISelection")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new UISelectionEdge(new UISelection(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("IPursues")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new IPursuesEdge(new IPursues(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("IHasSpec")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new IHasSpecEdge(new IHasSpec(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("UIPrecedes")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new UIPrecedesEdge(new UIPrecedes(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("UMLSendsMessage")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new UMLSendsMessageEdge(new UMLSendsMessage(Editor.getNewId()));
        }
      }
  ...
  public DefaultGraphCell createCell(String entity) throws InvalidEntity{
    ...
    IUIterate nentity=getOM().createIUIterate( Editor.getNewId("IUIterate"));
      DefaultGraphCell vertex = new
    ...
    IUConcurrence nentity=getOM().createIUConcurrence( Editor.getNewId("IUConcurrence"));
      DefaultGraphCell vertex = new
    ...
    InteractionUnit nentity=getOM().createInteractionUnit( Editor.getNewId("InteractionUnit"));
      DefaultGraphCell vertex = new
    ...
    UMLSpecification nentity=getOM().createUMLSpecification( Editor.getNewId("UMLSpecification"));
      DefaultGraphCell vertex = new
    ...
    AUMLSpecification nentity=getOM().createAUMLSpecification( Editor.getNewId("AUMLSpecification"));
      DefaultGraphCell vertex = new
    ...
    GRASIASpecification nentity=getOM().createGRASIASpecification( Editor.getNewId("GRASIASpecification"));
      DefaultGraphCell vertex = new
...
JOptionPane.showMessageDialog(IDE.ide,
 ...
 public synchronized JGraph cloneJGraph(){
		 ...
		 InteractionModelModelJGraph jg=new  InteractionModelModelJGraph(
				(InteractionModelDataEntity) this.mde,this.name,IDEAbs.ide.ids.om,
