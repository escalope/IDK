...
public class ParticipatesInUseCaseRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("ParticipatesInUseCase",
	index,"/rendererxml/ParticipatesInUseCaseNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ParticipatesInUseCase",
	index,"/rendererxml/ParticipatesInUseCaseINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ParticipatesInUseCase",
	index,"/rendererxml/ParticipatesInUseCaseLABELPanel.xml");
     ...
     */
     public ParticipatesInUseCaseRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("ParticipatesInUseCase",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.ParticipatesInUseCase ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ParticipatesInUseCase",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("ParticipatesInUseCase",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("ParticipatesInUseCase",c);
	}
