...
public class ColAgent1Protocol implements AgentProtocols{

public ColAgent1Protocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("SampleInteraction") && conv.getPlayedRole().equals("Colaborator")){
		   	DefaultCommControl dcc=new ColaboratorSampleInteractionDefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new ColaboratorSampleInteractionStateBehavior(agentName,
				msr, msu,
				conv,                           		
				conv.getPlayedRole(),
			   	actors,
