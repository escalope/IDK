...
public class AHasMSManagerView extends NAryView {

static AHasMSManagerRenderer renderer1 = new AHasMSManagerRenderer();
 public static AHasMSManagerRenderer renderer = new AHasMSManagerRenderer();
  // Constructor.
  public AHasMSManagerView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AHasMSManager ent=(ingenias.editor.entities.AHasMSManager)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AHasMSManager ent) {
