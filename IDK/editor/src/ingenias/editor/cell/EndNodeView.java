...
public class EndNodeView extends VertexView {
  ...
  public static EndNodeRenderer renderer = new EndNodeRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public EndNodeView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.EndNode ent=(ingenias.editor.entities.EndNode)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(EndNode ent) {
