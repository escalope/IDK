...
public class AGOClientServerRelationshipGroupRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGOClientServerRelationshipGroup",
	index,"/rendererxml/AGOClientServerRelationshipGroupNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOClientServerRelationshipGroup",
	index,"/rendererxml/AGOClientServerRelationshipGroupINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOClientServerRelationshipGroup",
	index,"/rendererxml/AGOClientServerRelationshipGroupLABELPanel.xml");
     ...
     */
     public AGOClientServerRelationshipGroupRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGOClientServerRelationshipGroup",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGOClientServerRelationshipGroup ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOClientServerRelationshipGroup",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGOClientServerRelationshipGroup",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGOClientServerRelationshipGroup",c);
	}
