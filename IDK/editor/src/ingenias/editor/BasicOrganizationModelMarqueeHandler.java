...
public class BasicOrganizationModelMarqueeHandler extends MarqueeHandler  implements java.io.Serializable {

	



        public BasicOrganizationModelMarqueeHandler(ModelJGraph graph){
	super(graph);
        }
