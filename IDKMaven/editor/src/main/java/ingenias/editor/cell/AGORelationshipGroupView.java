...
public class AGORelationshipGroupView extends NAryView {

static AGORelationshipGroupRenderer renderer1 = new AGORelationshipGroupRenderer();
 public static AGORelationshipGroupRenderer renderer = new AGORelationshipGroupRenderer();
  // Constructor.
  public AGORelationshipGroupView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGORelationshipGroup ent=(ingenias.editor.entities.AGORelationshipGroup)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGORelationshipGroup ent) {
