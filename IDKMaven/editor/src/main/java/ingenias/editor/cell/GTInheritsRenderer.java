...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("GTInherits",
	index,"/rendererxml/GTInheritsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTInherits",
	index,"/rendererxml/GTInheritsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTInherits",
	index,"/rendererxml/GTInheritsLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.GTInherits ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTInherits",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("GTInherits",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("GTInherits",c);
	}
