...
public class AGOInconditionalSubordinationRelationshipMemberRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGOInconditionalSubordinationRelationshipMember",
	index,"/rendererxml/AGOInconditionalSubordinationRelationshipMemberNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOInconditionalSubordinationRelationshipMember",
	index,"/rendererxml/AGOInconditionalSubordinationRelationshipMemberINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOInconditionalSubordinationRelationshipMember",
	index,"/rendererxml/AGOInconditionalSubordinationRelationshipMemberLABELPanel.xml");
     ...
     */
     public AGOInconditionalSubordinationRelationshipMemberRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGOInconditionalSubordinationRelationshipMember",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGOInconditionalSubordinationRelationshipMember ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOInconditionalSubordinationRelationshipMember",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGOInconditionalSubordinationRelationshipMember",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGOInconditionalSubordinationRelationshipMember",c);
	}
