...
public class MentalEntityInstanceAccessView extends VertexView {

  public static MentalEntityInstanceAccessRenderer renderer = new MentalEntityInstanceAccessRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public MentalEntityInstanceAccessView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.MentalEntityInstanceAccess ent=(ingenias.editor.entities.MentalEntityInstanceAccess)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(MentalEntityInstanceAccess ent) {
