...
public class AGOClientServerRelationshipOrgRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGOClientServerRelationshipOrg",
	index,"/rendererxml/AGOClientServerRelationshipOrgNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOClientServerRelationshipOrg",
	index,"/rendererxml/AGOClientServerRelationshipOrgINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOClientServerRelationshipOrg",
	index,"/rendererxml/AGOClientServerRelationshipOrgLABELPanel.xml");
     ...
     */
     public AGOClientServerRelationshipOrgRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGOClientServerRelationshipOrg",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGOClientServerRelationshipOrg ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOClientServerRelationshipOrg",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGOClientServerRelationshipOrg",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGOClientServerRelationshipOrg",c);
	}
