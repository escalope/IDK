...
public class AUMLComponentRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/AUMLComponentUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLComponent",
	index,"/ingenias/editor/rendererxml/AUMLComponentINGENIASPanel.xml");
  ...
  public static void setEntity(AUMLComponent ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLComponent",ent.getPrefs().getView());
