...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipGroup",
	index,"/rendererxml/AGOSubordinationRelationshipGroupNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipGroup",
	index,"/rendererxml/AGOSubordinationRelationshipGroupINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOSubordinationRelationshipGroup",
	index,"/rendererxml/AGOSubordinationRelationshipGroupLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.AGOSubordinationRelationshipGroup ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOSubordinationRelationshipGroup",ent.getPrefs(attributes).getView());
