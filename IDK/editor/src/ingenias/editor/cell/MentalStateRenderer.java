...
public class MentalStateRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/MentalStateUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("MentalState",
	index,"/ingenias/editor/rendererxml/MentalStateINGENIASPanel.xml");
  ...
  public static void setEntity(MentalState ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("MentalState",ent.getPrefs().getView());
