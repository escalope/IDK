...
public class DeploymentUnitByTypeWithInitMSView extends VertexView {
  ...
  public DeploymentUnitByTypeWithInitMSView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.DeploymentUnitByTypeWithInitMS ent=(ingenias.editor.entities.DeploymentUnitByTypeWithInitMS)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(DeploymentUnitByTypeWithInitMS ent) {
