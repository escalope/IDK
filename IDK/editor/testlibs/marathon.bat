...
SET CLASSPATH=%DIST%;%DIST%marathon.jar;%DIST%marathon-python.jar;%DIST%marathon-ruby.jar;%DIST%marathon-runtime.jar
SET CLASSPATH=%CLASSPATH%;%DIST%Support/forms-1.2.1/forms-1.2.1.jar;%DIST%Support/jaccess-1.3/jaccess.jar;%DIST%Support/jedit-textArea.jar;%DIST%Support/jline-0.9.93.jar;%DIST%Support/junit3.8.2/junit.jar;%DIST%Support/looks-2.2.0/looks-2.2.0.jar;%DIST%Support/vldocking_2.1.5C.jar
