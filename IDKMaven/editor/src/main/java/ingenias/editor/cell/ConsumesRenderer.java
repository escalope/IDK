...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/rendererxml/ConsumesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Consumes",
	index,"/rendererxml/ConsumesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("Consumes",
	index,"/rendererxml/ConsumesLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.Consumes ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Consumes",ent.getPrefs(attributes).getView());
