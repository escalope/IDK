...
public class SlotWidgetPreferences extends INGENIASObjectWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public SlotWidgetPreferences() {
  super();
  String[] preferredOrder={"Name","Type","Description",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("Name",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("Name",result);
  
   preferredWidget.put("Type",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("Type",result);
  
   preferredWidget.put("Value",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("Value",result);
