...
public class DeploymentUnitByTypeMSEntityWidgetPreferences extends DeploymentUnitByTypeWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public DeploymentUnitByTypeMSEntityWidgetPreferences() {
  super();
