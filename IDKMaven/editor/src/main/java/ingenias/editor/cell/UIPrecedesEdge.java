...
public class UIPrecedesEdge extends NAryEdge {

  // Constructor with data content
  public UIPrecedesEdge(ingenias.editor.entities.UIPrecedes userObject) {
    super(userObject);
    
     this.addRole("UIPrecedessource");
     this.setArity("UIPrecedessource",true,1);
     this.setArity("UIPrecedessource",false,2147483647);
     
this.addClass("UIPrecedessource","ingenias.editor.entities.InteractionUnit");
     
this.addClass("UIPrecedessource","ingenias.editor.entities.Interaction");
     
    
     this.addRole("UIPrecedestarget");
     this.setArity("UIPrecedestarget",true,1);
     this.setArity("UIPrecedestarget",false,2147483647);
     
this.addClass("UIPrecedestarget","ingenias.editor.entities.InteractionUnit");
     
this.addClass("UIPrecedestarget","ingenias.editor.entities.Interaction");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof UIPrecedesEdge)))
      return false;

    // n-edge to be considered.
    UIPrecedesEdge edge = new UIPrecedesEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof UIPrecedesEdge)
      edge = (UIPrecedesEdge) selectedEdge;
