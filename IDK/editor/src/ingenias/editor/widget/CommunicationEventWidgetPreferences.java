...
public class CommunicationEventWidgetPreferences extends GeneralEventWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public CommunicationEventWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Interaction","InteractionUnit",""};
