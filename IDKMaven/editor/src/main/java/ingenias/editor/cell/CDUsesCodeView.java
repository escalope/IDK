...
public class CDUsesCodeView extends NAryView {

static CDUsesCodeRenderer renderer1 = new CDUsesCodeRenderer();
 public static CDUsesCodeRenderer renderer = new CDUsesCodeRenderer();
  // Constructor.
  public CDUsesCodeView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.CDUsesCode ent=(ingenias.editor.entities.CDUsesCode)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.CDUsesCode ent) {
