...
public class UISelectionEdge extends NAryEdge {

  // Constructor with data content
  public UISelectionEdge(ingenias.editor.entities.UISelection userObject) {
    super(userObject);
    
     this.addRole("UISelectionsource");
     this.setArity("UISelectionsource",true,1);
     this.setArity("UISelectionsource",false,2147483647);
     
this.addClass("UISelectionsource","ingenias.editor.entities.InteractionUnit");
     
this.addClass("UISelectionsource","ingenias.editor.entities.Interaction");
     
    
     this.addRole("UISelectiontarget");
     this.setArity("UISelectiontarget",true,1);
     this.setArity("UISelectiontarget",false,2147483647);
     
this.addClass("UISelectiontarget","ingenias.editor.entities.InteractionUnit");
     
this.addClass("UISelectiontarget","ingenias.editor.entities.Interaction");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof UISelectionEdge)))
      return false;

    // n-edge to be considered.
    UISelectionEdge edge = new UISelectionEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof UISelectionEdge)
      edge = (UISelectionEdge) selectedEdge;
