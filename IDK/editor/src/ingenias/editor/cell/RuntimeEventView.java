...
public class RuntimeEventView extends VertexView {

  public static RuntimeEventRenderer renderer = new RuntimeEventRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public RuntimeEventView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.RuntimeEvent ent=(ingenias.editor.entities.RuntimeEvent)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(RuntimeEvent ent) {
