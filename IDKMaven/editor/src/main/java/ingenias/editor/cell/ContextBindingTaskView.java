...
public class ContextBindingTaskView extends VertexView {

  public static ContextBindingTaskRenderer renderer = new ContextBindingTaskRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ContextBindingTaskView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.ContextBindingTask ent=(ingenias.editor.entities.ContextBindingTask)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ContextBindingTask ent) {
