...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AContainsMENOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AContainsME",
	index,"/ingenias/editor/rendererxml/AContainsMEINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AContainsME",
	index,"/ingenias/editor/rendererxml/AContainsMELABELPanel.xml");
 ...
 public static void setEntity(AContainsME ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AContainsME",ent.getPrefs().getView());
