    ...
    if (nAryEdgesNum <= 1 && edgesNum == 0) {
      ...
      if (relacion.equalsIgnoreCase("EPerceives")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new EPerceivesEdge(new EPerceives(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("EPerceivesNotification")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new EPerceivesNotificationEdge(new EPerceivesNotification(Editor.getNewId()));
        }
      }
      ...
      if (relacion.equalsIgnoreCase("EPerceivesPolling")) {
        ...
        // There is no NAryEdges in selected.
          ...
          return new EPerceivesPollingEdge(new EPerceivesPolling(Editor.getNewId()));
        }
      }
...
JOptionPane.showMessageDialog(IDE.ide,
 ...
 public synchronized JGraph cloneJGraph(){
		 ...
		 EnvironmentModelModelJGraph jg=new  EnvironmentModelModelJGraph(
				(EnvironmentModelDataEntity) this.mde,this.name,IDEAbs.ide.ids.om,
