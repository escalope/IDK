...
public class RuntimeEventRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/RuntimeEventUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("RuntimeEvent",
	index,"/ingenias/editor/rendererxml/RuntimeEventINGENIASPanel.xml");
  ...
  public static void setEntity(RuntimeEvent ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("RuntimeEvent",ent.getPrefs().getView());
