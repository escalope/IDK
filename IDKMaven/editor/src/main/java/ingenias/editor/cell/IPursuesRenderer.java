...
public class IPursuesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("IPursues",
	index,"/rendererxml/IPursuesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IPursues",
	index,"/rendererxml/IPursuesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("IPursues",
	index,"/rendererxml/IPursuesLABELPanel.xml");
     ...
     */
     public IPursuesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("IPursues",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.IPursues ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IPursues",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("IPursues",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("IPursues",c);
	}
