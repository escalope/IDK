...
import ingenias.exception.NotFound;
  ...
  public class Role1Interaction0DefaultCommControl extends DefaultCommControl{
  ...
  public Role1Interaction0DefaultCommControl(String cid, MentalStateReader msr, ingenias.jade.comm.LocksRemover lr){
  super(msr, lr);
 ...
 public boolean continueProcessSend(String stateToEvaluate,String[] options,
   ...
   boolean processed = false;
    ...
    if (stateToEvaluate.equals("InteractionUnit2") &&
    	 sb.isState("InteractionUnit2")&& options.length>0) {         
         ...
         if (allexist && true){
           ...
           sb.removeState("InteractionUnit2");
           
           
	   	   mfcontent=getMSR().obtainConversationalMentalEntityByType(sb.getConversation(),"AnotherGlobalFact");
		   ...
		   futureStates.add("endInteractionUnit2");
  ...
  // String sequence= sb.getState();
    ...
    && mes.getUserDefinedParameter("sequence")!=null &&
         ...
         if (allexist && true){
		   ...
		   futureStates.add("InteractionUnit2");
