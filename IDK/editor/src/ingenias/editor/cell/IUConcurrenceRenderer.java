...
public class IUConcurrenceRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/IUConcurrenceUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IUConcurrence",
	index,"/ingenias/editor/rendererxml/IUConcurrenceINGENIASPanel.xml");
  ...
  public static void setEntity(IUConcurrence ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IUConcurrence",ent.getPrefs().getView());
