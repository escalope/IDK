...
public class ColumnRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/ColumnUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Column",
	index,"/ingenias/editor/rendererxml/ColumnINGENIASPanel.xml");
  ...
  public static void setEntity(Column ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Column",ent.getPrefs().getView());
