...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AInheritsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AInherits",
	index,"/ingenias/editor/rendererxml/AInheritsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AInherits",
	index,"/ingenias/editor/rendererxml/AInheritsLABELPanel.xml");
 ...
 public static void setEntity(AInherits ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AInherits",ent.getPrefs().getView());
