...
public class ApplicationBelongsToEdge extends NAryEdge {

  // Constructor with data content
  public ApplicationBelongsToEdge(ingenias.editor.entities.ApplicationBelongsTo userObject) {
    super(userObject);
    
     this.addRole("ApplicationBelongsTosource");
     this.setArity("ApplicationBelongsTosource",true,1);
     this.setArity("ApplicationBelongsTosource",false,1);
     
this.addClass("ApplicationBelongsTosource","ingenias.editor.entities.OrganizationGroup");
     
this.addClass("ApplicationBelongsTosource","ingenias.editor.entities.Agent");
     
this.addClass("ApplicationBelongsTosource","ingenias.editor.entities.Role");
     
    
     this.addRole("ApplicationBelongsTotarget");
     this.setArity("ApplicationBelongsTotarget",true,1);
     this.setArity("ApplicationBelongsTotarget",false,1);
     
this.addClass("ApplicationBelongsTotarget","ingenias.editor.entities.Application");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof ApplicationBelongsToEdge)))
      return false;

    // n-edge to be considered.
    ApplicationBelongsToEdge edge = new ApplicationBelongsToEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof ApplicationBelongsToEdge)
      edge = (ApplicationBelongsToEdge) selectedEdge;
