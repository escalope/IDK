...
public class IColaboratesView extends NAryView {

static IColaboratesRenderer renderer1 = new IColaboratesRenderer();
 public static IColaboratesRenderer renderer = new IColaboratesRenderer();
  // Constructor.
  public IColaboratesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.IColaborates ent=(ingenias.editor.entities.IColaborates)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.IColaborates ent) {
