...
public class WFStartsEdge extends NAryEdge {

  // Constructor with data content
  public WFStartsEdge(ingenias.editor.entities.WFStarts userObject) {
    super(userObject);
    
     this.addRole("WFStartssource");
     this.setArity("WFStartssource",true,1);
     this.setArity("WFStartssource",false,1);
     
this.addClass("WFStartssource","ingenias.editor.entities.InitialNode");
     
    
     this.addRole("WFStartstarget");
     this.setArity("WFStartstarget",true,1);
     this.setArity("WFStartstarget",false,1);
     
this.addClass("WFStartstarget","ingenias.editor.entities.ActionUML");
     
this.addClass("WFStartstarget","ingenias.editor.entities.InitialNode");
     
this.addClass("WFStartstarget","ingenias.editor.entities.DecisionNode");
     
this.addClass("WFStartstarget","ingenias.editor.entities.JoinNode");
     
this.addClass("WFStartstarget","ingenias.editor.entities.MergeNode");
     
this.addClass("WFStartstarget","ingenias.editor.entities.ForkNode");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof WFStartsEdge)))
      return false;

    // n-edge to be considered.
    WFStartsEdge edge = new WFStartsEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof WFStartsEdge)
      edge = (WFStartsEdge) selectedEdge;
