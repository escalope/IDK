...
public class AGOClientServerRelationshipMemberView extends NAryView {

static AGOClientServerRelationshipMemberRenderer renderer1 = new AGOClientServerRelationshipMemberRenderer();
 public static AGOClientServerRelationshipMemberRenderer renderer = new AGOClientServerRelationshipMemberRenderer();
  // Constructor.
  public AGOClientServerRelationshipMemberView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGOClientServerRelationshipMember ent=(ingenias.editor.entities.AGOClientServerRelationshipMember)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGOClientServerRelationshipMember ent) {
