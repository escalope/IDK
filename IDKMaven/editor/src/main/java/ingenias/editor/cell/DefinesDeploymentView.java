...
public class DefinesDeploymentView extends NAryView {

static DefinesDeploymentRenderer renderer1 = new DefinesDeploymentRenderer();
 public static DefinesDeploymentRenderer renderer = new DefinesDeploymentRenderer();
  // Constructor.
  public DefinesDeploymentView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.DefinesDeployment ent=(ingenias.editor.entities.DefinesDeployment)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.DefinesDeployment ent) {
