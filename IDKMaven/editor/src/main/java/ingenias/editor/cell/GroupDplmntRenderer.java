...
public class GroupDplmntRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("GroupDplmnt",
	index,"/rendererxml/GroupDplmntNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GroupDplmnt",
	index,"/rendererxml/GroupDplmntINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GroupDplmnt",
	index,"/rendererxml/GroupDplmntLABELPanel.xml");
     ...
     */
     public GroupDplmntRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("GroupDplmnt",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.GroupDplmnt ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GroupDplmnt",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("GroupDplmnt",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("GroupDplmnt",c);
	}
