...
public class TestingTimoutTwoParticipant2ForTimedOutCommunicationBothParticipant2 extends TimedOutCommunicationBothParticipant2{
...
{
        // Create a new agent
        final jade.wrapper.AgentController agcATimeOut_0 = ac.createNewAgent("ATimeOut_0",
            "ingenias.jade.agents.ATimeOutJADEAgent", new Object[0]);	
	
	{ FailAllParticipant2 ment=new FailAllParticipant2();
	   	   
	   agcATimeOut_0.putO2AObject(ment, false);
	}
        ...
        new Thread(){
          public void run(){
            try {
               System.out.println("Starting up ATimeOut_0...");
              agcATimeOut_0.start();
        ...
        new Thread(){
	      ...
	      MainInteractionManager.getInstance().setTitle("node DeploymentForTwoParticipant2Timeout");
