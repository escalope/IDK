...
public class OrganizationGroupView extends VertexView {

  public static OrganizationGroupRenderer renderer = new OrganizationGroupRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public OrganizationGroupView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.OrganizationGroup ent=(ingenias.editor.entities.OrganizationGroup)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(OrganizationGroup ent) {
