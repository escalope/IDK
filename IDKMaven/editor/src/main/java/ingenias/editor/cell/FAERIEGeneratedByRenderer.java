...
public class FAERIEGeneratedByRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("FAERIEGeneratedBy",
	index,"/rendererxml/FAERIEGeneratedByNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("FAERIEGeneratedBy",
	index,"/rendererxml/FAERIEGeneratedByINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("FAERIEGeneratedBy",
	index,"/rendererxml/FAERIEGeneratedByLABELPanel.xml");
     ...
     */
     public FAERIEGeneratedByRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("FAERIEGeneratedBy",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.FAERIEGeneratedBy ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("FAERIEGeneratedBy",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("FAERIEGeneratedBy",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("FAERIEGeneratedBy",c);
	}
