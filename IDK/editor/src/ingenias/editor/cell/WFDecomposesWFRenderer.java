...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/WFDecomposesWFNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFDecomposesWF",
	index,"/ingenias/editor/rendererxml/WFDecomposesWFINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFDecomposesWF",
	index,"/ingenias/editor/rendererxml/WFDecomposesWFLABELPanel.xml");
 ...
 public static void setEntity(WFDecomposesWF ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFDecomposesWF",ent.getPrefs().getView());
