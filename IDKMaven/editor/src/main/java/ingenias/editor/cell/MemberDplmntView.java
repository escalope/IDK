...
public class MemberDplmntView extends NAryView {

static MemberDplmntRenderer renderer1 = new MemberDplmntRenderer();
 public static MemberDplmntRenderer renderer = new MemberDplmntRenderer();
  // Constructor.
  public MemberDplmntView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.MemberDplmnt ent=(ingenias.editor.entities.MemberDplmnt)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.MemberDplmnt ent) {
