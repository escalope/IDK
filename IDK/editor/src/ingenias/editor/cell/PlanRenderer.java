...
public class PlanRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/PlanUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Plan",
	index,"/ingenias/editor/rendererxml/PlanINGENIASPanel.xml");
  ...
  public static void setEntity(Plan ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Plan",ent.getPrefs().getView());
