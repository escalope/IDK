...
public class AgentRequirementsQueryWidgetPreferences extends AutonomousEntityQueryWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public AgentRequirementsQueryWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","Requirements",""};
