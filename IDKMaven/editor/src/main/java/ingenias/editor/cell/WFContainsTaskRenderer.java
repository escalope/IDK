...
public class WFContainsTaskRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("WFContainsTask",
	index,"/rendererxml/WFContainsTaskNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFContainsTask",
	index,"/rendererxml/WFContainsTaskINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFContainsTask",
	index,"/rendererxml/WFContainsTaskLABELPanel.xml");
     ...
     */
     public WFContainsTaskRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("WFContainsTask",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.WFContainsTask ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFContainsTask",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("WFContainsTask",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("WFContainsTask",c);
	}
