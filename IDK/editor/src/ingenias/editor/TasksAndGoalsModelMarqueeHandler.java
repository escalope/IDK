...
public class TasksAndGoalsModelMarqueeHandler extends MarqueeHandler  implements java.io.Serializable {

	



        public TasksAndGoalsModelMarqueeHandler(ModelJGraph graph){
	super(graph);
        }
