...
public class WFDecidesEdge extends NAryEdge {

  // Constructor with data content
  public WFDecidesEdge(ingenias.editor.entities.WFDecides userObject) {
    super(userObject);
    
     this.addRole("WFDecidessource");
     this.setArity("WFDecidessource",true,1);
     this.setArity("WFDecidessource",false,1);
     
this.addClass("WFDecidessource","ingenias.editor.entities.DecisionNode");
     
    
     this.addRole("WFDecidestarget");
     this.setArity("WFDecidestarget",true,1);
     this.setArity("WFDecidestarget",false,1);
     
this.addClass("WFDecidestarget","ingenias.editor.entities.ActionUML");
     
this.addClass("WFDecidestarget","ingenias.editor.entities.InitialNode");
     
this.addClass("WFDecidestarget","ingenias.editor.entities.DecisionNode");
     
this.addClass("WFDecidestarget","ingenias.editor.entities.JoinNode");
     
this.addClass("WFDecidestarget","ingenias.editor.entities.MergeNode");
     
this.addClass("WFDecidestarget","ingenias.editor.entities.ForkNode");
     
this.addClass("WFDecidestarget","ingenias.editor.entities.Task");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof WFDecidesEdge)))
      return false;

    // n-edge to be considered.
    WFDecidesEdge edge = new WFDecidesEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof WFDecidesEdge)
      edge = (WFDecidesEdge) selectedEdge;
