...
public class ARoleInheritanceRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("ARoleInheritance",
	index,"/rendererxml/ARoleInheritanceNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ARoleInheritance",
	index,"/rendererxml/ARoleInheritanceINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("ARoleInheritance",
	index,"/rendererxml/ARoleInheritanceLABELPanel.xml");
     ...
     */
     public ARoleInheritanceRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("ARoleInheritance",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.ARoleInheritance ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ARoleInheritance",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("ARoleInheritance",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("ARoleInheritance",c);
	}
