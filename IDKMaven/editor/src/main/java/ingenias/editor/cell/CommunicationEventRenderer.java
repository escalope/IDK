...
public class CommunicationEventRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/rendererxml/CommunicationEventUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("CommunicationEvent",
	index,"/rendererxml/CommunicationEventINGENIASPanel.xml");
    ...
    public CommunicationEventRenderer() {
	  ...
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("CommunicationEvent",ent.getPrefs(map).getView());
  ...
  public static void setEntity(CommunicationEvent ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("CommunicationEvent",ent.getPrefs(attributes).getView());
