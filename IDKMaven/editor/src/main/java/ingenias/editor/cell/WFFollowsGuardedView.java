...
public class WFFollowsGuardedView extends NAryView {

static WFFollowsGuardedRenderer renderer1 = new WFFollowsGuardedRenderer();
 public static WFFollowsGuardedRenderer renderer = new WFFollowsGuardedRenderer();
  // Constructor.
  public WFFollowsGuardedView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFFollowsGuarded ent=(ingenias.editor.entities.WFFollowsGuarded)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFFollowsGuarded ent) {
