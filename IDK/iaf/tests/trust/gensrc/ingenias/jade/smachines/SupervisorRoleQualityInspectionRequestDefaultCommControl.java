...
import ingenias.exception.NotFound;
 ...
 public boolean continueProcessSend(String stateToEvaluate,String[] options,
   ...
   boolean processed = false;
    ...
    if (stateToEvaluate.equals("SolicitudInspeccionCalidadUI") &&
    	 sb.isState("SolicitudInspeccionCalidadUI")&& options.length>0) {         
         ...
         if (allexist && true){
           ...
           sb.removeState("SolicitudInspeccionCalidadUI");
...
public boolean continueProcess(Vector<ACLMessage> multipleMessages,String[] options,
  ...
  // String sequence= sb.getState();
    ...
    if (sb.isState("waiting for GradoCalidadListaUI")&& options.length>0 && mes!=null
    && mes.getUserDefinedParameter("sequence")!=null &&
    		mes.getUserDefinedParameter("sequence").equals("GradoCalidadListaUI")){
    	 boolean allexist=true;
         
         if (allexist && true){
     	   sb.removeState("waiting for GradoCalidadListaUI");           
    	   try {
