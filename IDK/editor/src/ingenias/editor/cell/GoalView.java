...
public class GoalView extends VertexView {

  public static GoalRenderer renderer = new GoalRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public GoalView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Goal ent=(ingenias.editor.entities.Goal)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Goal ent) {
