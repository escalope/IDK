...
public class RoleWSRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/RoleWSUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("RoleWS",
	index,"/ingenias/editor/rendererxml/RoleWSINGENIASPanel.xml");
  ...
  public static void setEntity(RoleWS ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("RoleWS",ent.getPrefs().getView());
