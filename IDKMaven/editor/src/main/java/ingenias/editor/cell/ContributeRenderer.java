...
public class ContributeRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("Contribute",
	index,"/rendererxml/ContributeNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Contribute",
	index,"/rendererxml/ContributeINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("Contribute",
	index,"/rendererxml/ContributeLABELPanel.xml");
     ...
     */
     public ContributeRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("Contribute",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.Contribute ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Contribute",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("Contribute",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("Contribute",c);
	}
