...
public class UMLDescribesUseCaseView extends NAryView {

static UMLDescribesUseCaseRenderer renderer1 = new UMLDescribesUseCaseRenderer();
 public static UMLDescribesUseCaseRenderer renderer = new UMLDescribesUseCaseRenderer();
  // Constructor.
  public UMLDescribesUseCaseView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.UMLDescribesUseCase ent=(ingenias.editor.entities.UMLDescribesUseCase)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.UMLDescribesUseCase ent) {
