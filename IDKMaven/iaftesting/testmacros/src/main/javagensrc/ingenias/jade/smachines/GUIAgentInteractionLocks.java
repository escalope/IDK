...
*/
			...
			public class GUIAgentInteractionLocks implements CustomLocks {
			
			public GUIAgentInteractionLocks(){};
                  ...
                  if (interaction.equals("Interaction0")&& role.equals("Role0")){
                    Role0Interaction0DefaultCommControl.addDefaultLocks(lw);
                  }
