...
public class FileSpecPatternMappingWidgetPreferences extends FileSpecMappingWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public FileSpecPatternMappingWidgetPreferences() {
  super();
  String[] preferredOrder={"Entity","File","Pattern",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("Pattern",ingenias.editor.widget.CustomJComboBox.class);
   result=new Vector();
   
   result.add("Singleton");
   
   result.add("MultipleInstances");
   
   defaultValues.put("Pattern",result);
