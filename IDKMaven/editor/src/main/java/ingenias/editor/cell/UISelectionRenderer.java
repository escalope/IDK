...
public class UISelectionRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("UISelection",
	index,"/rendererxml/UISelectionNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UISelection",
	index,"/rendererxml/UISelectionINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UISelection",
	index,"/rendererxml/UISelectionLABELPanel.xml");
     ...
     */
     public UISelectionRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("UISelection",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.UISelection ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UISelection",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("UISelection",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("UISelection",c);
	}
