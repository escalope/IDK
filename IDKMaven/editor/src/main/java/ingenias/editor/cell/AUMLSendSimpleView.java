...
public class AUMLSendSimpleView extends NAryView {

static AUMLSendSimpleRenderer renderer1 = new AUMLSendSimpleRenderer();
 public static AUMLSendSimpleRenderer renderer = new AUMLSendSimpleRenderer();
  // Constructor.
  public AUMLSendSimpleView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AUMLSendSimple ent=(ingenias.editor.entities.AUMLSendSimple)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AUMLSendSimple ent) {
