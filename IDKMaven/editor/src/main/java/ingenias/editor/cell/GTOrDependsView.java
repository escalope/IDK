...
public class GTOrDependsView extends NAryView {

static GTOrDependsRenderer renderer1 = new GTOrDependsRenderer();
 public static GTOrDependsRenderer renderer = new GTOrDependsRenderer();
  // Constructor.
  public GTOrDependsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.GTOrDepends ent=(ingenias.editor.entities.GTOrDepends)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.GTOrDepends ent) {
