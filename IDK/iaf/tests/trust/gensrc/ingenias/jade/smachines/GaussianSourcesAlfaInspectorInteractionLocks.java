...
*/
			...
			public class GaussianSourcesAlfaInspectorInteractionLocks implements CustomLocks {
			
			public GaussianSourcesAlfaInspectorInteractionLocks(){};
			
			        public void addInteractionLocks(String interaction, LocksWriter lw, String role){
                                    
                   if (interaction.equals("AlphaQualityInspectionRequest") && role.equals("SourcesAlphaQualityInspectorRole") ){
                            SourcesAlphaQualityInspectorRoleAlphaQualityInspectionRequestDefaultCommControl.addDefaultLocks(lw);
                   }
