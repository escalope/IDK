...
public class AGOCondSubordinationRelationshipOrgWidgetPreferences extends EntityWidgetPreferences {
  ...
  public AGOCondSubordinationRelationshipOrgWidgetPreferences() {
  super();
