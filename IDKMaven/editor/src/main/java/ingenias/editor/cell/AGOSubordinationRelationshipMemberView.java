...
public class AGOSubordinationRelationshipMemberView extends NAryView {

static AGOSubordinationRelationshipMemberRenderer renderer1 = new AGOSubordinationRelationshipMemberRenderer();
 public static AGOSubordinationRelationshipMemberRenderer renderer = new AGOSubordinationRelationshipMemberRenderer();
  // Constructor.
  public AGOSubordinationRelationshipMemberView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGOSubordinationRelationshipMember ent=(ingenias.editor.entities.AGOSubordinationRelationshipMember)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGOSubordinationRelationshipMember ent) {
