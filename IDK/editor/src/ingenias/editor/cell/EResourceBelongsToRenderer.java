...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/EResourceBelongsToNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("EResourceBelongsTo",
	index,"/ingenias/editor/rendererxml/EResourceBelongsToINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("EResourceBelongsTo",
	index,"/ingenias/editor/rendererxml/EResourceBelongsToLABELPanel.xml");
 ...
 public static void setEntity(EResourceBelongsTo ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("EResourceBelongsTo",ent.getPrefs().getView());
