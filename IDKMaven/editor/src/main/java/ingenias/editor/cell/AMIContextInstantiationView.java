...
public class AMIContextInstantiationView extends VertexView {

  public static AMIContextInstantiationRenderer renderer = new AMIContextInstantiationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public AMIContextInstantiationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.AMIContextInstantiation ent=(ingenias.editor.entities.AMIContextInstantiation)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(AMIContextInstantiation ent) {
