...
public class WFUsesView extends NAryView {

static WFUsesRenderer renderer1 = new WFUsesRenderer();
 public static WFUsesRenderer renderer = new WFUsesRenderer();
  // Constructor.
  public WFUsesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFUses ent=(ingenias.editor.entities.WFUses)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFUses ent) {
