...
public class IUConcurrenceView extends VertexView {

  public static IUConcurrenceRenderer renderer = new IUConcurrenceRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public IUConcurrenceView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.IUConcurrence ent=(ingenias.editor.entities.IUConcurrence)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(IUConcurrence ent) {
