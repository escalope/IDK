...
public class OrgDplmntRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("OrgDplmnt",
	index,"/rendererxml/OrgDplmntNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("OrgDplmnt",
	index,"/rendererxml/OrgDplmntINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("OrgDplmnt",
	index,"/rendererxml/OrgDplmntLABELPanel.xml");
     ...
     */
     public OrgDplmntRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("OrgDplmnt",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.OrgDplmnt ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("OrgDplmnt",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("OrgDplmnt",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("OrgDplmnt",c);
	}
