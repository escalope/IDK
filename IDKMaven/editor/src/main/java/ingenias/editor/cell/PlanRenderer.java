...
public class PlanRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("Plan",
	index,"/rendererxml/PlanUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Plan",
	index,"/rendererxml/PlanINGENIASPanel.xml");
    ...
    public PlanRenderer() {
	  ...
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("Plan",ent.getPrefs(map).getView());
  ...
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Plan",ent.getPrefs(attributes).getView());
  current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("Plan",
