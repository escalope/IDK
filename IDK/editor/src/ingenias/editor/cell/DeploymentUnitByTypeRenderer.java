...
public class DeploymentUnitByTypeRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/DeploymentUnitByTypeUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("DeploymentUnitByType",
	index,"/ingenias/editor/rendererxml/DeploymentUnitByTypeINGENIASPanel.xml");
  ...
  public static void setEntity(DeploymentUnitByType ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("DeploymentUnitByType",ent.getPrefs().getView());
