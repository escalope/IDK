...
public class HasCtxModelRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("HasCtxModel",
	index,"/rendererxml/HasCtxModelNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("HasCtxModel",
	index,"/rendererxml/HasCtxModelINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("HasCtxModel",
	index,"/rendererxml/HasCtxModelLABELPanel.xml");
     ...
     */
     public HasCtxModelRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("HasCtxModel",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.HasCtxModel ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("HasCtxModel",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("HasCtxModel",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("HasCtxModel",c);
	}
