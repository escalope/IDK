...
*/
			...
			public class PerfectSourceQualityInspectorInteractionLocks implements CustomLocks {
			
			public PerfectSourceQualityInspectorInteractionLocks(){};
			
			        public void addInteractionLocks(String interaction, LocksWriter lw, String role){
                                    
                   if (interaction.equals("QualityInspectionRequest") && role.equals("SourceQualityInspectorRole") ){
                            SourceQualityInspectorRoleQualityInspectionRequestDefaultCommControl.addDefaultLocks(lw);
                   }
