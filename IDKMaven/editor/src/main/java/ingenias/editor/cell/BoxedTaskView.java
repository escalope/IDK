...
public class BoxedTaskView extends VertexView {

  public static BoxedTaskRenderer renderer = new BoxedTaskRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public BoxedTaskView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.BoxedTask ent=(ingenias.editor.entities.BoxedTask)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(BoxedTask ent) {
