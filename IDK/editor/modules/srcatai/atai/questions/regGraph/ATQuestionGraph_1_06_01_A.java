...
public class ATQuestionGraph_1_06_01_A extends ATQuestionGraph {

	/**
	 * @param questionBrowser
	 */
	public ATQuestionGraph_1_06_01_A(Browser questionBrowser) {
		super(ATQuestion_1_06_01_A.getInstance(), questionBrowser);
	}
	...
	public void solvePotentialAnswers() {
		...
		for (int i_1 = 0; i_1 < potentialGroups.size(); i_1++) {
			...
			for (int i_2 = 0; i_2 < potentialObjectives.size(); i_2++) {
				...
				onePursue1 = this.isConnected(oneGroup, oneKeyGoal, ATRelation.Pursue);
				if (onePursue1 != null) {
						...
						if (oneEssential != null) {
							for (int i_4 = 0; i_4 < potentialArtifacts.size(); i_4++) {
								...
								if (onePursue1 != null && onePursue2 != null && oneEssential != null) {
									...
									mapTmp.put("Pursue: Group -> Key Goal", onePursue1.getID());
									graphTmp.put("Pursue: Group -> Key Goal", onePursue1);
