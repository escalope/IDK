...
*/
			...
			public class ConfigurableAutonomousCollaboratorInteractionLocks implements CustomLocks {
			
			public ConfigurableAutonomousCollaboratorInteractionLocks(){};
                  ...
                  if (interaction.equals("PerformProposal")&& role.equals("CollaboratorRole")){
                    CollaboratorRolePerformProposalDefaultCommControl.addDefaultLocks(lw);
                  }
