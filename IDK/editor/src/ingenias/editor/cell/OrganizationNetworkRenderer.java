...
public class OrganizationNetworkRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/OrganizationNetworkUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("OrganizationNetwork",
	index,"/ingenias/editor/rendererxml/OrganizationNetworkINGENIASPanel.xml");
  ...
  public static void setEntity(OrganizationNetwork ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("OrganizationNetwork",ent.getPrefs().getView());
