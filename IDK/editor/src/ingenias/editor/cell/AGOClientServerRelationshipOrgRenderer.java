...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AGOClientServerRelationshipOrgNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOClientServerRelationshipOrg",
	index,"/ingenias/editor/rendererxml/AGOClientServerRelationshipOrgINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOClientServerRelationshipOrg",
	index,"/ingenias/editor/rendererxml/AGOClientServerRelationshipOrgLABELPanel.xml");
 ...
 public static void setEntity(AGOClientServerRelationshipOrg ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOClientServerRelationshipOrg",ent.getPrefs().getView());
