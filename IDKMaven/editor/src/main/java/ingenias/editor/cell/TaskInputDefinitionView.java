...
public class TaskInputDefinitionView extends VertexView {

  public static TaskInputDefinitionRenderer renderer = new TaskInputDefinitionRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public TaskInputDefinitionView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.TaskInputDefinition ent=(ingenias.editor.entities.TaskInputDefinition)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(TaskInputDefinition ent) {
