...
public class CtxtNotifiesView extends NAryView {

static CtxtNotifiesRenderer renderer1 = new CtxtNotifiesRenderer();
 public static CtxtNotifiesRenderer renderer = new CtxtNotifiesRenderer();
  // Constructor.
  public CtxtNotifiesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.CtxtNotifies ent=(ingenias.editor.entities.CtxtNotifies)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.CtxtNotifies ent) {
