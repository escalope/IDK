...
/** 
 * This class was designed using code from  https://bugs.eclipse.org/bugs/show_bug.cgi?id=171432
 * as a workaround in the Java implementation for X11
 * @author jj
 *
 */
public class X11Patch {

	private boolean x11ErrorHandlerFixInstalled;

	private static X11Patch instance=new X11Patch();
	
	public static X11Patch getInstance(){
		return instance;
