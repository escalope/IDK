...
public class UseCasePursuesView extends NAryView {

static UseCasePursuesRenderer renderer1 = new UseCasePursuesRenderer();
 public static UseCasePursuesRenderer renderer = new UseCasePursuesRenderer();
  // Constructor.
  public UseCasePursuesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.UseCasePursues ent=(ingenias.editor.entities.UseCasePursues)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.UseCasePursues ent) {
