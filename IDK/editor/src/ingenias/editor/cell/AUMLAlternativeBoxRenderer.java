...
public class AUMLAlternativeBoxRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/AUMLAlternativeBoxUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLAlternativeBox",
	index,"/ingenias/editor/rendererxml/AUMLAlternativeBoxINGENIASPanel.xml");
  ...
  public static void setEntity(AUMLAlternativeBox ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLAlternativeBox",ent.getPrefs().getView());
