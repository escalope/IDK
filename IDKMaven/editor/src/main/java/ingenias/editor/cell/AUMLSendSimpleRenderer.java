...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AUMLSendSimple",
	index,"/rendererxml/AUMLSendSimpleNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLSendSimple",
	index,"/rendererxml/AUMLSendSimpleINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AUMLSendSimple",
	index,"/rendererxml/AUMLSendSimpleLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.AUMLSendSimple ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLSendSimple",ent.getPrefs(attributes).getView());
