...
public class AUMLAlternativeRowRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/AUMLAlternativeRowUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLAlternativeRow",
	index,"/ingenias/editor/rendererxml/AUMLAlternativeRowINGENIASPanel.xml");
  ...
  public static void setEntity(AUMLAlternativeRow ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLAlternativeRow",ent.getPrefs().getView());
