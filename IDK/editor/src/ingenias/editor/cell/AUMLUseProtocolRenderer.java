...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AUMLUseProtocolNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLUseProtocol",
	index,"/ingenias/editor/rendererxml/AUMLUseProtocolINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AUMLUseProtocol",
	index,"/ingenias/editor/rendererxml/AUMLUseProtocolLABELPanel.xml");
 ...
 public static void setEntity(AUMLUseProtocol ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLUseProtocol",ent.getPrefs().getView());
