...
public class PerfectSourceQualityInspectorProtocol implements AgentProtocols{

public PerfectSourceQualityInspectorProtocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("QualityInspectionRequest") && conv.getPlayedRole().equals("SourceQualityInspectorRole")){
		   	DefaultCommControl dcc=new SourceQualityInspectorRoleQualityInspectionRequestDefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new SourceQualityInspectorRoleQualityInspectionRequestStateBehavior(agentName,
				msr, msu,
				conv,                           		
				conv.getPlayedRole(),
			   	actors,
