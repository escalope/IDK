...
public class FAERIECtxtElementView extends VertexView {

  public static FAERIECtxtElementRenderer renderer = new FAERIECtxtElementRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public FAERIECtxtElementView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.FAERIECtxtElement ent=(ingenias.editor.entities.FAERIECtxtElement)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(FAERIECtxtElement ent) {
