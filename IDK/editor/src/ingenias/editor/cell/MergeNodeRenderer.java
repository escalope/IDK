...
public class MergeNodeRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/MergeNodeUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("MergeNode",
	index,"/ingenias/editor/rendererxml/MergeNodeINGENIASPanel.xml");
  ...
  public static void setEntity(MergeNode ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("MergeNode",ent.getPrefs().getView());
