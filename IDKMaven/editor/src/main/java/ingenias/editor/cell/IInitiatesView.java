...
public class IInitiatesView extends NAryView {

static IInitiatesRenderer renderer1 = new IInitiatesRenderer();
 public static IInitiatesRenderer renderer = new IInitiatesRenderer();
  // Constructor.
  public IInitiatesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.IInitiates ent=(ingenias.editor.entities.IInitiates)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.IInitiates ent) {
