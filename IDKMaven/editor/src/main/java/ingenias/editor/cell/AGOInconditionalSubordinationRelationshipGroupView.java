...
public class AGOInconditionalSubordinationRelationshipGroupView extends NAryView {

static AGOInconditionalSubordinationRelationshipGroupRenderer renderer1 = new AGOInconditionalSubordinationRelationshipGroupRenderer();
 public static AGOInconditionalSubordinationRelationshipGroupRenderer renderer = new AGOInconditionalSubordinationRelationshipGroupRenderer();
  // Constructor.
  public AGOInconditionalSubordinationRelationshipGroupView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGOInconditionalSubordinationRelationshipGroup ent=(ingenias.editor.entities.AGOInconditionalSubordinationRelationshipGroup)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGOInconditionalSubordinationRelationshipGroup ent) {
