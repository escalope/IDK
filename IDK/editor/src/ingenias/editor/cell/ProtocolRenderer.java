...
public class ProtocolRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/ProtocolUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Protocol",
	index,"/ingenias/editor/rendererxml/ProtocolINGENIASPanel.xml");
  ...
  public static void setEntity(Protocol ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Protocol",ent.getPrefs().getView());
