...
public class AGOInconditionalSubordinationRelationshipGroupEdge extends NAryEdge {

  // Constructor with data content
  public AGOInconditionalSubordinationRelationshipGroupEdge(ingenias.editor.entities.AGOInconditionalSubordinationRelationshipGroup userObject) {
    super(userObject);
    
     this.addRole("AGORelationship2source");
     this.setArity("AGORelationship2source",true,1);
     this.setArity("AGORelationship2source",false,1);
     
this.addClass("AGORelationship2source","ingenias.editor.entities.OrganizationGroup");
     
    
     this.addRole("AGORelationship2target");
     this.setArity("AGORelationship2target",true,1);
     this.setArity("AGORelationship2target",false,1);
     
this.addClass("AGORelationship2target","ingenias.editor.entities.OrganizationGroup");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof AGOInconditionalSubordinationRelationshipGroupEdge)))
      return false;

    // n-edge to be considered.
    AGOInconditionalSubordinationRelationshipGroupEdge edge = new AGOInconditionalSubordinationRelationshipGroupEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof AGOInconditionalSubordinationRelationshipGroupEdge)
      edge = (AGOInconditionalSubordinationRelationshipGroupEdge) selectedEdge;
