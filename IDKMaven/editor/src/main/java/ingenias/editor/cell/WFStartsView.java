...
public class WFStartsView extends NAryView {

static WFStartsRenderer renderer1 = new WFStartsRenderer();
 public static WFStartsRenderer renderer = new WFStartsRenderer();
  // Constructor.
  public WFStartsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFStarts ent=(ingenias.editor.entities.WFStarts)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFStarts ent) {
