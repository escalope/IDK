...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/UMLAssociationNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UMLAssociation",
	index,"/ingenias/editor/rendererxml/UMLAssociationINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UMLAssociation",
	index,"/ingenias/editor/rendererxml/UMLAssociationLABELPanel.xml");
 ...
 public static void setEntity(UMLAssociation ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UMLAssociation",ent.getPrefs().getView());
