...
public class ValidatesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("Validates",
	index,"/ingenias/editor/rendererxml/ValidatesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Validates",
	index,"/ingenias/editor/rendererxml/ValidatesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("Validates",
	index,"/ingenias/editor/rendererxml/ValidatesLABELPanel.xml");
     ...
     */
     public ValidatesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("Validates",current);
    }
 ...
 public static void setEntity(Validates ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Validates",ent.getPrefs().getView());
	...
	{
	return RenderComponentManager.retrievePanel("Validates",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("Validates",c);
	}
