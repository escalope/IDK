...
public class EPerceivesView extends NAryView {

static EPerceivesRenderer renderer1 = new EPerceivesRenderer();
 public static EPerceivesRenderer renderer = new EPerceivesRenderer();
  // Constructor.
  public EPerceivesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.EPerceives ent=(ingenias.editor.entities.EPerceives)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.EPerceives ent) {
