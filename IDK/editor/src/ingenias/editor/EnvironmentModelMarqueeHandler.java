...
public class EnvironmentModelMarqueeHandler extends MarqueeHandler  implements java.io.Serializable {

	



        public EnvironmentModelMarqueeHandler(ModelJGraph graph){
	super(graph);
        }
