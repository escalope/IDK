...
public class AGOCondSubordinationRelationshipOrgEdge extends NAryEdge {
  ...
  public AGOCondSubordinationRelationshipOrgEdge(ingenias.editor.entities.AGOCondSubordinationRelationshipOrg userObject) {
    super(userObject);
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof AGOCondSubordinationRelationshipOrgEdge)))
      return false;

    // n-edge to be considered.
    AGOCondSubordinationRelationshipOrgEdge edge = new AGOCondSubordinationRelationshipOrgEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof AGOCondSubordinationRelationshipOrgEdge)
      edge = (AGOCondSubordinationRelationshipOrgEdge) selectedEdge;
