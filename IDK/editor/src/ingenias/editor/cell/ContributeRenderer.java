...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/ContributeNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Contribute",
	index,"/ingenias/editor/rendererxml/ContributeINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("Contribute",
	index,"/ingenias/editor/rendererxml/ContributeLABELPanel.xml");
 ...
 public static void setEntity(Contribute ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Contribute",ent.getPrefs().getView());
