...
public class AutonomousColaboratorProtocol implements AgentProtocols{

public AutonomousColaboratorProtocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("PerformProposal") && conv.getPlayedRole().equals("ColaboratorRole")){
		   DefaultCommControl dcc=new ColaboratorRolePerformProposalDefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new ColaboratorRolePerformProposalStateBehavior(
			agentName,
				msr,msu,
					conv,                           		
				   conv.getPlayedRole(),
