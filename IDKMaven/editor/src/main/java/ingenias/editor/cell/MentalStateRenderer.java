...
public class MentalStateRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("MentalState",
	index,"/rendererxml/MentalStateUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("MentalState",
	index,"/rendererxml/MentalStateINGENIASPanel.xml");
     ...
     */
    public MentalStateRenderer() {
    }
    
      public JComponent getConcreteSubComponent(String fieldname, Entity ent, Map map) {
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("MentalState",ent.getPrefs(map).getView());
	  return currentMap.get(fieldname);
  		}

    public Dimension getSize() {
    return RenderComponentManager.getSize("MentalState",current);
    }
  ...
  public static void setEntity(MentalState ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("MentalState",ent.getPrefs(attributes).getView());
  current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("MentalState",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("MentalState",current);
	}
