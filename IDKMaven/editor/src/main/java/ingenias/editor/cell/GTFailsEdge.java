...
public class GTFailsEdge extends NAryEdge {

  // Constructor with data content
  public GTFailsEdge(ingenias.editor.entities.GTFails userObject) {
    super(userObject);
    
     this.addRole("GTFailssource");
     this.setArity("GTFailssource",true,1);
     this.setArity("GTFailssource",false,1);
     
this.addClass("GTFailssource","ingenias.editor.entities.Task");
     
this.addClass("GTFailssource","ingenias.editor.entities.Workflow");
     
this.addClass("GTFailssource","ingenias.editor.entities.Plan");
     
    
     this.addRole("GTFailstarget");
     this.setArity("GTFailstarget",true,1);
     this.setArity("GTFailstarget",false,2147483647);
     
this.addClass("GTFailstarget","ingenias.editor.entities.Goal");
     
    
     this.addRole("GTFailsHelperTasktarget");
     this.setArity("GTFailsHelperTasktarget",true,0);
     this.setArity("GTFailsHelperTasktarget",false,1);
     
this.addClass("GTFailsHelperTasktarget","ingenias.editor.entities.Task");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof GTFailsEdge)))
      return false;

    // n-edge to be considered.
    GTFailsEdge edge = new GTFailsEdge( null);
