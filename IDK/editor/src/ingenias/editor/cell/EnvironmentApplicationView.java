...
public class EnvironmentApplicationView extends VertexView {

  public static EnvironmentApplicationRenderer renderer = new EnvironmentApplicationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public EnvironmentApplicationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.EnvironmentApplication ent=(ingenias.editor.entities.EnvironmentApplication)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(EnvironmentApplication ent) {
