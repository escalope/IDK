...
public class AGOInconditionalSubordinationRelationshipOrgRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGOInconditionalSubordinationRelationshipOrg",
	index,"/rendererxml/AGOInconditionalSubordinationRelationshipOrgNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOInconditionalSubordinationRelationshipOrg",
	index,"/rendererxml/AGOInconditionalSubordinationRelationshipOrgINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOInconditionalSubordinationRelationshipOrg",
	index,"/rendererxml/AGOInconditionalSubordinationRelationshipOrgLABELPanel.xml");
     ...
     */
     public AGOInconditionalSubordinationRelationshipOrgRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGOInconditionalSubordinationRelationshipOrg",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGOInconditionalSubordinationRelationshipOrg ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOInconditionalSubordinationRelationshipOrg",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGOInconditionalSubordinationRelationshipOrg",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGOInconditionalSubordinationRelationshipOrg",c);
	}
