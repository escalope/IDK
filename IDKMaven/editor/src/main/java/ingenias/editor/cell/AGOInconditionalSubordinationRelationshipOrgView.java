...
public class AGOInconditionalSubordinationRelationshipOrgView extends NAryView {

static AGOInconditionalSubordinationRelationshipOrgRenderer renderer1 = new AGOInconditionalSubordinationRelationshipOrgRenderer();
 public static AGOInconditionalSubordinationRelationshipOrgRenderer renderer = new AGOInconditionalSubordinationRelationshipOrgRenderer();
  // Constructor.
  public AGOInconditionalSubordinationRelationshipOrgView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGOInconditionalSubordinationRelationshipOrg ent=(ingenias.editor.entities.AGOInconditionalSubordinationRelationshipOrg)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGOInconditionalSubordinationRelationshipOrg ent) {
