...
public class DeploymentUnitByTypeView extends VertexView {

  public static DeploymentUnitByTypeRenderer renderer = new DeploymentUnitByTypeRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public DeploymentUnitByTypeView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.DeploymentUnitByType ent=(ingenias.editor.entities.DeploymentUnitByType)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(DeploymentUnitByType ent) {
