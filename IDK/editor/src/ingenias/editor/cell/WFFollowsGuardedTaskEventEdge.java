...
public class WFFollowsGuardedTaskEventEdge extends NAryEdge {

  // Constructor with data content
  public WFFollowsGuardedTaskEventEdge(WFFollowsGuardedTaskEvent userObject) {
    super(userObject);
    
     this.addRole("WFFollowssource");
     this.setArity("WFFollowssource",true,1);
     this.setArity("WFFollowssource",false,1);
     
this.addClass("WFFollowssource","ingenias.editor.entities.Task");
...
this.addClass("WFFollowssource","ingenias.editor.entities.ConditionalMentalState");
     ...
     this.setArity("WFFollowstarget",false,1);
     
this.addClass("WFFollowstarget","ingenias.editor.entities.DecisionNode");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof WFFollowsGuardedTaskEventEdge)))
      return false;

    // n-edge to be considered.
    WFFollowsGuardedTaskEventEdge edge = new WFFollowsGuardedTaskEventEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof WFFollowsGuardedTaskEventEdge)
      edge = (WFFollowsGuardedTaskEventEdge) selectedEdge;
