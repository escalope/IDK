...
public class RoleRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/RoleUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Role",
	index,"/ingenias/editor/rendererxml/RoleINGENIASPanel.xml");
  ...
  public static void setEntity(Role ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Role",ent.getPrefs().getView());
