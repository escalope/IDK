...
public class InteractionUnitView extends VertexView {

  public static InteractionUnitRenderer renderer = new InteractionUnitRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public InteractionUnitView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.InteractionUnit ent=(ingenias.editor.entities.InteractionUnit)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(InteractionUnit ent) {
