...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GTDecomposesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTDecomposes",
	index,"/ingenias/editor/rendererxml/GTDecomposesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTDecomposes",
	index,"/ingenias/editor/rendererxml/GTDecomposesLABELPanel.xml");
 ...
 public static void setEntity(GTDecomposes ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTDecomposes",ent.getPrefs().getView());
