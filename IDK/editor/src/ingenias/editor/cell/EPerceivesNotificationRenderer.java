...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/EPerceivesNotificationNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("EPerceivesNotification",
	index,"/ingenias/editor/rendererxml/EPerceivesNotificationINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("EPerceivesNotification",
	index,"/ingenias/editor/rendererxml/EPerceivesNotificationLABELPanel.xml");
 ...
 public static void setEntity(EPerceivesNotification ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("EPerceivesNotification",ent.getPrefs().getView());
