...
public class HasCtxModelView extends NAryView {

static HasCtxModelRenderer renderer1 = new HasCtxModelRenderer();
 public static HasCtxModelRenderer renderer = new HasCtxModelRenderer();
  // Constructor.
  public HasCtxModelView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.HasCtxModel ent=(ingenias.editor.entities.HasCtxModel)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.HasCtxModel ent) {
