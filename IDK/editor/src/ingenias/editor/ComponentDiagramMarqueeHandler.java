...
public class ComponentDiagramMarqueeHandler extends MarqueeHandler  implements java.io.Serializable {

	



        public ComponentDiagramMarqueeHandler(ModelJGraph graph){
	super(graph);
        }
