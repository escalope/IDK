...
public class IColaboratestargetRole extends RoleEntity {
 ...
 public IColaboratestargetRole() {
	    super("IColaboratestargetRole"+idCounter);
	    idCounter++;
  ...
  public IColaboratestargetRole(String id) {
    super(id);
