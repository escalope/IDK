...
public class GroupBelongsToOrganizationEdge extends NAryEdge {

  // Constructor with data content
  public GroupBelongsToOrganizationEdge(ingenias.editor.entities.GroupBelongsToOrganization userObject) {
    super(userObject);
    
     this.addRole("GroupBelongsToOrganizationO");
     this.setArity("GroupBelongsToOrganizationO",true,1);
     this.setArity("GroupBelongsToOrganizationO",false,1);
     
this.addClass("GroupBelongsToOrganizationO","ingenias.editor.entities.Organization");
     
    
     this.addRole("GroupBelongsToOrganizationT");
     this.setArity("GroupBelongsToOrganizationT",true,1);
     this.setArity("GroupBelongsToOrganizationT",false,2147483647);
     
this.addClass("GroupBelongsToOrganizationT","ingenias.editor.entities.OrganizationGroup");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof GroupBelongsToOrganizationEdge)))
      return false;

    // n-edge to be considered.
    GroupBelongsToOrganizationEdge edge = new GroupBelongsToOrganizationEdge( null);
    // If the connection involves an existing n-edge its assignations has to be considered.
    if (nAryEdgesNum == 1 && selectedEdge instanceof GroupBelongsToOrganizationEdge)
      edge = (GroupBelongsToOrganizationEdge) selectedEdge;
