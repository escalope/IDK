...
public class SimulationEventView extends VertexView {

  public static SimulationEventRenderer renderer = new SimulationEventRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public SimulationEventView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.SimulationEvent ent=(ingenias.editor.entities.SimulationEvent)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(SimulationEvent ent) {
