...
public class ResourceRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/rendererxml/ResourceUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Resource",
	index,"/rendererxml/ResourceINGENIASPanel.xml");
    ...
    public ResourceRenderer() {
	  ...
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("Resource",ent.getPrefs(map).getView());
  ...
  public static void setEntity(Resource ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Resource",ent.getPrefs(attributes).getView());
