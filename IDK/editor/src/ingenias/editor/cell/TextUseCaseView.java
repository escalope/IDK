...
public class TextUseCaseView extends VertexView {

  public static TextUseCaseRenderer renderer = new TextUseCaseRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public TextUseCaseView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.TextUseCase ent=(ingenias.editor.entities.TextUseCase)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(TextUseCase ent) {
