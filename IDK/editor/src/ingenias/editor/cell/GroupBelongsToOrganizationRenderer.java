...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GroupBelongsToOrganizationNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GroupBelongsToOrganization",
	index,"/ingenias/editor/rendererxml/GroupBelongsToOrganizationINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GroupBelongsToOrganization",
	index,"/ingenias/editor/rendererxml/GroupBelongsToOrganizationLABELPanel.xml");
 ...
 public static void setEntity(GroupBelongsToOrganization ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GroupBelongsToOrganization",ent.getPrefs().getView());
