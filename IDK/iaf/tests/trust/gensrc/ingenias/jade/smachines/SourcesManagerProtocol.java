...
public SourcesManagerProtocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("RequestToAddSource") && conv.getPlayedRole().equals("GestorFuentesRole")){
		   	DefaultCommControl dcc=new GestorFuentesRoleRequestToAddSourceDefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new GestorFuentesRoleRequestToAddSourceStateBehavior(agentName,
				msr, msu,
				conv,                           		
				conv.getPlayedRole(),
			   	actors,
