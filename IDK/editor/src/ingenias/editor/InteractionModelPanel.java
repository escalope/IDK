...
public class InteractionModelPanel extends JGraph {
 ...
 entities.add("UMLComment");
  ...
  public DefaultGraphCell createCell(String entity) throws InvalidEntity{
    ...
    Interaction nentity=new Interaction(Editor.getNewId("Interaction"));
      DefaultGraphCell vertex = new
    ...
    IUIterate nentity=new IUIterate(Editor.getNewId("IUIterate"));
      DefaultGraphCell vertex = new
    ...
    IUConcurrence nentity=new IUConcurrence(Editor.getNewId("IUConcurrence"));
      DefaultGraphCell vertex = new
    ...
    InteractionUnit nentity=new InteractionUnit(Editor.getNewId("InteractionUnit"));
      DefaultGraphCell vertex = new
    ...
    UMLSpecification nentity=new UMLSpecification(Editor.getNewId("UMLSpecification"));
      DefaultGraphCell vertex = new
    ...
    AUMLSpecification nentity=new AUMLSpecification(Editor.getNewId("AUMLSpecification"));
      DefaultGraphCell vertex = new
    ...
    GRASIASpecification nentity=new GRASIASpecification(Editor.getNewId("GRASIASpecification"));
      DefaultGraphCell vertex = new
