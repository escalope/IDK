...
public class IncludesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("Includes",
	index,"/rendererxml/IncludesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("Includes",
	index,"/rendererxml/IncludesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("Includes",
	index,"/rendererxml/IncludesLABELPanel.xml");
     ...
     */
     public IncludesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("Includes",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.Includes ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("Includes",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("Includes",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("Includes",c);
	}
