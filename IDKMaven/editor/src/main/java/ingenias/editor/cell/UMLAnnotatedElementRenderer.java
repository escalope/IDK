...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("UMLAnnotatedElement",
	index,"/rendererxml/UMLAnnotatedElementNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UMLAnnotatedElement",
	index,"/rendererxml/UMLAnnotatedElementINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UMLAnnotatedElement",
	index,"/rendererxml/UMLAnnotatedElementLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.UMLAnnotatedElement ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UMLAnnotatedElement",ent.getPrefs(attributes).getView());
