...
public class ParticipatesInUseCaseView extends NAryView {

static ParticipatesInUseCaseRenderer renderer1 = new ParticipatesInUseCaseRenderer();
 public static ParticipatesInUseCaseRenderer renderer = new ParticipatesInUseCaseRenderer();
  // Constructor.
  public ParticipatesInUseCaseView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.ParticipatesInUseCase ent=(ingenias.editor.entities.ParticipatesInUseCase)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.ParticipatesInUseCase ent) {
