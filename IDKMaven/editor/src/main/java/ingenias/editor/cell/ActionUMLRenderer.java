...
public class ActionUMLRenderer extends CompositeRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	RenderComponentManager.loadRenderFile("ActionUML",
	index,"/rendererxml/ActionUMLUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ActionUML",
	index,"/rendererxml/ActionUMLINGENIASPanel.xml");
     ...
     */
    public ActionUMLRenderer() {
    }
    
      public JComponent getConcreteSubComponent(String fieldname, Entity ent, Map map) {
	  Map<String,JComponent> currentMap=(Map)  RenderComponentManager.retrieveIDs("ActionUML",ent.getPrefs(map).getView());
	  return currentMap.get(fieldname);
  		}

    public Dimension getSize() {
    return RenderComponentManager.getSize("ActionUML",current);
    }
  ...
  public static void setEntity(ActionUML ent, Map attributes){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ActionUML",ent.getPrefs(attributes).getView());
  current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("ActionUML",
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("ActionUML",current);
	}
