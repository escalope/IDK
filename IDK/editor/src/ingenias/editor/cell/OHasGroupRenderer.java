...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/OHasGroupNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("OHasGroup",
	index,"/ingenias/editor/rendererxml/OHasGroupINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("OHasGroup",
	index,"/ingenias/editor/rendererxml/OHasGroupLABELPanel.xml");
 ...
 public static void setEntity(OHasGroup ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("OHasGroup",ent.getPrefs().getView());
