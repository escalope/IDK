...
public class TaskWSRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/TaskWSUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("TaskWS",
	index,"/ingenias/editor/rendererxml/TaskWSINGENIASPanel.xml");
  ...
  public static void setEntity(TaskWS ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("TaskWS",ent.getPrefs().getView());
