...
public class AGORelationshipOrgView extends NAryView {

static AGORelationshipOrgRenderer renderer1 = new AGORelationshipOrgRenderer();
 public static AGORelationshipOrgRenderer renderer = new AGORelationshipOrgRenderer();
  // Constructor.
  public AGORelationshipOrgView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.AGORelationshipOrg ent=(ingenias.editor.entities.AGORelationshipOrg)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.AGORelationshipOrg ent) {
