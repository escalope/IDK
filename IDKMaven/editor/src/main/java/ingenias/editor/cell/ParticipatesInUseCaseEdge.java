...
public class ParticipatesInUseCaseEdge extends NAryEdge {

  // Constructor with data content
  public ParticipatesInUseCaseEdge(ingenias.editor.entities.ParticipatesInUseCase userObject) {
    super(userObject);
    
     this.addRole("ParticipatesInUseCasesource");
     this.setArity("ParticipatesInUseCasesource",true,1);
     this.setArity("ParticipatesInUseCasesource",false,1);
     
this.addClass("ParticipatesInUseCasesource","ingenias.editor.entities.Agent");
     
this.addClass("ParticipatesInUseCasesource","ingenias.editor.entities.Role");
     
this.addClass("ParticipatesInUseCasesource","ingenias.editor.entities.Organization");
     
this.addClass("ParticipatesInUseCasesource","ingenias.editor.entities.OrganizationGroup");
     
    
     this.addRole("ParticipatesInUseCasetarget");
     this.setArity("ParticipatesInUseCasetarget",true,1);
     this.setArity("ParticipatesInUseCasetarget",false,2147483647);
     
this.addClass("ParticipatesInUseCasetarget","ingenias.editor.entities.UseCase");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof ParticipatesInUseCaseEdge)))
      return false;

    // n-edge to be considered.
    ParticipatesInUseCaseEdge edge = new ParticipatesInUseCaseEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof ParticipatesInUseCaseEdge)
      edge = (ParticipatesInUseCaseEdge) selectedEdge;
