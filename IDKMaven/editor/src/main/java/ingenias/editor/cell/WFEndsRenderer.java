...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/rendererxml/WFEndsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("WFEnds",
	index,"/rendererxml/WFEndsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("WFEnds",
	index,"/rendererxml/WFEndsLABELPanel.xml");
 ...
 public static void setEntity(ingenias.editor.entities.WFEnds ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("WFEnds",ent.getPrefs(attributes).getView());
