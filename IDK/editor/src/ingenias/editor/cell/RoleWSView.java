...
public class RoleWSView extends VertexView {

  public static RoleWSRenderer renderer = new RoleWSRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public RoleWSView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.RoleWS ent=(ingenias.editor.entities.RoleWS)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(RoleWS ent) {
