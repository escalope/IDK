...
public class DeploymentPackageView extends VertexView {

  public static DeploymentPackageRenderer renderer = new DeploymentPackageRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public DeploymentPackageView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.DeploymentPackage ent=(ingenias.editor.entities.DeploymentPackage)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(DeploymentPackage ent) {
