...
public class AGOCondSubordinationRelationshipMemberRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AGOCondSubordinationRelationshipMember",
	index,"/rendererxml/AGOCondSubordinationRelationshipMemberNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AGOCondSubordinationRelationshipMember",
	index,"/rendererxml/AGOCondSubordinationRelationshipMemberINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AGOCondSubordinationRelationshipMember",
	index,"/rendererxml/AGOCondSubordinationRelationshipMemberLABELPanel.xml");
     ...
     */
     public AGOCondSubordinationRelationshipMemberRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AGOCondSubordinationRelationshipMember",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AGOCondSubordinationRelationshipMember ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AGOCondSubordinationRelationshipMember",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AGOCondSubordinationRelationshipMember",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AGOCondSubordinationRelationshipMember",c);
	}
