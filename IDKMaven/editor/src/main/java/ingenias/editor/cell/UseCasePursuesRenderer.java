...
public class UseCasePursuesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("UseCasePursues",
	index,"/rendererxml/UseCasePursuesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UseCasePursues",
	index,"/rendererxml/UseCasePursuesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UseCasePursues",
	index,"/rendererxml/UseCasePursuesLABELPanel.xml");
     ...
     */
     public UseCasePursuesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("UseCasePursues",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.UseCasePursues ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UseCasePursues",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("UseCasePursues",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("UseCasePursues",c);
	}
