...
*/
			...
			public class InitiatorAgentInteractionLocks implements CustomLocks {
			
			public InitiatorAgentInteractionLocks(){};
                  ...
                  if (interaction.equals("SampleInteraction")&& role.equals("Initiator")){
                    InitiatorSampleInteractionDefaultCommControl.addDefaultLocks(lw);
                  }
