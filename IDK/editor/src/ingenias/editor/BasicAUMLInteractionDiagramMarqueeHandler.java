...
public class BasicAUMLInteractionDiagramMarqueeHandler extends MarqueeHandler  implements java.io.Serializable {

	



        public BasicAUMLInteractionDiagramMarqueeHandler(ModelJGraph graph){
	super(graph);
        }
