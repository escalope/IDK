...
public class UMLDescribesUseCaseEdge extends NAryEdge {

  // Constructor with data content
  public UMLDescribesUseCaseEdge(ingenias.editor.entities.UMLDescribesUseCase userObject) {
    super(userObject);
    
     this.addRole("UMLDescribesUseCasesource");
     this.setArity("UMLDescribesUseCasesource",true,1);
     this.setArity("UMLDescribesUseCasesource",false,1);
     
this.addClass("UMLDescribesUseCasesource","ingenias.editor.entities.UseCase");
     
    
     this.addRole("UMLDescribesUseCasetarget");
     this.setArity("UMLDescribesUseCasetarget",true,1);
     this.setArity("UMLDescribesUseCasetarget",false,2147483647);
     
this.addClass("UMLDescribesUseCasetarget","ingenias.editor.entities.Interaction");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof UMLDescribesUseCaseEdge)))
      return false;

    // n-edge to be considered.
    UMLDescribesUseCaseEdge edge = new UMLDescribesUseCaseEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof UMLDescribesUseCaseEdge)
      edge = (UMLDescribesUseCaseEdge) selectedEdge;
