...
public class OrganizationView extends VertexView {

  public static OrganizationRenderer renderer = new OrganizationRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public OrganizationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Organization ent=(ingenias.editor.entities.Organization)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Organization ent) {
