...
public class AUMLAlternativeBoxWidgetPreferences extends AUMLContainerWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public AUMLAlternativeBoxWidgetPreferences() {
  super();
  String[] preferredOrder={"NumberOfAlternatives",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("NumberOfAlternatives",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("NumberOfAlternatives",result);
