...
public class MentalStateManagerView extends VertexView {

  public static MentalStateManagerRenderer renderer = new MentalStateManagerRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public MentalStateManagerView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.MentalStateManager ent=(ingenias.editor.entities.MentalStateManager)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(MentalStateManager ent) {
