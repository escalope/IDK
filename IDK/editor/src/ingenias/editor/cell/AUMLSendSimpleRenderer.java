...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/AUMLSendSimpleNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLSendSimple",
	index,"/ingenias/editor/rendererxml/AUMLSendSimpleINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AUMLSendSimple",
	index,"/ingenias/editor/rendererxml/AUMLSendSimpleLABELPanel.xml");
