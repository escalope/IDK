...
public class MentalStateProcessorWidgetPreferences extends AgentComponentWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public MentalStateProcessorWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","ProcessorDescription",""};
