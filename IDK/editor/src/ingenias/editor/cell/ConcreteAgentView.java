...
public class ConcreteAgentView extends VertexView {

  public static ConcreteAgentRenderer renderer = new ConcreteAgentRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public ConcreteAgentView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.ConcreteAgent ent=(ingenias.editor.entities.ConcreteAgent)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ConcreteAgent ent) {
