...
public class SourcesManagerProtocol implements AgentProtocols{

public SourcesManagerProtocol(){};		
	...
	public ActiveConversation initialiseProtocols(String agentName,RuntimeConversation conv, 
        ...
        // Adds a protocol to the protocol queue
		   ...
		   if (conv.getInteraction().getId().equals("RequestToAddSource") && conv.getPlayedRole().equals("SourcesManagerRole")){
		   	DefaultCommControl dcc=new SourcesManagerRoleRequestToAddSourceDefaultCommControl(
                        		   conv.getConversationID(),msr,lr);
			sb = new SourcesManagerRoleRequestToAddSourceStateBehavior(agentName,
				msr, msu,
				conv,                           		
				conv.getPlayedRole(),
			   	actors,
