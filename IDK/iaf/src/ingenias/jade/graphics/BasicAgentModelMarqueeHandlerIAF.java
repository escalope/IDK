...
public abstract class BasicAgentModelMarqueeHandlerIAF extends MarqueeHandlerIAF  implements java.io.Serializable {

	



        public BasicAgentModelMarqueeHandlerIAF(JGraph graph){
	super(graph);
        }
