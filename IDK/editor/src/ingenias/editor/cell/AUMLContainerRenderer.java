...
public class AUMLContainerRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/AUMLContainerUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AUMLContainer",
	index,"/ingenias/editor/rendererxml/AUMLContainerINGENIASPanel.xml");
  ...
  public static void setEntity(AUMLContainer ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AUMLContainer",ent.getPrefs().getView());
