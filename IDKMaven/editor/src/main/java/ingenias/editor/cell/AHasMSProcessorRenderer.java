...
public class AHasMSProcessorRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("AHasMSProcessor",
	index,"/rendererxml/AHasMSProcessorNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("AHasMSProcessor",
	index,"/rendererxml/AHasMSProcessorINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("AHasMSProcessor",
	index,"/rendererxml/AHasMSProcessorLABELPanel.xml");
     ...
     */
     public AHasMSProcessorRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("AHasMSProcessor",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.AHasMSProcessor ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("AHasMSProcessor",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("AHasMSProcessor",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("AHasMSProcessor",c);
	}
