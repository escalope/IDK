...
public class CompromiseView extends VertexView {

  public static CompromiseRenderer renderer = new CompromiseRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public CompromiseView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.Compromise ent=(ingenias.editor.entities.Compromise)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(Compromise ent) {
