...
public class AUMLAlternativeRowView extends VertexView {

  public static AUMLAlternativeRowRenderer renderer = new AUMLAlternativeRowRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public AUMLAlternativeRowView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.AUMLAlternativeRow ent=(ingenias.editor.entities.AUMLAlternativeRow)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(AUMLAlternativeRow ent) {
