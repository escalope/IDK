...
public class IUConcurrenceWidgetPreferences extends InteractionUnitWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public IUConcurrenceWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","InteractionUnits",""};
