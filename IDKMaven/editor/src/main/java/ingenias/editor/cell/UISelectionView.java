...
public class UISelectionView extends NAryView {

static UISelectionRenderer renderer1 = new UISelectionRenderer();
 public static UISelectionRenderer renderer = new UISelectionRenderer();
  // Constructor.
  public UISelectionView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.UISelection ent=(ingenias.editor.entities.UISelection)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.UISelection ent) {
