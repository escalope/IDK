...
public class ATQuestion_2_02_01_B extends ATQuestion {
	 ...
	 */
	static ATQuestion_2_02_01_B theInstance = null;
	...
	static {
		...
		entityTypes.put("Needed Elements", ATEntity.Object);
		Map<String, ATRelation> relationTypes = new HashMap<String, ATRelation>();
		relationTypes.put("Tranform: This Activity -> Needed Elements", ATRelation.Transform);
		...
		players.put("Tranform: This Activity -> Needed Elements" + "::" + Graph.ROLE_ORIGIN, "This Activity");
		players.put("Tranform: This Activity -> Needed Elements" + "::" + Graph.ROLE_TARGET, "Needed Elements");
//////////// ¿SERÁ ESTO NECESARIO?		
	...
	protected ATQuestion_2_02_01_B() {
		super();
		this.setArea(ATQuestion_2_02_01_B.area);
		this.setAspect(ATQuestion_2_02_01_B.aspect);
		this.setId(ATQuestion_2_02_01_B.id);
		this.setDescription(ATQuestion_2_02_01_B.description);
		this.setQuestion(ATQuestion_2_02_01_B.question);
		this.setTextualQuestion(ATQuestion_2_02_01_B.textualQuestion);
	}
	
	
	
	static public ATQuestion_2_02_01_B getInstance() {
		if (ATQuestion_2_02_01_B.theInstance == null)
			ATQuestion_2_02_01_B.theInstance = new ATQuestion_2_02_01_B();
		return ATQuestion_2_02_01_B.theInstance;
	}
