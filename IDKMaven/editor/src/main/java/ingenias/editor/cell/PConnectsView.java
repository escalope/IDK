...
public class PConnectsView extends NAryView {

static PConnectsRenderer renderer1 = new PConnectsRenderer();
 public static PConnectsRenderer renderer = new PConnectsRenderer();
  // Constructor.
  public PConnectsView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.PConnects ent=(ingenias.editor.entities.PConnects)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.PConnects ent) {
