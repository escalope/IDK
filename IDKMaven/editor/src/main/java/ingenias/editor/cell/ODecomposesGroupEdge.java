...
public class ODecomposesGroupEdge extends NAryEdge {

  // Constructor with data content
  public ODecomposesGroupEdge(ingenias.editor.entities.ODecomposesGroup userObject) {
    super(userObject);
    
     this.addRole("ODecomposesGroupsource");
     this.setArity("ODecomposesGroupsource",true,1);
     this.setArity("ODecomposesGroupsource",false,1);
     
this.addClass("ODecomposesGroupsource","ingenias.editor.entities.OrganizationGroup");
     
    
     this.addRole("ODecomposesGrouptarget");
     this.setArity("ODecomposesGrouptarget",true,1);
     this.setArity("ODecomposesGrouptarget",false,2147483647);
     
this.addClass("ODecomposesGrouptarget","ingenias.editor.entities.OrganizationGroup");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof ODecomposesGroupEdge)))
      return false;

    // n-edge to be considered.
    ODecomposesGroupEdge edge = new ODecomposesGroupEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof ODecomposesGroupEdge)
      edge = (ODecomposesGroupEdge) selectedEdge;
