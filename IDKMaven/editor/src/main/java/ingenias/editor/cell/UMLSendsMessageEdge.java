...
public class UMLSendsMessageEdge extends NAryEdge {

  // Constructor with data content
  public UMLSendsMessageEdge(ingenias.editor.entities.UMLSendsMessage userObject) {
    super(userObject);
    
     this.addRole("UMLSendsMessagesource");
     this.setArity("UMLSendsMessagesource",true,1);
     this.setArity("UMLSendsMessagesource",false,1);
     
this.addClass("UMLSendsMessagesource","ingenias.editor.entities.Agent");
     
this.addClass("UMLSendsMessagesource","ingenias.editor.entities.Role");
     
    
     this.addRole("UMLSendsMessagetarget");
     this.setArity("UMLSendsMessagetarget",true,1);
     this.setArity("UMLSendsMessagetarget",false,1);
     
this.addClass("UMLSendsMessagetarget","ingenias.editor.entities.Agent");
     
this.addClass("UMLSendsMessagetarget","ingenias.editor.entities.Role");
  ...
  // Connects an Agent with a Goal or an Agent with a Goal and a Fact.
   public static boolean acceptConnection(GraphModel model, GraphCell[] selected) {
    ...
    if (nAryEdgesNum > 1 || edgesNum > 0 ||
      !((selectedEdge == null) || (selectedEdge instanceof UMLSendsMessageEdge)))
      return false;

    // n-edge to be considered.
    UMLSendsMessageEdge edge = new UMLSendsMessageEdge( null);
    ...
    if (nAryEdgesNum == 1 && selectedEdge instanceof UMLSendsMessageEdge)
      edge = (UMLSendsMessageEdge) selectedEdge;
