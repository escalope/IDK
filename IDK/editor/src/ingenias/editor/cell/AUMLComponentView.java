...
public class AUMLComponentView extends VertexView {

  public static AUMLComponentRenderer renderer = new AUMLComponentRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public AUMLComponentView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.AUMLComponent ent=(ingenias.editor.entities.AUMLComponent)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(AUMLComponent ent) {
