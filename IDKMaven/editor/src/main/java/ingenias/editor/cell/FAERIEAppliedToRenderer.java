...
public class FAERIEAppliedToRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("FAERIEAppliedTo",
	index,"/rendererxml/FAERIEAppliedToNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("FAERIEAppliedTo",
	index,"/rendererxml/FAERIEAppliedToINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("FAERIEAppliedTo",
	index,"/rendererxml/FAERIEAppliedToLABELPanel.xml");
     ...
     */
     public FAERIEAppliedToRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("FAERIEAppliedTo",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.FAERIEAppliedTo ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("FAERIEAppliedTo",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("FAERIEAppliedTo",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("FAERIEAppliedTo",c);
	}
