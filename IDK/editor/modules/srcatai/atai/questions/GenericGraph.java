 ...
 * This class is used to represent questions and answers in the REG. 
 ...
 * The class considers names and types of elements as strings without
...
public class GenericGraph implements Graph {
	...
	/**
	 * Language of the graph.
	 */
	private String language;
	/**
	 * Ids of the entities in the graph.
	 */
	private List<String> entities;
	/**
	 * Pairs <id, type> for the entities in the graph.
	 */
	private Map<String, String> entityTypes;
	/**
	 * Ids for the relations in the graph.
	 */
	private List<String> relations;
	/**
	 * Pairs <id, type> for the relations in the graph.
	 */
	private Map<String, String> relationTypes;
	/**
	 * Pairs <relation id, role id> for the relations in the graph.
	 */
	private Map<String, List<String>> roles;
	/**
	 * Pairs <id, type> for the roles in the graph.
	 */
	private Map<String, String> roleTypes;
	/**
	 * Pairs <role id, entity id> for the players of roles in the graph.
	 */
	 ...
	 * @param variables  
	 */
	public GenericGraph(String language,
	...
	/**
	 * @return the elements that are variables in this graph.
	 */
