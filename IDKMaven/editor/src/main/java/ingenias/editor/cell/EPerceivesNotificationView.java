...
public class EPerceivesNotificationView extends NAryView {

static EPerceivesNotificationRenderer renderer1 = new EPerceivesNotificationRenderer();
 public static EPerceivesNotificationRenderer renderer = new EPerceivesNotificationRenderer();
  // Constructor.
  public EPerceivesNotificationView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.EPerceivesNotification ent=(ingenias.editor.entities.EPerceivesNotification)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.EPerceivesNotification ent) {
