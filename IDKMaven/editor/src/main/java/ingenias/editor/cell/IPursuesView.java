...
public class IPursuesView extends NAryView {

static IPursuesRenderer renderer1 = new IPursuesRenderer();
 public static IPursuesRenderer renderer = new IPursuesRenderer();
  // Constructor.
  public IPursuesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.IPursues ent=(ingenias.editor.entities.IPursues)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.IPursues ent) {
