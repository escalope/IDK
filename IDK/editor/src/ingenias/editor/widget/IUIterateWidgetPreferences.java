...
public class IUIterateWidgetPreferences extends InteractionUnitWidgetPreferences {

  Hashtable preferredWidget=new Hashtable();
  Hashtable defaultValues=new Hashtable();


  public IUIterateWidgetPreferences() {
  super();
  String[] preferredOrder={"id","Description","NumberIterations","InteractionUnits",""};
  this.setPreferredOrder(preferredOrder);
   Vector result=null;
  
   preferredWidget.put("NumberIterations",ingenias.editor.widget.CustomJTextField.class);
   result=new Vector();
   
   defaultValues.put("NumberIterations",result);
