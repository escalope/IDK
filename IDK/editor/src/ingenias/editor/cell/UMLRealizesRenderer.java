...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/UMLRealizesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UMLRealizes",
	index,"/ingenias/editor/rendererxml/UMLRealizesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UMLRealizes",
	index,"/ingenias/editor/rendererxml/UMLRealizesLABELPanel.xml");
 ...
 public static void setEntity(UMLRealizes ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UMLRealizes",ent.getPrefs().getView());
