...
public class OrganizationGroupRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/OrganizationGroupUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("OrganizationGroup",
	index,"/ingenias/editor/rendererxml/OrganizationGroupINGENIASPanel.xml");
  ...
  public static void setEntity(OrganizationGroup ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("OrganizationGroup",ent.getPrefs().getView());
