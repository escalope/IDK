...
public class SimulationPackageRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/SimulationPackageUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("SimulationPackage",
	index,"/ingenias/editor/rendererxml/SimulationPackageINGENIASPanel.xml");
      ...
      if (currentMap.get("Test")!=null){
	   if (ent!=null && ent.getTest()!=null){
		...
		((javax.swing.JLabel)( currentMap).get("Test")).setText(ent.getTest().toString());
		 ...
		 if (currentMap.get("Test") instanceof javax.swing.text.JTextComponent)
		 ((javax.swing.text.JTextComponent)( currentMap).get("Test")).setText(ent.getTest().toString());
		
	      } 
	   } else  {
	     if (currentMap.get("Test") instanceof javax.swing.JLabel)
	     ((javax.swing.JLabel)( currentMap).get("Test")).setText("");
	     else {
		if (!(currentMap.get("Test") instanceof ingenias.editor.rendererxml.CollectionPanel)) 
		((javax.swing.text.JTextComponent)( currentMap).get("Test")).setText("");
	     }
         }
	  }
      ...
      if (currentMap.get("Duration")!=null){
	   if (ent!=null && ent.getDuration()!=null){
		...
		((javax.swing.JLabel)( currentMap).get("Duration")).setText(ent.getDuration().toString());
		 ...
		 if (currentMap.get("Duration") instanceof javax.swing.text.JTextComponent)
		 ((javax.swing.text.JTextComponent)( currentMap).get("Duration")).setText(ent.getDuration().toString());
		
	      } 
	   } else  {
	     if (currentMap.get("Duration") instanceof javax.swing.JLabel)
	     ((javax.swing.JLabel)( currentMap).get("Duration")).setText("");
	     else {
		if (!(currentMap.get("Duration") instanceof ingenias.editor.rendererxml.CollectionPanel)) 
		((javax.swing.text.JTextComponent)( currentMap).get("Duration")).setText("");
	     }
         }
	  }
