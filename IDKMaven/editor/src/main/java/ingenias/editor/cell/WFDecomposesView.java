...
public class WFDecomposesView extends NAryView {

static WFDecomposesRenderer renderer1 = new WFDecomposesRenderer();
 public static WFDecomposesRenderer renderer = new WFDecomposesRenderer();
  // Constructor.
  public WFDecomposesView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.WFDecomposes ent=(ingenias.editor.entities.WFDecomposes)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.WFDecomposes ent) {
