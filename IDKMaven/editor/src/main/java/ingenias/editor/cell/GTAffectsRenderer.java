...
public class GTAffectsRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("GTAffects",
	index,"/rendererxml/GTAffectsNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTAffects",
	index,"/rendererxml/GTAffectsINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTAffects",
	index,"/rendererxml/GTAffectsLABELPanel.xml");
     ...
     */
     public GTAffectsRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("GTAffects",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.GTAffects ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTAffects",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("GTAffects",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("GTAffects",c);
	}
