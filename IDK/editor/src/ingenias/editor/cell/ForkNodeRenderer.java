...
public class ForkNodeRenderer extends VertexRenderer implements CellViewRenderer, Serializable {
  ...
  static {
	...
	index,"/ingenias/editor/rendererxml/ForkNodeUMLPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("ForkNode",
	index,"/ingenias/editor/rendererxml/ForkNodeINGENIASPanel.xml");
  ...
  public static void setEntity(ForkNode ent){
  Map currentMap=(Map)  RenderComponentManager.retrieveIDs("ForkNode",ent.getPrefs().getView());
