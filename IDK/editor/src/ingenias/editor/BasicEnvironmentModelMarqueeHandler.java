...
public class BasicEnvironmentModelMarqueeHandler extends MarqueeHandler  implements java.io.Serializable {

	



        public BasicEnvironmentModelMarqueeHandler(ModelJGraph graph){
	super(graph);
        }
