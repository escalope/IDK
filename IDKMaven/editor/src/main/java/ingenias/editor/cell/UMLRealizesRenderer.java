...
public class UMLRealizesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("UMLRealizes",
	index,"/rendererxml/UMLRealizesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("UMLRealizes",
	index,"/rendererxml/UMLRealizesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("UMLRealizes",
	index,"/rendererxml/UMLRealizesLABELPanel.xml");
     ...
     */
     public UMLRealizesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("UMLRealizes",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.UMLRealizes ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("UMLRealizes",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("UMLRealizes",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("UMLRealizes",c);
	}
