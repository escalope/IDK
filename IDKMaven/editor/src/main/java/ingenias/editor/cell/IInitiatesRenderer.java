...
public class IInitiatesRenderer extends VertexRenderer implements CellViewRenderer{
...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	RenderComponentManager.loadRenderFile("IInitiates",
	index,"/rendererxml/IInitiatesNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("IInitiates",
	index,"/rendererxml/IInitiatesINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("IInitiates",
	index,"/rendererxml/IInitiatesLABELPanel.xml");
     ...
     */
     public IInitiatesRenderer() {
    }

    public Dimension getSize() {
    return RenderComponentManager.getSize("IInitiates",current);
    }
 ...
 public static void setEntity(ingenias.editor.entities.IInitiates ent, Map attributes){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("IInitiates",ent.getPrefs(attributes).getView());
current=ent.getPrefs(attributes).getView();
	...
	{
	return RenderComponentManager.retrievePanel("IInitiates",this.current);
	...
	public static JPanel setCurrent(ViewPreferences.ViewType c) {
		...
		return (JPanel) RenderComponentManager.retrievePanel("IInitiates",c);
	}
