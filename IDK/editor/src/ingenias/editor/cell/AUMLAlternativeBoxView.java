...
public class AUMLAlternativeBoxView extends VertexView {

  public static AUMLAlternativeBoxRenderer renderer = new AUMLAlternativeBoxRenderer();

  // Constructor for Superclass
  // cell es un AgentCell
  public AUMLAlternativeBoxView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg,boolean b1, boolean b2, boolean b3){
   CellViewRenderer renderer=null;
    try {
           ingenias.editor.entities.AUMLAlternativeBox ent=(ingenias.editor.entities.AUMLAlternativeBox)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(AUMLAlternativeBox ent) {
