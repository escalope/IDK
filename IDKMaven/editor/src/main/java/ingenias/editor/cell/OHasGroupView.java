...
public class OHasGroupView extends NAryView {

static OHasGroupRenderer renderer1 = new OHasGroupRenderer();
 public static OHasGroupRenderer renderer = new OHasGroupRenderer();
  // Constructor.
  public OHasGroupView(Object cell) {
    super(cell);
  }
  ...
  public java.awt.Component getRendererComponent(JGraph jg, boolean b1,
   ...
   try {
         ingenias.editor.entities.OHasGroup ent=(ingenias.editor.entities.OHasGroup)((DefaultGraphCell)this.getCell()).getUserObject();
  ...
  static public Dimension getSize(ingenias.editor.entities.OHasGroup ent) {
