...
private static ViewPreferences.ViewType current = ViewPreferences.ViewType.INGENIAS;
  ...
  static {
   try {
	...
	index,"/ingenias/editor/rendererxml/GTDecomposesANDNOICONPanel.xml");
	
	index=ViewPreferences.ViewType.INGENIAS;
	RenderComponentManager.loadRenderFile("GTDecomposesAND",
	index,"/ingenias/editor/rendererxml/GTDecomposesANDINGENIASPanel.xml");
	
	index=ViewPreferences.ViewType.LABEL;
	RenderComponentManager.loadRenderFile("GTDecomposesAND",
	index,"/ingenias/editor/rendererxml/GTDecomposesANDLABELPanel.xml");
 ...
 public static void setEntity(GTDecomposesAND ent){
 Map currentMap=(Map)  RenderComponentManager.retrieveIDs("GTDecomposesAND",ent.getPrefs().getView());
