...
public class INGENIASUseCase extends UseCase {
  ...
  public INGENIASUseCase(String id) {
    super(id);
    this.setHelpDesc("This use case is configured with information about preconditions and postconditions, as well as information of the different interactions that may appear");
    this.setHelpRecom("");
  }
